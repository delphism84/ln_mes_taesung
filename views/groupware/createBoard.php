		...
		<div class="page-content">
			...
			<div class="row">
				<div class="col-xs-12">
					...
					<form name="frm" id="frm" method="post" action="index.php" enctype="multipart/form-data">
						...
						<input type="hidden" name="action" id="action" value="registBoard" />
						<!-- 테이블 -->
						<table id="simple-table" class="table  table-bordered table-hover">
							<tr>
								<th class="col-xs-1" style="background-color:#f1f1f1">제목</th>
								<td class="col-xs-11"><input type="text" name="title" id="title" /></td>
							</tr>
							<tr>
								<th class="col-xs-1" style="background-color:#f1f1f1">업무구분</th>
								<td class="col-xs-11">
									<select name="board_gb" id="board_gb">
							...
							<tr>
								...
								<td class="col-xs-11"><input type="file" name="attach" id="attach" /></td>
							</tr>
							<tr>
			...
			<div class="clearfix form-actions center">
				<div class="col-md-12">
					...
					&nbsp; &nbsp; &nbsp;
					<button class="btn" type="reset" onclick="location.href = 'index.php?controller=groupware&action=listPageBoard' ">
