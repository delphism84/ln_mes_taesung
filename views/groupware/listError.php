			...
			<div class="page-header">
				<h1>
					...
					<small>
						...
						사용 중 발생한 오류를 등록해 주시면 빠른 시간안에 처리 해드리겠습니다.
					</small>
				</h1>
			</div>
			<!--// 서브제목과 라인 -->
...
<!-- PAGE CONTENT BEGINS ---------------------------------------------------------------------------------------------------------------------------------------->
					...
					<div class="widget-header">
						<div class="col-xs-6" style="float:left">
							<select id="per" onchange="getError(1)">
							...
							<table id="file_list" class="table  table-bordered table-striped">
								<thead class="thin-border-bottom">
									<tr>
										...
										<?}?>
										<th class="col-xs-10"><i class="ace-icon fa fa-caret-right blue"></i> 제목</th>
					...
					<div class="clearfix form-actions center" style="margin-top:0px">
						<div class="col-md-12">
							...
							<div class="col-xs-6 right" style="text-align:right">
								<button class="btn btn-info" type="button" onclick="location.href = 'index.php?controller=groupware&action=inputPageError' ">
...
function getError(page){
	...
	$.getJSON("ajax/groupware.php",{"page":page, "mode":"getError", "rpp" : rpp, "adjacents" : adjacents},
		function(json){
			if(json != null) {
