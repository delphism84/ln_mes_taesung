...
function getEleSettlement(page){
	...
	$.getJSON("ajax/groupware.php",{"page":page, "mode":"getEleSettlement", "rpp" : rpp, "adjacents" : adjacents, "where" : where},
		function(json){
			if(json != null) {
