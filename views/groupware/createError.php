		...
		<div class="page-content">
			...
			<div class="page-header">
				<h1>
					...
					<small>
						...
						ERP SYSTEM 사용시 발생하는 오류를 알려주시면 빠른 시간에 해결해 드리겠습니다.
					</small>
				</h1>
			</div><!-- /.page-header -->
			<!--// 서브제목과 라인 -->
			...
			<div class="row">
				<div class="col-xs-12">
					...
					<form name="frm" id="frm" method="post" action="index.php" enctype="multipart/form-data">
						...
						<input type="hidden" name="action" id="action" value="registError" />
						<!-- 테이블 -->
						<table id="simple-table" class="table  table-bordered table-hover">
							<tr>
								<th class="col-xs-1" style="background-color:#f1f1f1">제목</th>
								<td class="col-xs-11"><input type="text" class="form-control" name="title" id="title" /></td>
							</tr>
							<tr>
								<th class="col-xs-1" style="background-color:#f1f1f1">업체</th>
								<td class="col-xs-11"><input type="text" name="account" id="account" value="코스모산전" readonly /></td>
							</tr>
							<tr>
			...
			<div class="clearfix form-actions center">
				<div class="col-md-12">
					...
					&nbsp; &nbsp; &nbsp;
					<button class="btn" type="reset" onclick="location.href = 'index.php?controller=groupware&action=listPageError' ">
...
jQuery(function($) {
	...
	$( "#id-btn-dialog1" ).on('click', function(e) {
		...
		var dialog = $( "#dialog-message1" ).removeClass('hide').dialog({
			...
			height:500,
			modal: true,
			title: "<div class='widget-header widget-header-small'><h4 class='smaller'><i class='ace-icon fa fa-check'></i>견적서 리스트</h4></div>",
			title_html: true,
			buttons: [ 
				{
					text: "Cancel",
