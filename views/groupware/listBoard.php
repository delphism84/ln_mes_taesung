...
<!-- PAGE CONTENT BEGINS ---------------------------------------------------------------------------------------------------------------------------------------->
					...
					<div class="widget-header">
						<div class="col-xs-6" style="float:left">
							<select id="per" onchange="getBoard(1)">
					...
					<div class="widget-body">
						<div class="widget-main no-padding">
							<table id="board_list" class="table  table-bordered table-striped">
								<thead class="thin-border-bottom">
									<tr>
										...
										<th class="col-xs-3"><i class="ace-icon fa fa-caret-right blue"></i> 제목</th>
										<th class="col-xs-3"><i class="ace-icon fa fa-caret-right blue"></i> 파일</th>
										<th class="col-xs-2"><i class="ace-icon fa fa-caret-right blue"></i> 등록자</th>
										<th class="col-xs-2"><i class="ace-icon fa fa-caret-right blue"></i> 등록일</th>
									</tr>
								</thead>
								<tbody></tbody>
							</table>
					...
					<div class="clearfix form-actions center" style="margin-top:0px">
						<div class="col-md-12">
							...
							<div class="col-xs-6 right" style="text-align:right">
								<button class="btn btn-info" type="button" onclick="location.href = 'index.php?controller=groupware&action=inputPageBoard' ">
...
function getBoard(page){
	...
	$.getJSON("ajax/groupware.php",{"page":page, "mode":"getBoard", "rpp" : rpp, "adjacents" : adjacents},
		function(json){
			if(json != null) {
...
function deleteSelect(){
	if(confirm("선택하신 업무공유 정보를 삭제하시겠습니까?")) {
		$(".chk").each(function(){
		...
		var dataString = "mode=deleteSelectBoard&table=erp_board&uids=" + $("#check_uids").val();
		$.ajax({
			type : "post",
