		...
		<div class="page-content">
			...
			<div class="row">
				<div class="col-xs-12">
					...
					<form name="frm" id="frm" method="post" action="index.php" enctype="multipart/form-data">
						...
						<input type="hidden" name="action" id="action" value="registPublicThing" />
						<!-- 테이블 -->
						<table id="simple-table" class="table  table-bordered table-hover">
							<tr>
								<th class="col-xs-1" style="background-color:#f1f1f1">공용품명</th>
								<td class="col-xs-5"><input type="text" name="item_nm" id="item_nm" /></td>
								<th class="col-xs-1" style="background-color:#f1f1f1">용품구분</th>
								<td class="col-xs-5">
			...
			<div class="clearfix form-actions center">
				<div class="col-md-12">
					...
					&nbsp; &nbsp; &nbsp;
					<button class="btn" type="reset" onclick="location.href = 'index.php?controller=groupware&action=listPagePublicThing'">
...
function formSubmit(){
	if(!check_str($("#item_nm").val(),"공용품명")) return false;
	if(!check_str($("#in_dt").val(),"도입(구입)일")) return false;
