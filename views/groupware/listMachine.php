...
<!-- PAGE CONTENT BEGINS ---------------------------------------------------------------------------------------------------------------------------------------->
					...
					<div style="margin-top:10px">
						<table id="machine_list" class="table  table-bordered table-hover">
							<thead>
								<tr>
									...
									<th class="col-xs-6 center" style="background-color:#f1f1f1">기계명</th>
									<th class="col-xs-6 center" style="background-color:#f1f1f1">작업공정</th>
								</tr>
							</thead>
							<tbody></tbody>
						</table>
			...
			<div class="clearfix form-actions center">
				<div class="col-md-12">
					...
					<div class="col-xs-6 right" style="text-align:right">
						<button class="btn btn-info" type="button" onclick="location.href = 'index.php?controller=groupware&action=inputPageMachine' ">
...
// 거래처 리스트 가져오기
function getMachine(page){
	var rpp = 15;
	var adjacents = 4;
	var tag = "";
	var page = page;

	$.getJSON("ajax/groupware.php",{"page":page, "mode":"getMachine", "rpp" : rpp, "adjacents" : adjacents},
		function(json){
			if(json != null) {
				for(var i = 0 ; i < json.length ; i++) {
					...
					tag += "</label>";
					tag += "</td>";
					tag += "<td><a href='index.php?controller=groupware&action=modifyPageEleSettlement&uid=" + json[i].uid + "'>" + json[i].machine_nm + "</a></td>";
					tag += "<td class='center'>" + json[i].process_nm + "</td>";
					tag += "</tr>";
				}
			}
