...
<!-- PAGE CONTENT BEGINS ---------------------------------------------------------------------------------------------------------------------------------------->
					...
					<div class="widget-header">
						<div class="col-xs-6" style="float:left">
							<select id="per" onchange="getVersion(1)">
							...
							<table id="file_list" class="table  table-bordered table-striped">
								<thead class="thin-border-bottom">
									<tr>
										...
										<th class="col-xs-1 center" style="background-color:#f1f1f1">타겟</th>
										<th class="col-xs-1 center" style="background-color:#f1f1f1">버전</th>
										<th class="col-xs-1 center" style="background-color:#f1f1f1">버전코드</th>
										<th class="col-xs-7 center" style="background-color:#f1f1f1">제목</th>
					...
					<div class="clearfix form-actions center" style="margin-top:0px">
						<div class="col-md-12">
							...
							<div class="col-xs-6 right" style="text-align:right">
								<button class="btn btn-info" type="button" onclick="location.href = 'index.php?controller=groupware&action=inputPageVersion' ">
...
function getVersion(page){
	...
	$.getJSON("ajax/groupware.php",{"page":page, "mode":"getVersion", "rpp" : rpp, "adjacents" : adjacents, "where" : where},
		function(json){
			if(json != null) {
				for(var i = 0 ; i < json.length ; i++) {
					...
					tag += "</label>";
					tag += "</td>";
					tag += "<td class='center'>" + json[i].target + "</td>";
					tag += "<td class='center'>" + json[i].version + "</td>";
					tag += "<td class='center'>" + json[i].version_code + "</td>";
					tag += "<td class='center'>" + json[i].title + "</td>";
