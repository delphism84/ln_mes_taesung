			...
			<div class="row">
				<div class="col-xs-12">
					...
					<form name="frm" id="frm" method="post" action="index.php" enctype="multipart/form-data">
						...
						<input type="hidden" name="action" id="action" value="registVersion" />
						<!-- 테이블 -->
						<table id="simple-table" class="table  table-bordered table-hover">
							...
							<tr>
								<th class="col-xs-1" style="background-color:#f1f1f1">버전</th>
								<td class="col-xs-11">
							...
							<tr>
								<th class="col-xs-1" style="background-color:#f1f1f1">버전코드</th>
								<td class="col-xs-11"><input type="text" class="form-control" name="version_code" id="version_code" value="<?=time()?>" /></td>
							</tr>
							<tr>
								...
								<td class="col-xs-11">
									<select name="target" id="target">
										...
										<option value="yeonam">연암</option>
										<option value="inf">인퍼스</option>
										<option value="inw">이노윌</option>
										<option value="cosmo">코스모</option>
										<option value="bdt">백두</option>
										<option value="bw">백운</option>
										<option value="its">태성</option>
										<option value="sh">신화</option>
										<option value="vow">바우</option>
									</select>
								</td>
							</tr>
							<tr>
