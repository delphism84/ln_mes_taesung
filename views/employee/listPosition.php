						...
						<table id="position_list" class="table  table-bordered table-hover">
							<thead>
								<tr>
									...
									<th class="col-xs-10 center" style="background-color:#f1f1f1">직위명</th>
			...
			<div class="clearfix form-actions center">
				<div class="col-md-12">
					...
					<div class="col-xs-6 right" style="text-align:right">
						<button class="btn btn-info" type="button" onclick="location.href = 'index.php?controller=employee&action=inputPagePosition' ">
...
function getPosition(page){
	...
	$.getJSON("ajax/position.php",{"page":page, "mode":"getPosition", "rpp" : rpp, "adjacents" : adjacents},
		function(json){
			if(json != null) {
				...
				for(var i = 0 ; i < json.length ; i++){
					...
					tag += "</label>";
					tag += "</td>";
					tag += "<td><a href='index.php?controller=employee&action=modifyPagePosition&uid=" + json[i].uid + "'>" + json[i].position_nm + "</a></td>";
...
function deleteSelect(){
	if(confirm("선택하신 직위 정보를 삭제하시겠습니까? 다른 데이터와 연동된 직위 정보는 삭제되지 않습니다.")) {
		$(".chk").each(function(){
