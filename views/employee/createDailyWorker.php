			...
			<div class="row">
				<div class="col-xs-12">
					...
					<form id="frm" method="post" action="index.php">
						...
						<input type="hidden" name="action" id="action" value="registDailyWorker" />
						<!-- 테이블 -->
						<table id="simple-table" class="table  table-bordered table-hover">
							<tr>
								<th class="col-xs-1" style="background-color:#f1f1f1"><i class="cf fa fa-check" aria-hidden="true"></i> 사원번호</th>
								<td class="col-xs-5"><input type="text" class="form-control" name="emp_cd" id="emp_cd" readonly /></td>
							...
							<tr>
								...
								<td class="col-xs-5"><input type="text" name="emp_id" id="emp_id" /></td>
								<th class="col-xs-1" style="background-color:#f1f1f1"><i class="cf fa fa-check" aria-hidden="true"></i> 사원 PASSWORD</th>
								<td class="col-xs-5"><input type="text" name="emp_pwd" id="emp_pwd" /></td>
							</tr>
							<tr>
								<th class="col-xs-1" style="background-color:#f1f1f1">성별</th>
								<td class="col-xs-5">
									<label>
										<input type="radio" class="ace" name="sex_gb" id="sex_gb" value="m" checked onclick="createEmployeeCode()" />
										<span class="lbl"> 남성</span>
									</label>

									<label>
										<input type="radio" class="ace" name="sex_gb" id="sex_gb" value="w" onclick="createEmployeeCode()" />
							...
							<tr>
								...
								<td class="col-xs-5">
									<div class="input-group">
										...
										<input class="form-control input-mask-mobile" type="text" name="emp_mobile" id="emp_mobile" />
									</div>
								</td>
								...
								<td class="col-xs-5">
									<div class="input-group">
										...
										<input class="form-control input-mask-telephone" type="text" name="emp_telephone" id="emp_telephone" />
									</div>
								</td>
							</tr>
							<tr>
								<th class="col-xs-1" style="background-color:#f1f1f1">Email</th>
								<td class="col-xs-5" colspan="3"><input type="text" class="form-control" name="emp_email" id="emp_email" /></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td class="col-xs-5">
									<label>
										<input type="radio" class="ace" name="pay_gb" id="pay_gb" value="일급" checked />
										<span class="lbl"> 일급</span>
									</label>

									<label>
										<input type="radio" class="ace" name="pay_gb" id="pay_gb" value="시급" onclick="createEmployeeCode()" />
