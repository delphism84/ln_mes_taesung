			...
			<div class="row">
				<div class="col-xs-12">
					...
					<form id="frm" method="post" action="index.php">
						...
						<input type="hidden" name="action" id="action" value="updatePosition" />
						...
						<table id="simple-table" class="table  table-bordered table-hover">
							<tr>
								...
								<td class="col-xs-5"><input type="text" class="form-control" name="position_nm" id="position_nm" value="<?=$t->position_nm?>" /></td>
