						...
						<table id="employee_list" class="table  table-bordered table-hover">
							<thead>
								<tr>
									...
									<th class="col-xs-1 center" style="background-color:#f1f1f1">직급</th>
									<th class="col-xs-1 center" style="background-color:#f1f1f1">입사일자</th>
									<th class="col-xs-2 center" style="background-color:#f1f1f1">휴대전화</th>
			...
			<div class="clearfix form-actions center">
				<div class="col-md-12">
					...
					<div class="col-xs-6 right" style="text-align:right">
						<button class="btn btn-info" type="button" onclick="location.href = 'index.php?controller=employee&action=inputPageEmployee' ">
...
function getEmployee(page){
	...
	$.getJSON("ajax/employee.php",{"page":page, "mode":"getEmployee", "rpp" : rpp, "adjacents" : adjacents, "department_cd" : department_cd, "where":search, "search_choice" : search_choice, "txt" : txt},
		function(json){
			if(json != null) {
				//$("#total_num").html(json[0].total_num);
				for(var i = 0 ; i < json.length ; i++){
					...
					tag += "<td><a href='index.php?controller=employee&action=modifyPageEmployee&uid=" + json[i].uid + "'>" + json[i].emp_nm + "</a></td>";
