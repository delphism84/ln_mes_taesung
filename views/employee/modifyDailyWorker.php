			...
			<div class="row">
				<div class="col-xs-12">
					...
					<form id="frm" method="post" action="index.php">
						...
						<input type="hidden" name="action" id="action" value="updateDailyWorker" />
						...
						<table id="simple-table" class="table  table-bordered table-hover">
							...
							<tr>
								...
								<td class="col-xs-5">
									<label>
										<input type="radio" class="ace" name="sex_gb" id="sex_gb" value="m" <? if($t->sex_gb == "m") echo "checked"; ?> onclick="createEmployeeCode()" />
										<span class="lbl"> 남성</span>
									</label>

									<label>
										<input type="radio" class="ace" name="sex_gb" id="sex_gb" value="w" <? if($t->sex_gb == "w") echo "checked"; ?> onclick="createEmployeeCode()" />
							...
							<tr>
								...
								<td class="col-xs-5" colspan="3"><input type="text" class="form-control" name="emp_email" id="emp_email" value="<?=$t->emp_email?>" /></td>
							</tr>
							<tr>
								...
								<td class="col-xs-5">
									<span class="input-icon input-icon-right">
										<div class="input-group">
											<input class=" date-picker" type="text" data-date-format="yyyy-mm-dd" name="join_dt" id="join_dt" value="<?=substr($t->join_dt)?>"/>
											<span class="input-group-addon">
								...
								<td class="col-xs-5">
									<span class="input-icon input-icon-right">
										<div class="input-group">
											<input class=" date-picker" type="text" data-date-format="yyyy-mm-dd" name="resign_dt" id="resign_dt" value="<?=substr($t->resign_dt)?>"/>
											<span class="input-group-addon">
												<i class="fa fa-calendar bigger-110"></i>
											</span>
										</div>
							...
							<tr>
								...
								<td class="col-xs-5">
									<label>
										<input type="radio" class="ace" name="pay_gb" id="pay_gb" value="일급" <? if($t->pay_gb == "일급") echo "checked"; ?> />
										<span class="lbl"> 일급</span>
									</label>

									<label>
										<input type="radio" class="ace" name="pay_gb" id="pay_gb" value="시급" <? if($t->pay_gb == "시급") echo "checked"; ?> />
								...
								<td class="col-xs-5">
									<label>
										<input type="radio" class="ace" name="health_ins" id="health_ins" value="대상자" <? if($t->health_ins == "대상자") echo "checked"; ?> />
										<span class="lbl"> 대상자</span>
									</label>

									<label>
										<input type="radio" class="ace" name="health_ins" id="health_ins" value="비대상자" <? if($t->health_ins == "비대상자") echo "checked"; ?> />
							...
							<tr>
								...
								<td class="col-xs-5">
									<label>
										<input type="radio" class="ace" name="national_pension" id="national_pension" value="대상자" <? if($t->national_pension == "대상자") echo "checked"; ?> />
										<span class="lbl"> 대상자</span>
									</label>

									<label>
										<input type="radio" class="ace" name="national_pension" id="national_pension" value="비대상자" <? if($t->national_pension == "비대상자") echo "checked"; ?> />
										<span class="lbl"> 비대상자</span>
									</label>
								</td>
								...
								<td class="col-xs-5">
									<label>
										<input type="radio" class="ace" name="eldelry_ins" id="eldelry_ins" value="대상자" <? if($t->eldelry_ins == "대상자") echo "checked"; ?> />
										<span class="lbl"> 대상자</span>
									</label>

									<label>
										<input type="radio" class="ace" name="eldelry_ins" id="eldelry_ins" value="비대상자" <? if($t->eldelry_ins == "비대상자") echo "checked"; ?> />
										<span class="lbl"> 비대상자</span>
									</label>
								</td>
							</tr>
							<tr>
								...
								<td class="col-xs-5">
									<label>
										<input type="radio" class="ace" name="unemployment_ins" id="unemployment_ins" value="대상자" <? if($t->unemployment_ins == "대상자") echo "checked"; ?> />
										<span class="lbl"> 대상자</span>
									</label>

									<label>
										<input type="radio" class="ace" name="unemployment_ins" id="unemployment_ins" value="비대상자" <? if($t->unemployment_ins == "비대상자") echo "checked"; ?> />
										<span class="lbl"> 비대상자</span>
									</label>
								</td>
								...
								<td class="col-xs-5">
									<label>
										<input type="radio" class="ace" name="occupation" id="occupation" value="일반직" <? if($t->occupation == "일반직") echo "checked"; ?> />
										<span class="lbl"> 일반직</span>
									</label>

									<label>
										<input type="radio" class="ace" name="occupation" id="occupation" value="생산직" <? if($t->occupation == "생산직") echo "checked"; ?> />
										<span class="lbl"> 생산직</span>
									</label>

									<label>
										<input type="radio" class="ace" name="occupation" id="occupation" value="연구직" <? if($t->occupation == "연구직") echo "checked"; ?> />
							...
							<tr>
								...
								<td class="col-xs-5" colspan="3">
									<label>
										<input type="radio" class="ace" name="nationality" id="nationality" value="내국인" <? if($t->nationality == "내국인") echo "checked"; ?> />
										<span class="lbl"> 내국인</span>
									</label>

									<label>
										<input type="radio" class="ace" name="nationality" id="nationality" value="외국인" <? if($t->nationality == "외국인") echo "checked"; ?> />
