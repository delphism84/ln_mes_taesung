						...
						<table id="product" class="table  table-bordered table-hover" style="margin-top:10px">
							<thead>
								<tr>
									...
									<th class="center col-xs-1" style="background-color:#f1f1f1">출하수량 / 박스당수량</th>
									...
									<th class="center col-xs-2" style="background-color:#f1f1f1">press생산일</th>
								</tr>
							</thead>
							<tbody>
								<tr>
		...
		function(json){
			if(json != null) {
				for(var i = 0 ; i < json.length ; i++){					
					...
					tag += "<td>" + json[i].cnt + " / " + json[i].box_cnt + "</td>";
					tag += "<td>" + json[i].lot_no_cd + "</td>";
					tag += "<td>" + json[i].work_cd + "</td>";
					tag += "<td>" + json[i].presswork_dt + "</td>";
