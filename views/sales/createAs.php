			...
			<div class="row">
				<div class="col-xs-12">
					...
					<form name="frm" id="frm" method="post" action="index.php" enctype="multipart/form-data">
						...
						<input type="hidden" name="action" id="action" value="registAs" />
						<!-- 테이블 -->
						...
						<table id="simple-table" class="table  table-bordered table-hover">
									...
									<div>
										<span class="input-icon input-icon-right">
											<div class="input-group">
												<input class=" date-picker" name="accept_dt" id="accept_dt" type="text" data-date-format="yyyy-mm-dd" value="<?=date("Y-m-d")?>" />
							...
							<tr>
								...
								<td class="col-xs-5"><input type="text" class="form-control" name="email" id="email" /></td>
								<th class="col-xs-1" style="background-color:#f1f1f1">연락처</th>
								<td class="col-xs-5"><input type="text" name="phone" id="phone" /></td>
							</tr>
						</table>
						...
						<table id="simple-table" class="table  table-bordered table-hover">
							<tr>
								...
								<td class="col-xs-5">
									<div class="input-group">
										<span class="input-icon input-icon-right">
											<div class="input-group">
												<input type="hidden" name="item_cd" id="item_cd" readonly />
												<input type="text" name="item_nm" id="item_nm" onclick="centerOpenWindow('views/popup/productList.php', '품목리스트', 800, 500)" readonly />
												<span class="input-group-addon btn-purple" onclick="centerOpenWindow('views/popup/productList.php', '품목리스트', 800, 500)">
													<i class="ace-icon fa fa-search icon-on-right bigger-110" style="color:#ffffff"></i>
												</span>
											</div>
										</span>
							...
							<tr>
								...
								<td class="col-xs-5">
									<input type="text" name="processing_cost" id="processing_cost" class='onlynum align-right' />
								</td>
							</tr>
							<tr>
									...
									<div class="input-group">
										<span class="input-icon input-icon-right">
											<div class="input-group">
												...
												<input type="text" name="emp_nm" id="emp_nm" readonly onclick="centerOpenWindow('views/popup/employeeList.php', '사원리스트', 800, 500)" />
