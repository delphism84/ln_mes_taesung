							...
							<table id="estimate_list" class="table  table-bordered table-striped">
								<thead class="thin-border-bottom">
									<tr>
										...
										<th class="col-xs-1"><i class="ace-icon fa fa-caret-right blue"></i> 수주일</th>
										<th class="col-xs-2"><i class="ace-icon fa fa-caret-right blue"></i> 전체매출금액</th>
										<th class="col-xs-2"><i class="ace-icon fa fa-caret-right blue"></i> 미수금</th>
...
// 거래처 리스트 가져오기
function getAccountReceivable(page){
	var rpp = $("#per").val();
	var adjacents = 4;
	var tag = "";
	var where = $("#where").val();
	...
	$.getJSON("ajax/sales.php",{"page":page, "mode":"getAccountReceivable", "rpp" : rpp, "adjacents" : adjacents, "where" : where},
		function(json){
			if(json != null) {
