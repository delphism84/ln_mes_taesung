							...
							<table id="order_list" class="table  table-bordered table-striped">
								<thead class="thin-border-bottom">
									<tr>
										...
										<?}?>
										<th class="col-xs-2"><i class="ace-icon fa fa-caret-right blue"></i> 주문번호</th>
										...
										<th class="col-xs-2"><i class="ace-icon fa fa-caret-right blue"></i> 납기일자</th>
										<th class="col-xs-1"><i class="ace-icon fa fa-caret-right blue"></i> 금액</th>
										<th class="col-xs-2"><i class="ace-icon fa fa-caret-right blue"></i> 인쇄</th>
									</tr>
								</thead>
								<tbody></tbody>
							</table>
