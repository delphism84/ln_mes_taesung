						...
						<table id="account_list" class="table  table-bordered table-hover">
							<thead>
								<tr>
									...
									<th class="col-xs-1 center" style="background-color:#f1f1f1">거래처코드</th>
									<th class="col-xs-1 center" style="background-color:#f1f1f1">대표자</th>
									<th class="col-xs-2 center" style="background-color:#f1f1f1">회사전화</th>
									<th class="col-xs-2 center" style="background-color:#f1f1f1">회사팩스</th>
			...
			<div class="clearfix form-actions center">
				<div class="col-md-12">
					...
					<div class="col-xs-6 right" style="text-align:right">
						<button class="btn btn-info" type="button" onclick="location.href = 'index.php?controller=sales&action=inputPageAccount' ">
		...
		function(json){
			if(json != null) {
				...
				for(var i = 0 ; i < json.length ; i++){
					...
					tag += "<td><a href='index.php?controller=sales&action=modifyPageAccount&uid=" + json[i].uid + "'>" + json[i].account_nm + "</a></td>";
					tag += "<td>" + json[i].account_cd + "</td>";
					tag += "<td class='center'>" + json[i].owner + "</td>";
					tag += "<td class='center'>" + json[i].corp_phone + "</td>";
					tag += "<td class='center'>" + json[i].corp_fax + "</td>";
					tag += "<td class='center'>" + json[i].corp_email + "</td>";
