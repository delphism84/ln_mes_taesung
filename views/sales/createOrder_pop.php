			...
			<div class="row">
				<div class="col-xs-12">
					...
					<form name="frm" id="frm" method="post" action="index.php" enctype="multipart/form-data">
						...
						<input type="hidden" name="action" id="action" value="inputPageOrder" />
						...
						<table id="simple-table" class="table  table-bordered table-hover">
							<tr>
								<th class="col-xs-1" style="background-color:#f1f1f1"><i class="ace-icon fa fa-caret-right blue"></i> 주문일자</th>
								<td class="col-xs-5" colspan="3">
									<!-- <input type="text" name="order_cd" id="order_cd" readonly /> -->
									<div>
										<span class="input-icon input-icon-right">
											<div class="input-group">
												<input class=" date-picker" name="order_dt" id="order_dt" type="text" data-date-format="yyyy/mm/dd" value='<?=date("Y/m/d")?>'/>
							...
							<tr>
								<th class="col-xs-1" style="background-color:#f1f1f1"><i class="ace-icon fa fa-caret-right blue"></i> 견적서코드</th>
								<td class="col-xs-5">
									<div class="input-group">
										<span class="input-icon input-icon-right">
											<div class="input-group">
												<input type="hidden" name="estimate_uid" id="estimate_uid" readonly />
												<input type="text" name="estimate_cd" id="estimate_cd" onclick="centerOpenWindow('views/popup/estimateList.php', '견적서리스트', 600, 500)" readonly />
												<span class="input-group-addon btn-purple" onclick="centerOpenWindow('views/popup/estimateList.php', '견적서리스트', 600, 500)">
								...
								<td class="col-xs-5">
									<span class="input-icon input-icon-right">
										<div class="input-group">
											...
											<input type="text" name="warehouse_nm" id="warehouse_nm" onclick="centerOpenWindow('views/popup/warehouseList.php', '창고리스트', 600, 500)" />
...
function getEstimateOne() {
	var uid = $("#estimate_uid").val();
