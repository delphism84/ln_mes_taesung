							...
							<table id="facility_management_list" class="table  table-bordered table-striped">
								<thead class="thin-border-bottom">
									<tr>
										...
										<?}?>
										<th class="col-xs-1"><i class="ace-icon fa fa-caret-right blue"></i> 일자</th>
										<th class="col-xs-1"><i class="ace-icon fa fa-caret-right blue"></i> 구분</th>
										<th class="col-xs-1"><i class="ace-icon fa fa-caret-right blue"></i> 설비코드</th>
										<th class="col-xs-1"><i class="ace-icon fa fa-caret-right blue"></i> 설비명</th>
										<th class="col-xs-1"><i class="ace-icon fa fa-caret-right blue"></i> 모델명</th>
										<th class="col-xs-1"><i class="ace-icon fa fa-caret-right blue"></i> 근무시간(분)</th>
										<th class="col-xs-1"><i class="ace-icon fa fa-caret-right blue"></i> 작업투입시간(분)</th>
										<th class="col-xs-1"><i class="ace-icon fa fa-caret-right blue"></i> 비가동시간(분)</th>
										<th class="col-xs-1"><i class="ace-icon fa fa-caret-right blue"></i> 비가동유형</th>
										<th class="col-xs-1"><i class="ace-icon fa fa-caret-right blue"></i> 가동률</th>
										<th class="col-xs-1"><i class="ace-icon fa fa-caret-right blue"></i> 이상내용</th>
										<th class="col-xs-1"><i class="ace-icon fa fa-caret-right blue"></i> 조치내역</th>
									</tr>
								</thead>
								<tbody></tbody>
							</table>
