			...
			<div class="row">
				<div class="col-xs-12">
					...
					<form name="frm" id="frm" method="post" action="index.php">
						...
						<input type="hidden" name="action" id="action" value="insertPageFacilityManagement" />
						...
						<table id="simple-table" class="table  table-bordered table-hover">
							<tr>
									...
									<div>
										<span class="input-icon input-icon-right">
											<div class="input-group">
												<input class=" date-picker" name="facilities_dt" id="facilities_dt" type="text" value="<?=date('Y-m-d')?>" data-date-format="yyyy-mm-dd" readonly/>
								...
								<td class="col-xs-5">
									<input type="text" name="office_hours" id="office_hours" class="text-right" value='700' onclick='this.select();' style="ime-mode:disabled"/>
								</td>
								<th class="col-xs-1" style="background-color:#f1f1f1">모델명</th>
								<td class="col-xs-5">
									<input type="text" name="model_no" id="model_no" onclick='this.select();' style="ime-mode:disabled"/>
								</td>
							</tr>
								<tr>
								...
								<td class="col-xs-5">
									<div class="input-group">
										<div class="input-group clockpicker" data-placement="left" data-align="top" data-autoclose="true" id="timePicker4" style="width:110px;float:left">
											<input type="text" name="f_work_tm1" id="f_work_tm1" class="form-control" value="<?=date('H:i')?>" onclick="officeHours()">
											<span class="input-group-addon">
										...
										<div class="input-group clockpicker" data-placement="left" data-align="top" data-autoclose="true" id="timePicker5" style="width:110px;float:left">
											<input type="text" name="f_work_tm2" id="f_work_tm2" class="form-control" value="<?=date('H:i')?>" onblur="operationRate()">
											<span class="input-group-addon">
												<span class="glyphicon glyphicon-time"  onblur="operationRate()"></span>
											</span>
										</div>
										<input type="hidden" name="f_work_tm" id="f_work_tm" >
									</div>
								</td>
								...
								<td class="col-xs-5">
									<div class="input-group">
										<div class="input-group clockpicker" data-placement="left" data-align="top" data-autoclose="true" id="timePicker6" style="width:110px;float:left">
											<input type="text" name="f_off_tm1" id="f_off_tm1" class="form-control" value="<?=date('H:i')?>">
											<span class="input-group-addon">
										...
										<div class="input-group clockpicker" data-placement="left" data-align="top" data-autoclose="true" id="timePicker7" style="width:110px;float:left">
											<input type="text" name="f_off_tm2" id="f_off_tm2" class="form-control" value="<?=date('H:i')?>" onblur="fOffTm();">
											<span class="input-group-addon">
							...
							<tr>
								...
								<td class="col-xs-5">
									<input type="text" name="operation_rate" id="operation_rate" class="text-right" value='0' onclick='this.select();' onKeyPress="onlyNumber();" onKeyUp="input_comma(this);" style="ime-mode:disabled"/>%
								</td>
								<th class="col-xs-1" style="background-color:#f1f1f1">이상발생분류</th>
									<td class="col-xs-5">
										<input type="radio" name="problem_gb" id="problem_gb" value="0" class="text-left" checked/> 돌발방생&nbsp;&nbsp;&nbsp;<input type="radio" name="problem_gb" id="problem_gb" value="1" class="text-left"/> 일상및 정기점검
								</td>
							...
							<tr>
								...
								<td class="col-xs-5">
									...
									<option value="1">계획생산정지</option>
									<option value="2">휴식</option>
									<option value="3">식사</option>
									<option value="4">TPM교육</option>
									<option value="5">영업계획차질</option>
									<option value="6">자연재해</option>
									<option value="7">설비보수</option>
									<option value="8">Valve End 청소</option>
									<option value="9">샘플진행</option>
									<option value="10">모델변경</option>
									<option value="11">기계조절시간</option>
									<option value="12">고장수리</option>
									<option value="13">탕도청소</option>
							...
							<tr>
								...
								<td class="col-xs-5">
									<textarea name="a_content" id="a_content" class="form-control"/></textarea>
								</td>
							</tr>
							...
							<tr>
								...
								<td class="col-xs-5">
									<div class="input-group">
											<span class="input-icon input-icon-right">
												<div class="input-group">
													<input class=" date-picker" type="text" data-date-format="yyyy-mm-dd" name="receipt_dt" id="receipt_dt" />
													<span class="input-group-addon">
														<i class="fa fa-calendar bigger-110"></i>
													</span>
												</div>
								...
								<td class="col-xs-5">
									<div class="input-group">
											<span class="input-icon input-icon-right">
												<div class="input-group">
													<input class=" date-picker" type="text" data-date-format="yyyy-mm-dd" name="handle_dt" id="handle_dt" />
													<span class="input-group-addon">
														<i class="fa fa-calendar bigger-110"></i>
													</span>
												</div>
