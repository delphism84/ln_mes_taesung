...
?>
				<tr>
					...
					<td class='center'><span style="cursor:pointer" onclick="postItem('<?=$t->item_cd?>','<?=$t->item_nm?>','<?=$t->standard1?>','<?=$t->unit?>','<?=$remain_cnt?>','<?=$bcnt?>','<?=$cnt?>')"><?=$t->item_cd?></span></td>
					<td class='center'><span style="cursor:pointer" onclick="postItem('<?=$t->item_cd?>','<?=$t->item_nm?>','<?=$t->standard1?>','<?=$t->unit?>','<?=$remain_cnt?>','<?=$bcnt?>','<?=$cnt?>')"><?=$t->item_nm?></span></td>
					<td class='center'><span style="cursor:pointer" onclick="postItem('<?=$t->item_cd?>','<?=$t->item_nm?>','<?=$t->standard1?>','<?=$t->unit?>','<?=$remain_cnt?>','<?=$bcnt?>','<?=$cnt?>')"><?=$t->standard1?></span></td>
					<td class='center'><span style="cursor:pointer" onclick="postItem('<?=$t->item_cd?>','<?=$t->item_nm?>','<?=$t->standard1?>','<?=$t->unit?>','<?=$remain_cnt?>','<?=$bcnt?>','<?=$cnt?>')"><?=$t->unit?></span></td>
				</tr>			
<?
}				
?>
