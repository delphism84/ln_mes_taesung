...
function search() {
	$("#where").val(" where item_nm='" + $("#search_txt").val() + "'");
	setPage(1);
}
</script>
...
?>
				<tr>
					...
					<td class='center'><span style="cursor:pointer" onclick="postItem('<?=$t->item_cd?>','<?=$t->item_nm?>')"><?=$t->item_cd?></span></td>
					<td class='center'><span style="cursor:pointer" onclick="postItem('<?=$t->item_cd?>','<?=$t->item_nm?>')"><?=$t->item_nm?></span></td>
					<td class='center'><span style="cursor:pointer" onclick="postItem('<?=$t->item_cd?>','<?=$t->item_nm?>')"><?=$t->standard?></span></td>
				</tr>			
<?
}				
?>
