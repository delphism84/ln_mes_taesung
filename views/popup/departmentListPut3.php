							...
							<table id="mold_hits_list" class="table table-bordered table-striped">
								...
								<tfoot style="background-color: #eeeeee;">
									<tr>
										...
										<th style="col-xs-12 text-right" align="right">0</th>
										<th align="right">0</th>
										<th align="right">0</th>
										<th align="right">0</th>
		...
		function(json){
			if(json != null) {
				for(var i = 0 ; i < json.length ; i++){
					...
					tag += "<td>" + json[i].production_dt + "</a></td>";
					tag += "<td>" + json[i].process_nm + "</a></td>";
					tag += "<td>" + json[i].machine_nm + "</a></td>";
					tag += "<td></td>";
					tag += "<td></td>";
					tag += "<td>" + json[i].item_cd + "</td>";
					tag += "<td>" + json[i].item_nm + "</a></td>";
					tag += "<td>" + json[i].standard1 + "</a></td>";
					tag += "<td class='text-right'>" + json[i].output_qty + "</a></td>";
		...
		function(json){
			if(json != null) {
				for(var i = 0 ; i < json.length ; i++){
					...
					tag += "<td>" + json[i].item_nm + "</a></td>";
					tag += "<td>" + json[i].standard1 + "</a></td>";
					tag += "<td>" + json[i].material + "</a></td>";
					tag += "<td>" + json[i].unit + "</a></td>";
					tag += "<td class='text-right'>" + json[i].cnt + "</a></td>";
					tag += "<td class='text-right'>" + json[i].valid_item_hit_cnt + "</a></td>";
					tag += "<td class='text-right'>" + json[i].valid_item_hit_be_cnt + "</a></td>";
					tag += "<td class='text-right'>" + json[i].valid_item_hit_rest_count + "</a></td>";
					tag += "<td class='text-right'>" + json[i].valid_item_hit_rate + "</a></td>";
					tag += "<td class=''>" + json[i].remark + "</a></td>";
					tag += "</tr>";
				}
			}else{
				tag += "<tr>";
