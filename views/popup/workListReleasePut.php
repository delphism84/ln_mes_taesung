...
function setPage(page){
	...
	location.href = "./workListReleasePut.php?page=" + page + "&search_txt=" + search_txt + "&state=" + $("#state option:selected").val();
}
...
function postWork(work_cd, item_cd, item_nm, standard1, material, unit, cnt, uid) {
	...
	$("#work_bom",opener.document).val(uid); //bom 번호
	$(opener.location).attr("href", "javascript:getWorkReleaseRequest('"+uid+"');");
	window.close();
}
//-->
</script>
			...
			<!-- PAGE CONTENT BEGINS -->
				...
				<div class="col-xs-5" style="float:right">
					<div class="input-group">						
						<input type="text" class="form-control search-query" name="search_txt" id="search_txt" placeholder="작업지시서 번호"/>
