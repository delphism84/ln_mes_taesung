					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<div>
									<form method="post" name="dropzone" action="./upload.php" enctype="multipart/form-data" class="dropzone well" id="dropzone">
...
<![endif]-->
		...
		<script>
			function formSubmit(){
				...
				var dataString = "mode=moldFileUpload&file=" + $("#file").val();
				$.ajax({
					type : "post",
					url : "ajax/mold.php",
					data : dataString,
		...
		<script type="text/javascript">
			...
			try {
			  ...
			  var myDropzone = new Dropzone('#dropzone', {
			    ...
			    maxFilesize: 0.5,
				maxFiles: 5,
				acceptedFiles: ".jpg,.gif,.png,.jpeg,.JPG,.GIF,.PNG,.doc,.DOC,.docx,.Docx,.pdf",
