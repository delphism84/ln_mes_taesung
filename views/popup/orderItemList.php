...
function postItem(item_cd, item_nm, standard1, material, unit, unit_price) {
	...
	if(idx >= 0) {
		...
		tag += "<td><input type='text' class='form-control' name='unit[]' id='unit_" + flag + "' value='" + unit + "' readonly /></td>";
		...
		tag += "<td><input type='text' class='form-control text-right unit_price' name='unit_price[]' id='unit_price_" + flag + "' value='" + unit_price + "' onclick='this.select();' onkeyup='calculation(" + flag + ");input_comma(this);' onblur='calculationTotal(" + flag + ");'/></td>";
		tag += "<td><input type='text' class='form-control text-right supply_price' name='supply_price[]' id='supply_price_" + flag + "' onclick='this.select();' onkeyup='input_comma(this);' onblur='calculationTotal(" + flag + ");' readonly /></td>";
		tag += "<td><input type='text' class='form-control text-right tax' name='tax[]' id='tax_" + flag + "' onkeyup='input_comma(this);' onclick='this.select();' onblur='calculationTotal(" + flag + ");' readonly /></td>";
		tag += "<td><input type='text' class='form-control text-right total_price' name='total_price[]' id='total_price_" + flag + "' onclick='this.select();' onkeyup='input_comma(this);' onblur='calculationTotal(" + flag + ");' readonly /></td>";
