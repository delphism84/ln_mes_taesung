...
function postmachine(machine_uid, machine_nm) {
	...
	//window.close();
	var flag = $("#flag").val();
	$(opener.document).find("#machine_cd_"+ flag ).val(machine_uid);
	$(opener.document).find("#machine_nm_"+ flag ).val(machine_nm);
	...
	<div class="row">
		<div class="col-xs-12">
			...
			<form name="frm" id="frm" method="post" action="index.php" enctype="multipart/form-data" />
				<input type="hidden" name="flag" id="flag" value="<?=$_GET['flag']?>" />
