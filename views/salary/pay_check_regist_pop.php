						...
						<table id="simple-table" class="table  table-bordered table-hover">
									...
									<td>
										...
										<span class="input-icon input-icon-right">
											<div class="input-group">
												<input class=" date-picker" name="pay_check_dt" id="pay_check_dt" type="text" value="<?=date('Y/m')?>" data-date-format="yyyy/mm" style="width:100px" />
												<span class="input-group-addon">
													<i class="fa fa-calendar bigger-110"></i>
												</span>
												<span>&nbsp;
												(급여차수<select name="pay_check_ca" id="pay_check_ca">
												<option value="1">1</option></select>)
												</span>
												<span id="lblPDate1">aa
												</span>
								...
								<td>
									<div>
										<span class="input-icon input-icon-right">
											<div class="input-group">
												<input class=" date-picker" name="scdate" id="scdate" type="text" value="<?=date('Y/m/')."/1"?>" data-date-format="yyyy/mm/dd" style="width:100px"/>
												<span class="input-group-addon">
													<i class="fa fa-calendar bigger-110"></i>
												</span>
											</div>
										...
										<span class="input-icon input-icon-right">
											<div class="input-group">
												<input class=" date-picker" name="ecdate" id="ecdate" type="text" value="<?=date('Y/m/')."/".$end_day?>" data-date-format="yyyy/mm/dd" style="width:100px"/>
												<span class="input-group-addon">
													<i class="fa fa-calendar bigger-110"></i>
												</span>
											</div>
								...
								<tr>
								  ...
								  <td>
									<div>
										<span class="input-icon input-icon-right">
											<div class="input-group">
												<input class=" date-picker" name="paydate" id="paydate" type="text" value="<?=date('Y/m/d')?>" data-date-format="yyyy/mm/dd" style="width:100px"/>
												<span class="input-group-addon">
													<i class="fa fa-calendar bigger-110"></i>
												</span>
											</div>
								...
								<tr>
								  ...
								  <td>
									<div>
										<span class="input-icon input-icon-right">
											<div class="input-group">
												<input class=" date-picker" name="lastday" id="lastday" type="text" value="<?=date('Y/m')?>" data-date-format="yyyy/mm" style="width:100px"/>
												<span class="input-group-addon">
													<i class="fa fa-calendar bigger-110"></i>
												</span>
											</div>
								...
								<tr id="trBonus2" style="display: none;">
									...
									<td>
										<div>
											<span class="input-icon input-icon-right">
												<div class="input-group">
													<input class=" date-picker" name="sbonusdate" id="sbonusdate" type="text" value="<?=date('Y/m')?>" data-date-format="yyyy/mm" style="width:100px"/>
													<span class="input-group-addon">
														<i class="fa fa-calendar bigger-110"></i>
													</span>
												</div>
											...
											<span class="input-icon input-icon-right">
												<div class="input-group">
													<input class=" date-picker" name="ebonusdate" id="ebonusdate" type="text" value="<?=date('Y/m')?>" data-date-format="yyyy/mm" style="width:100px"/>
													<span class="input-group-addon">
														<i class="fa fa-calendar bigger-110"></i>
													</span>
												</div>
								...
								<tr id="trBonus3" style="display: none;">
									...
									<td>
										<span id="payrateflag" name="payrateflag" onclick="ChangePayRateFlag();"><input id="payrateflag_0" type="radio" name="payrateflag" value="0" checked="checked" /><label for="payrateflag_0">지급률(%)&nbsp;&nbsp;</label><input id="payrateflag_1" type="radio" name="payrateflag" value="1" /><label for="payrateflag_1">지급액</label></span>
										<span id="divPayRate1">
										<input name="payrate" type="text" id="payrate" class="defaultright" style="width:50px;" />%
										</span>
								...
								<tr id="trBonus4" style="display: none;">
									...
									<td>
										<span id="bonusapplyflag"><input id="bonusapplyflag_0" type="radio" name="bonusapplyflag" value="0" checked="checked" /><label for="bonusapplyflag_0">급여대장기준&nbsp;&nbsp;</label><input id="bonusapplyflag_1" type="radio" name="bonusapplyflag" value="1" /><label for="bonusapplyflag_1">사원등록기준</label></span><br />
									</td>
								</tr>        
								<tr>
								...
								<tr>
									...
									<td><input name="paydes" type="text" maxlength="30" id="paydes" class="default" style="width:200px;" /></td>
								</tr>
								<tr>
								  <th id="th8" style="background-color:#f1f1f1;">급여명세서하단</th>
								  <td><input name="paycomment" type="text" value="※수고하셨습니다" maxlength="100" id="paycomment" class="default" style="width:200px;" /></td>
								</tr>
							</table>    
					</form>
				</div>
