			...
			<div class="row">
				...
				<table id="payroll_book_list" class="table table-bordered table-hover" summary="" class="insa">
					<thead>
						...
						<th class="center col-xs-1" style="background-color:#f1f1f1">잔업수당</th>
						<th class="center col-xs-1" style="background-color:#f1f1f1">특근수당</th>
						<th class="center col-xs-1" style="background-color:#f1f1f1">특근잔업</th>
						...
						<th class="center col-xs-1" style="background-color:#f1f1f1">식대</th>
						<th class="center col-xs-1" style="background-color:#f1f1f1">차량유지비</th>
						<th class="center col-xs-1" style="background-color:#f1f1f1">상여</th>
						<th class="center col-xs-1" style="background-color:#f1f1f1">지급총액</th>
						...
						<th class="center col-xs-1" style="background-color:#f1f1f1">공제총액</th>
						<th class="center col-xs-1" style="background-color:#f1f1f1">실지급액</th>
						</tr>
					</thead>
					<tbody></tbody>
				</table>
				...
				<div class="row" class="col-xs-12"><p class="test-right">[P. 1/1]</p><p class="float_right"><?echo date('Y-m-d H:i:s');?></p></div>
                </div> <!-- //contents-->
            </div><!-- //idPrint-->
		...
		function(json){
			if(json != null) {
				...
				for(var i = 0 ; i < json.length ; i++){
					tag += "<tr>";
					tag += "<td>";
					tag += "<input view='N' type='checkbox' id='chkRow' name='chkRow' value='"+ json[i].emp_cd +"' checked>" + json[i].emp_nm ;
					tag += "</td>";
					tag += "<td class='text-right price1'>" + json[i].txtPayAmt1_arr_sum + "</td>";
					tag += "<td class='text-right price2'></td>";
					tag += "<td class='text-right price3'></td>";
					tag += "<td class='text-right price4'></td>";
					tag += "<td class='text-right price5'>12</td>";
					tag += "<td class='text-right price6'></td>";
					tag += "<td class='text-right price7'></td>";
					tag += "<td class='text-right price8'></td>";
					tag += "<td class='text-right price9'></td>";
					tag += "<td class='text-right price10'></td>";
					tag += "</tr>";
					tag += "<tr>";
					tag += "<td class='text-right'><a href='javascript:void(0);'  onclick='payCheck_modiy(" + json[i].uid + "," + json[i].pay_check_dt + "," + json[i].pay_check_ca + ");'>" + json[i].emp_cd + "</a></td>";
					tag += "<td class='text-right price11'></td>";
					tag += "<td class='text-right price12'></td>";
					tag += "<td class='text-right price13'></td>";
					tag += "<td class='text-right price14'>" + json[i].txtPayAmt2_arr_sum + "</td>";
					tag += "<td class='text-right price15'>" + json[i].txtPayAmt_sum + "</td>";
					tag += "<td class='text-right price16'></td>";
					tag += "<td class='text-right price17'></td>";
					tag += "<td class='text-right price18'></td>";
					tag += "<td class='text-right price19'></td>";
					tag += "<td class='text-right price20'>" + json[i].txtPayAmt_sum + "</td>";
					tag += "</tr>";
				}


					//tag += "<tfoot class='border_line'>";
					tag += "<tr style='background-color:#f1f1f1;border:1px solid #036;' >";
					tag += "<td width='80' rowspan='2' class='center' style='vertical-align:middle'><strong>합계("+json[0].total_num+"명)</strong></td>";
					tag += "<td width='104' class='text-right' id='total_amount1'>"+json[0].txtPayAmt1_hap+"</td>";
					tag += "<td width='104' class='text-right' id='total_amount2'>&nbsp;</td>";
					tag += "<td width='104' class='text-right' id='total_amount3'>&nbsp;</td>";
					tag += "<td width='104' class='text-right' id='total_amount4'>&nbsp;</td>";
					tag += "<td width='104' class='text-right' id='total_amount5'>&nbsp;</td>";
					tag += "<td width='78' class='text-right' id='total_amount6'>&nbsp;</td>";
					tag += "<td width='78' class='text-right' id='total_amount7'>&nbsp;</td>";
					tag += "<td width='78' class='text-right' id='total_amount8'>&nbsp;</td>";
					tag += "<td width='78' class='text-right' id='total_amount9'>&nbsp;</td>";
					tag += "<td width='78' class='text-right' id='total_amount10'>&nbsp;</td>";
					tag += "</tr>";
					tag += "<tr style='background-color:#f1f1f1'>";
					tag += "<td width='104' class='text-right' id='total_amount11'>&nbsp;</td>";
					tag += "<td width='104' class='text-right' id='total_amount12'>&nbsp;</td>";
					tag += "<td width='104' class='text-right' id='total_amount13'>&nbsp;</td>";
					tag += "<td width='104' class='text-right' id='total_amount14'>&nbsp;</td>";
					tag += "<td width='104' class='text-right' id='total_amount15'><strong></strong></td>";
					tag += "<td width='78' class='text-right' id='total_amount16'>&nbsp;</td>";
					tag += "<td width='78' class='text-right' id='total_amount17'>&nbsp;</td>";
					tag += "<td width='78' class='text-right' id='total_amount18'>&nbsp;</td>";
					tag += "<td width='78' class='text-right' id='total_amount19'><strong>&nbsp;</strong></td>";
					tag += "<td width='78' class='text-right' id='total_amount20'><strong>&nbsp;</strong></td>";
					tag += "</tr>";
					//tag += "</tfoot>";	
			} else{
					tag += "<tr>";
			...
			$("#payroll_book_list tbody").html(tag);
					...
					for(i = 1; i <= 20; i++){
						...
						$(".price"+i).each(function() {
							sum += Number(Money2Num($(this).text()));
						});
						$('#total_amount'+i).html(Num2Money(sum));
						sum = 0;
					}
