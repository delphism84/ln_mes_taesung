...
<?
$array_uid = explode(",",substr($uid,1,strlen(trim($uid))));
...
$sql = "select * from erp_warehousing_item where fid in (".$uids.")";
//echo $sql;
									...
									<td style='width:50%;'>
										...
										<tbody>
											<tr style="height:20px">
												<th class="col-xs-2" colspan="2" style="vertical-align: middle;white-space:nowrap;text-align:center;font-size:16pt;">자재 TAG <!-- <button id="btnPrint" class="btn btn-primary btn-xs" onclick="BarcodePrintElem('<?=$barcode[$i]?>')"> Barcode Print </button> --></th>
											</tr>	
