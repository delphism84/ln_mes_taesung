...
<?
//	if ($mode=="modify"){
	$sql = "Select * From erp_warehousing where uid = ".$uid;
	//echo $sql."<br>"; 
			...
			<div id="idPrint" class="p-relative" style="margin-top:30px">
				<div class="virtualpage hidepiece" printtype="page">
					<div id="rpt_contents_new">
						...
						<TBODY>
							<TR>
							<TD style="TEXT-ALIGN: center; WIDTH: 99%; HEIGHT: 30px; FONT-SIZE: 20px; FONT-WEIGHT: bold"><U>구 매 전 표</U></TD>
                    ...
                    <table class="p_rptC" style="width:650px;table-layout:fixed;word-break:break-all; word-wrap: break-word;">
                        ...
                        <tbody>
						<?
					$sql = "Select * From erp_warehousing_item where fid = '".$t->uid."'";
					//echo $sql."<br>";  
					$result = mysql_query($sql);
					...
					if ($result){
						if ($cnt>"0"){
							...
							?>	
					<TR height=19>
					<TD style="OVERFLOW: hidden" class=" left font11px"><?=substr($t1->warehousing_cd,5,5)?></TD>
