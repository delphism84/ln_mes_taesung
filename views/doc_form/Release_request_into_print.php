...
//	if ($mode=="modify"){
	...
	$sql = "select * From erp_release_request where uid = ".$uid;
	//echo $sql."<br>"; 
				...
				<div class="virtualpage hidepiece" printtype="page">
                    ...
                    <table class="p_rptC" style="width:650px;table-layout:fixed;word-break:break-all; word-wrap: break-word;">
                        ...
                        <tr>
                                ...
                                <th style="height:22px">품목명</th>
                        
                                <th style="height:22px">규격</th>

				<th style="height:22px">재질</th>

				<th style="height:22px">수량(중량)</th>
                        
                                <th style="height:22px">비고</th>
                        
                        </tr>
                        </thead>
                        <tbody>
						<?
					$sql = "Select * From erp_release_request_item where rid = '".$t->uid."'";
					//echo $sql."<br>";  
					$result = mysql_query($sql);
					...
					if ($result){
						if ($cnt>"0"){
							...
							?>	
					<TR height=19>
					<TD style="OVERFLOW: hidden" class="center font11px"><?=$ct?></TD>
					<TD style="OVERFLOW: hidden" class="left font11px"><?=$t1->item_nm?></TD>
					<TD style="OVERFLOW: hidden" class="font11px"><?=$t1->standard1?></TD>
					<TD style="OVERFLOW: hidden" class="font11px"><?=$t1->material?></TD>
					<TD style="OVERFLOW: hidden" class="right font11px"><?=number_format($t1->cnt)?><?=$t1->unit?></TD>
					<TD style="OVERFLOW: hidden" class="leftfont11px"><?=$t->memo?></TD></TR>
					<?
								$ct++;
								}
							}
