...
<?
//	if ($mode=="modify"){
	$sql = "Select * From erp_purchase_demand where uid = ".$porder_cd;
	echo $sql."<br>"; 
...
<TABLE style="WIDTH: 650px; BORDER-COLLAPSE: collapse; MARGIN-BOTTOM: 5px; COLOR: #000; FONT-SIZE: 12px" border=0 cellSpacing=0 cellPadding=0>
						<TBODY>
							<TR>
							<TD style="TEXT-ALIGN: center; WIDTH: 99%; HEIGHT: 30px; FONT-SIZE: 20px; FONT-WEIGHT: bold"><U>구 매 요 청 서</U></TD>
...
<table border="0" cellspacing="0" cellpadding="0" style="margin:0px 0px 5px 0px; width:650px; font-size:12px; color:#000; line-height:14px; border-left:1px solid #000; border-top:1px solid #000; border-collapse:collapse; table-layout:fixed">
    ...
    <tbody>
        <tr>
			...
			<td style="padding:3px 0px 2px 0px; word-wrap:break-word; border-right:1px solid #000; border-bottom:1px solid #000">&nbsp;<?=$t->purchase_cd?></td>
			...
			<td style="padding:3px 0px 2px 0px; word-wrap:break-word; border-right:1px solid #000; border-bottom:1px solid #000">&nbsp;<?=$t->warehouse_nm?></td>
        </tr>
        <tr>
			...
			<td style="padding:3px 0px 2px 0px; word-wrap:break-word; border-right:1px solid #000; border-bottom:1px solid #000">&nbsp;<?=getEmpNm($t->emp_id)?></td>
			...
			<td style="padding:3px 0px 2px 0px; word-wrap:break-word; border-right:1px solid #000; border-bottom:1px solid #000">&nbsp;<?=$t->purchase_expect_dt?></td>
        </tr>
        <tr>
			...
			<td style="padding:3px 0px 2px 0px; word-wrap:break-word; border-right:1px solid #000; border-bottom:1px solid #000">&nbsp;<?=$t->project_nm?></td>
			...
			<td style="padding:3px 0px 2px 0px; word-wrap:break-word; border-right:1px solid #000; border-bottom:1px solid #000">&nbsp;<?=$t->ref_des?>&nbsp;</td>
        </tr>
    </tbody>
</table>
...
<TD style="TEXT-ALIGN: right; PADDING-BOTTOM: 0px; PADDING-LEFT: 0px; PADDING-RIGHT: 17px; PADDING-TOP: 0px">(￦ <?=number_format($t->priceTotal)?>원) / VAT포함</TD></TR></TBODY></TABLE></DIV><!-- TopSql 끝 --><!-- 품목리스트 시작 -->
...
<TH style="HEIGHT: 25px">품목 및 규격</TH>
...
<?
					...
					if ($result){
						if ($cnt>"0"){
							...
							?>	
					<TR height=19>
					<TD style="OVERFLOW: hidden" class=" center font11px"><?=substr($t->purchase_dt,2,5)?></TD>
					<TD style="OVERFLOW: hidden" class=" left font11px"><?=$t1->item_nm?> <?=($t1->item_nm)? "[".$t1->standard1."]":""?></TD>
					<TD style="OVERFLOW: hidden" class=" left font11px"><?=$t1->account_nm?></TD>
