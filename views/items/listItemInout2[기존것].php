...
function getStock(page){
	...
	$.getJSON("ajax/stock.php",{"page":page, "mode":"getStock", "rpp" : rpp, "adjacents" : adjacents, "where" : where},
		function(json){
			if(json != null) {
				...
				for(var i = 0 ; i < json.length ; i++){
					...
					tag += "<td style='text-align:right'>" + json[i].pur_unit_price + "</td>";
