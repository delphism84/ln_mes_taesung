...
<!-- PAGE CONTENT BEGINS ---------------------------------------------------------------------------------------------------------------------------------------->
					<div class="widget-header">
						<div class="col-xs-6" style="float:left">
							<select id="per" onchange="getRelease(1)">
						...
						<div class="widget-main no-padding">
							<table id="work_list" class="table  table-bordered table-hover">
								<thead class="thin-border-bottom">
									<tr>
										<th class="col-xs-1"><i class="ace-icon fa fa-caret-right blue"></i> 지시서코드</th>
										<th class="col-xs-1"><i class="ace-icon fa fa-caret-right blue"></i> 출고공정</th>
										<th class="col-xs-1"><i class="ace-icon fa fa-caret-right blue"></i> 출고기계</th>
										...
										<th class="col-xs-1"><i class="ace-icon fa fa-caret-right blue"></i> 규격</th>
										<th class="col-xs-1"><i class="ace-icon fa fa-caret-right blue"></i> 규격</th>
										<th class="col-xs-1"><i class="ace-icon fa fa-caret-right blue"></i> 출고요청수량</th>
										<th class="col-xs-1"><i class="ace-icon fa fa-caret-right blue"></i> 현재고수량</th>
										<th class="col-xs-1"><i class="ace-icon fa fa-caret-right blue"></i> 요청자</th>
										<th class="col-xs-1"><i class="ace-icon fa fa-caret-right blue"></i> 요청일</th>
									</tr>
								</thead>
								<tbody></tbody>
							</table>
		...
		function(json){
			if(json != null) {
				...
				for(var i = 0 ; i < json.length ; i++){
					...
					tag += "<tr>";
					if(json[i].remain_cnt > 0)	tag += "<td><a href='index.php?controller=items&action=modifyPageRelease&uid=" + json[i].uid + "'>" + json[i].work_cd + "</a></td>";
