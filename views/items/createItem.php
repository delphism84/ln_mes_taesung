				...
				<div class="col-xs-12">
					...
					<form name="frm" id="frm" method="post" action="index.php"  enctype="multipart/form-data" />
						...
						<table id="simple-table" class="table  table-bordered table-hover">
							<tr>
								<th class="col-xs-1" style="background-color:#f1f1f1;">품목구분 <i class="fa fa-check red" aria-hidden="true"></i></th>
								<td class="col-xs-5">
									...
									<div class="input-group">
										<span class="input-icon input-icon-right">
											<div class="input-group">
												...
												<input type="text" name="item_group_nm" id="item_group_nm" readonly />
							...
							<tr>
								<th class="col-xs-1" style="background-color:#f1f1f1;">품목코드 <i class="fa fa-check red" aria-hidden="true"></i></th>
								<td class="col-xs-5">
									<input type="text" class="form-control" validation="yes" err="품목코드를 입력하세요" name="item_cd" id="item_cd" />
								</td>
								<th class="col-xs-1" style="background-color:#f1f1f1;">품목명 <i class="fa fa-check red" aria-hidden="true"></i></th>
								<td class="col-xs-5"><input type="text" class="form-control" validation="yes" err="품목명을 입력하세요" name="item_nm" id="item_nm" /></td>
							</tr>
							<tr>
								<th class="col-xs-1" style="background-color:#f1f1f1;">단위 <i class="fa fa-check red" aria-hidden="true"></i></th>
								<td class="col-xs-5"><input type="text" validation="yes" err="단위를 입력하세요" name="unit" id="unit" /></td>
								<th class="col-xs-1" style="background-color:#f1f1f1;">규격 <i class="fa fa-check red" aria-hidden="true"></i></th>
								<td class="col-xs-5">
									<div class="input-group">
										<span class="input-icon input-icon-right">
											<div class="input-group">
												<input type="text" validation="yes" err="규격을 입력하세요" name="standard" id="standard" readonly />
							...
							<tr>
								<th class="col-xs-1" style="background-color:#f1f1f1;">최소구매(생산)단위 <i class="fa fa-check red" aria-hidden="true"></i></th>
								<td class="col-xs-5"><input type="text" validation="yes" err="최소구매(생산)단위를 입력하세요" name="min_pur_unit" id="min_pur_unit" /></td>
								<th class="col-xs-1" style="background-color:#f1f1f1;">입고창고 <i class="fa fa-check red" aria-hidden="true"></i></th>
								<td class="col-xs-5">
									<div class="input-group">
										<span class="input-icon input-icon-right">
											<div class="input-group">
												<input type="hidden" name="warehouse_cd" id="warehouse_cd" readonly />
												<input type="text" validation="yes" err="입고창고를 입력하세요" name="warehouse_nm" id="warehouse_nm" readonly />
							...
							<tr>
								<th class="col-xs-1" style="background-color:#f1f1f1;">구매처 <i class="fa fa-check red" aria-hidden="true"></i></th>
								<td class="col-xs-5">
									<div class="input-group">
										<span class="input-icon input-icon-right">
											<div class="input-group">
												<input type="hidden" name="account_cd" id="account_cd" readonly />
												<input type="text" validation="yes" err="구매처를 입력하세요" name="account_nm" id="account_nm" readonly />
							...
							<tr>
								...
								<td class="col-xs-5"><input type="text" class="onlynum" name="base_stock_cnt" id="base_stock_cnt" /></td>
								<th class="col-xs-1" style="background-color:#f1f1f1;">안전재고수량 <i class="fa fa-check red" aria-hidden="true"></i></th>
								<td class="col-xs-5"><input type="text" class="onlynum" validation="yes" err="안전재고수량을 입력하세요" name="safety_stock_cnt" id="safety_stock_cnt" /></td>
							</tr>							
							<tr>
								<th class="col-xs-1" style="background-color:#f1f1f1">입고단가</th>
								<td class="col-xs-5"><input type="text" name="pur_unit_price" id="pur_unit_price" /></td>
								<th class="col-xs-1" style="background-color:#f1f1f1">출고단가</th>
								<td class="col-xs-5"><input type="text" name="unit_price" id="unit_price" /></td>
							</tr>
							<tr>
								<th class="col-xs-1" style="background-color:#f1f1f1">입고바코드</th>
								<td class="col-xs-5"><input type="text" class="form-control" name="in_barcode" id="in_barcode" /></td>
								<th class="col-xs-1" style="background-color:#f1f1f1">출고바코드</th>
								<td class="col-xs-5"><input type="text" class="form-control" name="barcode" id="barcode" /></td>
							</tr>
							<tr>
