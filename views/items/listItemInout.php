		...
		<div class="widget-header">
			<div class="row">
				<div class="col-xs-12" style="height:750px;">					
					<div class="col-xs-12" style="margin-top:5px; border:1px solid #ccc; height:100%;overflow: scroll;">
						<div style="height:750px; padding-top:10px">
							...
							<div class="col-xs-3"  style="float:right">
								<div class="input-group">						
									<input type="text" class="form-control search-query" placeholder="품목코드 검색" name="search_txt" id="search_txt" onkeypress="if(event.keyCode==13) {search(); return false;}"/>
...
//==================================================
function toggle(it) {
	$("#item_list tr").css("background-color","");
...
function getStock( page ){ 
	...
	$.getJSON("ajax/stock.php",{ "mode":"getWarehouseStock3", "page":page, "rpp" : rpp, "adjacents" : adjacents, "where" : $("#where").val() },
		function(json){
			if(json != null) {
				for(var i = 0 ; i < json.length ; i++){
					...
					tag += "<td nowrap><a href='#' onclick='stock_inout_pop(\""+ json[i].item_cd +"\",\""+ json[i].standard1 +"\")'>" + json[i].standard1+ "</a></td>";
...
//수불부 열기
function stock_inout_pop(cd,st)
	{
