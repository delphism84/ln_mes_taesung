			...
			<div class="row">
				<div class="col-xs-12">
					...
					<form id="frm" method="post" action="index.php">
						...
						<input type="hidden" name="action" id="action" value="registWarehouse" />
						<!-- 테이블 -->
						<table id="simple-table" class="table  table-bordered table-hover">
							<tr>
								...
								<td class="col-xs-5">
									<label>
										<input type="radio" class="ace" name="warehouse_gb" id="warehouse_gb" value="1" checked onclick="createWarehouseCode()" />
										<span class="lbl"> 창고</span>
									</label>

									<label>
										<input type="radio" class="ace" name="warehouse_gb" id="warehouse_gb" value="2" onclick="createWarehouseCode()" />
										<span class="lbl"> 공장</span>
									</label>

									<label>
										<input type="radio" class="ace" name="warehouse_gb" id="warehouse_gb" value="3" onclick="createWarehouseCode()" />
								...
								<td class="col-xs-5"><input type="text" class="form-control" name="warehouse_cd" id="warehouse_cd" readonly /></td>
							</tr>
							<tr>
								...
								<td class="col-xs-5"><input type="text" name="process_nm" id="process_nm" /></td>
							</tr>
							<tr>
