			...
			<div class="row">
				<div class="col-xs-12">
					...
					<form name="frm" id="frm" method="post" action="index.php"  enctype="multipart/form-data" />
						...
						<input type="hidden" name="attach" id="attach" value="<?=$t->attach?>" />
						...
						<table id="simple-table" class="table  table-bordered table-hover">
							...
							<tr>
								...
								<td class="col-xs-5"><input type="text" class="form-control" name="in_barcode" id="in_barcode" value="<?=$t->barcode?>" /></td>
								<th class="col-xs-1" style="background-color:#f1f1f1">출고바코드</th>
								<td class="col-xs-5"><input type="text" class="form-control" name="barcode" id="barcode" value="<?=$t->lot_no?>" /></td>
							</tr>
							<tr>
