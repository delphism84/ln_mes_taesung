						...
						<table id="item_list" class="table  table-bordered table-hover">
							<thead>
								<tr>
									...
									<th class="col-xs-1 center" style="background-color:#f1f1f1">이미지</th>
									...
									<th class="col-xs-1 center" style="background-color:#f1f1f1">그룹명</th>
									<th class="col-xs-1 center" style="background-color:#f1f1f1">규격명</th>
									<th class="col-xs-1 center" style="background-color:#f1f1f1">바코드</th>
									<th class="col-xs-1 center" style="background-color:#f1f1f1">입고단가</th>
									<th class="col-xs-1 center" style="background-color:#f1f1f1">출고단가</th>
								</tr>
							</thead>
							<tbody></tbody>
						</table>
			...
			<div class="clearfix form-actions center">
				<div class="col-md-12">
					...
					<div class="col-xs-6 right" style="text-align:right">
						<button class="btn btn-info" type="button" onclick="location.href = 'index.php?controller=items&action=inputPageItem' ">
...
function getItem(page){
	...
	$.getJSON("ajax/item.php",{"page":page, "mode":"getItem", "rpp" : rpp, "adjacents" : adjacents, "where":search, "item_gb":item_gb, "search_choice" : search_choice, "txt" : txt},
		function(json){
			if(json != null) {
				...
				for(var i = 0 ; i < json.length ; i++){
					...
					if(json[i].img != "") 	tag += "<td class='center'><a href='#' onclick='location.href = \"index.php?controller=items&action=modifyPageItem&uid=" + json[i].uid + "\"'><img src='attach/" + json[i].img + "' style='width:80px; height:40px' /></a></td>";
					else tag += "<td class='center'></td>";

					tag += "<td class='center'><a href='#' onclick='location.href = \"index.php?controller=items&action=modifyPageItem&uid=" + json[i].uid + "\"'>" + gb + "</a></td>";
					tag += "<td class='center'><a href='#' onclick='location.href = \"index.php?controller=items&action=modifyPageItem&uid=" + json[i].uid + "\"'>" + json[i].item_cd + "</a></td>";
					tag += "<td class='center'><a href='#' onclick='location.href = \"index.php?controller=items&action=modifyPageItem&uid=" + json[i].uid + "\"'>" + json[i].item_nm + "</a></td>";
					tag += "<td class='center'>" + json[i].item_group_nm + "</td>";
					tag += "<td class='center'>" + json[i].standard + "</td>";
					tag += "<td class='center'>" + json[i].barcode + "</td>";
					tag += "<td class='center'>" + json[i].pur_unit_price + "</td>";
					tag += "<td class='center'>" + json[i].unit_price + "</td>";
					tag += "</tr>";
				}
			}
