				...
				<div class="col-xs-12">
					...
					<form name="frm" id="frm" method="post" action="index.php"  enctype="multipart/form-data" />
						...
						<table id="simple-table" class="table  table-bordered table-hover">
							...
							<tr>
								<th class="col-xs-1" style="background-color:#f1f1f1;">길이 <i class="fa fa-check red" aria-hidden="true"></i></th>
								<td class="col-xs-5">
									<input type="text" name="item_cd" id="item_cd" /> X <input type="text" name="item_cd" id="item_cd" />
								</td>
								<th class="col-xs-1" style="background-color:#f1f1f1;">색상 <i class="fa fa-check red" aria-hidden="true"></i></th>
								<td class="col-xs-5"><input type="text" class="form-control" validation="yes" err="품목명을 입력하세요" name="item_nm" id="item_nm" /></td>
							</tr>
							<tr>
								<th class="col-xs-1" style="background-color:#f1f1f1;">무늬 <i class="fa fa-check red" aria-hidden="true"></i></th>
								<td class="col-xs-5"><input type="text" validation="yes" err="단위를 입력하세요" name="unit" id="unit" /></td>
								<th class="col-xs-1" style="background-color:#f1f1f1;">결 <i class="fa fa-check red" aria-hidden="true"></i></th>
								<td class="col-xs-5">
									<div class="input-group">
										<span class="input-icon input-icon-right">
											<div class="input-group">
							...
							<tr>
								<th class="col-xs-1" style="background-color:#f1f1f1;">파지수량 <i class="fa fa-check red" aria-hidden="true"></i></th>
								<td class="col-xs-5"><input type="text" validation="yes" err="최소구매(생산)단위를 입력하세요" name="min_pur_unit" id="min_pur_unit" /></td>
								<th class="col-xs-1" style="background-color:#f1f1f1;">보관창고 <i class="fa fa-check red" aria-hidden="true"></i></th>
								<td class="col-xs-5">
									<div class="input-group">
										<span class="input-icon input-icon-right">
											<div class="input-group">
