				...
				<div class="col-xs-12">
					...
					<form id="frm" method="post" action="index.php">
						...
						<table id="simple-table" class="table  table-bordered table-hover">
							<tr>
								<th class="col-xs-1" style="background-color:#f1f1f1">창고 구분</th>
								<td class="col-xs-5">
									<label>
										<input type="radio" class="ace" name="warehouse_gb" id="warehouse_gb" value="1" <? if($t->warehouse_gb == 1) echo "checked"; ?> />
										<span class="lbl"> 창고</span>
									</label>

									<label>
										<input type="radio" class="ace" name="warehouse_gb" id="warehouse_gb" value="2" <? if($t->warehouse_gb == 2) echo "checked"; ?> />
										<span class="lbl"> 공장</span>
									</label>

									<label>
										<input type="radio" class="ace" name="warehouse_gb" id="warehouse_gb" value="3" <? if($t->warehouse_gb == 3) echo "checked"; ?> />
										<span class="lbl"> 외주공장</span>
									</label>
								</td>
								<th class="col-xs-1" style="background-color:#f1f1f1"><i class="cf fa fa-check" aria-hidden="true"></i> 창고 코드</th>
								<td class="col-xs-5"><input type="text" class="form-control" name="warehouse_cd" id="warehouse_cd" value="<?=$t->warehouse_cd?>" readonly /></td>
							</tr>
							<tr>
								<th class="col-xs-1" style="background-color:#f1f1f1"><i class="cf fa fa-check" aria-hidden="true"></i> 창고명</th>
								<td class="col-xs-5"><input type="text" class="form-control" name="warehouse_nm" id="warehouse_nm" value="<?=$t->warehouse_nm?>" /></td>
								<th class="col-xs-1" style="background-color:#f1f1f1">생산공정명</th>
								<td class="col-xs-5"><input type="text" name="process_nm" id="process_nm" value="<?=$t->process_nm?>" /></td>
							</tr>
							<tr>
									...
									<div class="input-group">
										<span class="input-icon input-icon-right">
											<div class="input-group">
												...
												</span> <span class="summary">※ 외주공장은 거래처에 먼저 등록이 되어있어야 합니다.</span>
											</div>
										</span>
									</div>
								</td>
