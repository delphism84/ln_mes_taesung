						...
						<div class="col-xs-6" style="float:right">
							<div class="col-xs-4"  style="float:right">
								<div class="input-group">						
									<input type="text" class="form-control search-query" placeholder="Lot No" name="search_txt" id="search_txt" />
						...
						<div class="widget-main no-padding">
							<table id="item_list" class="table  table-bordered table-striped">
								<thead class="thin-border-bottom">
									<tr>
										<th class="col-xs-1"><i class="ace-icon fa fa-caret-right blue"></i> Lot No</th>
										...
										<th class="col-xs-1"><i class="ace-icon fa fa-caret-right blue"></i> 규격</th>
										<th class="col-xs-1"><i class="ace-icon fa fa-caret-right blue"></i> 규격</th>
										<th class="col-xs-4"><i class="ace-icon fa fa-caret-right blue"></i> 발생사유</th>	
									</tr>
								</thead>
								<tbody></tbody>
							</table>
...
<input type="hidden" name="where" id="where" value=" where lot_no<>''" />
...
function search(){
	...
	location.href = "index.php?controller=items&action=viewPageLotNo&lotno=" + txt;
}
...
function getLotNo(page){
	...
	$.getJSON("ajax/stock.php",{"page":page, "mode":"getLotNo", "rpp" : rpp, "adjacents" : adjacents, "where" : where},
		function(json){
			if(json != null) {
				//$("#total_num").html(json[0].total_num);
				for(var i = 0 ; i < json.length ; i++){
					tag += "<tr>";
					tag += "<td><a href='index.php?controller=items&action=viewPageLotNo&lotno=" + json[i].lot_no + "'>" + json[i].lot_no + "</a></td>";
