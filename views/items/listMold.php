							...
							<table id="order_list" class="table  table-bordered table-striped">
								<thead class="thin-border-bottom">
									<tr>
										...
										<th class="col-xs-2"><i class="ace-icon fa fa-caret-right blue"></i> 금형코드</th>
										<th class="col-xs-2"><i class="ace-icon fa fa-caret-right blue"></i> 도면</th>
										<th class="col-xs-2"><i class="ace-icon fa fa-caret-right blue"></i> 제작일자</th>
										<th class="col-xs-1"><i class="ace-icon fa fa-caret-right blue"></i> 수명</th>
										<th class="col-xs-1"><i class="ace-icon fa fa-caret-right blue"></i> 누적쇼트수</th>
										<th class="col-xs-1"><i class="ace-icon fa fa-caret-right blue"></i> 캐비티</th>
										<th class="col-xs-1"><i class="ace-icon fa fa-caret-right blue"></i> 생산시간</th>
									</tr>
								</thead>
								<tbody></tbody>
							</table>
					...
					<div class="clearfix form-actions" style="margin-top:0px">
						<div class="col-md-12">
							...
							<div class="col-xs-6 right" style="text-align:right">
								<button class="btn btn-info" type="button" onclick="location.href = 'index.php?controller=purchase&action=inputPagePurchaseDemand' ">
