		...
		<div class="page-content">
				...
				<div class="col-xs-12">
					<form name="frm" id="frm" method="post" action="index.php" enctype="multipart/form-data">
						...
						<table id="simple-table" class="table  table-bordered table-hover">
							<tr>
								<th class="col-xs-1" style="background-color:#f1f1f1"><i class="ace-icon fa fa-caret-right blue"></i> 입고일자</th>
							...
							<tr>
								<th class="col-xs-1" style="background-color:#f1f1f1"><i class="ace-icon fa fa-caret-right blue"></i> 발주서코드</th>
								<td class="col-xs-5">
									<div class="input-group">
										<span class="input-icon input-icon-right">
											<div class="input-group">
												<input type="hidden" name="estimate_uid" id="estimate_uid" readonly />
												<input type="text" name="estimate_cd" id="estimate_cd" onclick="centerOpenWindow('views/popup/estimateList.php', '발주서리스트', 600, 500)" readonly />
												<span class="input-group-addon btn-purple" onclick="centerOpenWindow('views/popup/estimateList.php', '발주서리스트', 600, 500)">
						...
						<table id="product" class="table  table-bordered table-hover" style="margin-top:10px">
							<thead>
								<tr>
									...
									<th class="center " style="background-color:#f1f1f1">Lot_no</th>
								</tr>
							</thead>
							<tbody></tbody>
							<tfoot>
			...
			<div class="clearfix form-actions center">
				<div class="col-md-12">
					...
					<button class="btn" type="reset" onclick="self.close()">
