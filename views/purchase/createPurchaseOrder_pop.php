				...
				<div class="col-xs-12">
					...
					<form name="frm" id="frm" method="post" action="index.php" enctype="multipart/form-data">
						...
						<table id="simple-table" class="table  table-bordered table-hover">
							<tr>
								<th class="col-xs-1" style="background-color:#f1f1f1"><i class="ace-icon fa fa-caret-right red"></i> 발주일자</th>
								<td class="col-xs-5">
									<div>
										<span class="input-icon input-icon-right">
											<div class="input-group">
												<input class=" date-picker" name="p_order_dt" id="p_order_dt" type="text" value=<?=date('Y/m/d')?> data-date-format="yyyy/mm/dd" />
								...
								<th class="col-xs-1" style="background-color:#f1f1f1"><i class="ace-icon fa fa-caret-right blue"></i> 구매요청서</th>
								<td class="col-xs-5">
									<div class="input-group">
										<span class="input-icon input-icon-right">
											<div class="input-group">
												<input type="hidden" name="purchase_uid" id="purchase_uid" readonly />
												<input type="text" name="purchase_cd" id="purchase_cd" onclick="centerOpenWindow('views/popup/purchaseDemandItemList.php', '구매요청서 Item 리스트', 1000, 800)" readonly />
												<span class="input-group-addon btn-purple" onclick="centerOpenWindow('views/popup/purchaseDemandItemList.php', '구매요청서 Item 리스트', 1000, 800)">
							...
							<tr>
								<th class="col-xs-1" style="background-color:#f1f1f1"><i class="ace-icon fa fa-caret-right red"></i> 납기일자</th>
								<td class="col-xs-5">
									<div>
										<span class="input-icon input-icon-right">
											<div class="input-group">
							...
							<tr>
								...
								<td class="col-xs-5">
									<select name="state" id="state" onchange="state_change(this.value)">
										<option value="0">구매요청</option>
										<option value="1">발주중</option>
										<option value="2">발주완료</option>
										<option value="3">발주취소</option>
										<option value="4">구매완료</option>
										<option value="5">입고완료</option>
						...
						<a class="btn btn-xs btn-success" onclick="centerOpenWindow('views/popup/pOrderItemList.php', '품목리스트', 900, 500)">품목선택</a>
		...
		function(json){
			if(json != null) {
				for(var i = 0 ; i < json.length ; i++){
					...
					tag += "<td><input type='text' class='form-control material' name='material[]' id='material_" + currentFlag + "' value='" + json[i].material + "'  /></td>";
