						...
						<div class="widget-main no-padding">
							<table id="simple-table" class="table  table-bordered table-hover">
								<tr>
									...
									<td><input type="text" name="barcode" id="barcode" onblur="registIn()"placeholder="바코드를 스캔해 주세요"  /></td>
								</tr>
								<tr>
									<th class="col-xs-1" style="background-color:#f1f1f1"><i class="ace-icon fa fa-caret-right blue"></i> 입고수량</th>
									<td><input type="text" name="cnt" id="cnt" placeholder="입고 수량을 입력해 주세요" /></td>
								...
								<td class="col-xs-5">
									...
									<td><button class="btn btn-info" type="button" onclick="formSubmit()">
	...
	$.getJSON("ajax/purchase.php",{"mode":"getBarcodeItem", "barcode" : barcode},
		function(json){
			if(json != null) {
					...
					tag += "<td>" + json.standard1 + "</td>";
					tag += "<td>" + json.material + "</td>";
					tag += "<td>" + json.unit + "</td>";
					tag += "<td>" + json.warehouse_nm + "</td>";
					tag += "<td>" + json.remain_cnt + "</td>";
					tag += "</tr>";
			}
