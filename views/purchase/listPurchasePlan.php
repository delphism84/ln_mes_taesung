							...
							<table id="estimate_list" class="table  table-bordered table-striped">
								<thead class="thin-border-bottom">
									<tr>
										...
										<?}?>
										<th class="col-xs-3"><i class="ace-icon fa fa-caret-right blue"></i> 발주계획서코드</th>
										<th class="col-xs-3"><i class="ace-icon fa fa-caret-right blue"></i> 발주품목</th>
										<th class="col-xs-3"><i class="ace-icon fa fa-caret-right blue"></i> 발주합계금액</th>
										<th class="col-xs-3"><i class="ace-icon fa fa-caret-right blue"></i> 작성일</th>
									</tr>
								</thead>
								<tbody></tbody>
							</table>
