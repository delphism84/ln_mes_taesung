			...
			<div class="row">
				<div class="col-xs-12">
					...
					<form name="frm" id="frm" method="post" action="index.php" enctype="multipart/form-data">
						...
						<a class="btn btn-xs btn-success" onclick="centerOpenWindow('views/popup/workPlanItemList.php?mode=modify', '품목리스트', 800, 500)">품목선택</a>
						<table id="workplan_item_bom" class="table  table-bordered table-hover" style="margin-top:10px">
							<thead>
								<tr>
									...
									<th class="center col-xs-1" style="background-color:#f1f1f1" nowrap>합계금액</th>
								</tr>
							</thead>
							<tbody>
							</tbody>
							<tfoot>
								<tr>
									...
									<th class="center col-xs-1" style="background-color:#f1f1f1" style="text-align:right;" nowrap><SPAN class="priceTotal"></SPAN></th>
								</tr>
							<tfoot>			
						</table>
					</form>
