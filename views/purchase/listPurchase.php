							...
							<table id="estimate_list" class="table  table-bordered table-striped">
								<thead class="thin-border-bottom">
									<tr>
										...
										<th class="col-xs-1"><i class="ace-icon fa fa-caret-right blue"></i> 주문수량</th>
										<th class="col-xs-1"><i class="ace-icon fa fa-caret-right blue"></i> 구매단가</th>
										<th class="col-xs-1"><i class="ace-icon fa fa-caret-right blue"></i> 총금액</th>
...
function deleteSelect(){
	if(confirm("선택하신 발주서 정보를 삭제하시겠습니까? 삭제시 구매(입고)에서도 삭제됩니다.")) {
		$(".chk").each(function(){
		...
		var dataString = "mode=deleteSelectPurchase&table=erp_estimate&uids=" + $("#check_uids").val();
		$.ajax({
			type : "post",
