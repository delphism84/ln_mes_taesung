						...
						<table id="simple-table" class="table  table-bordered table-hover">
							...
							<tr>
								...
								<td class="col-xs-5">
									<select name="currency " id="currency">
										...
										<option value="3" <?if($t->currency == 3) echo "selected";?> >엔화</option>
										<option value="4" <?if($t->currency == 4) echo "selected";?> >위안</option>
										<option value="5" <?if($t->currency == 5) echo "selected";?> >유로</option>
										<option value="6" <?if($t->currency == 6) echo "selected";?> >추가</option>
									</select>
								</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<? } ?>	
									...
									<label class="pl-1">
										<input name="switch-field-1" class="ace ace-switch ace-switch-6"  name="purchaseOrderAccount" id="purchaseOrderAccount" value='Y' type="checkbox" <? if($t->purchaseOrderAccount == "Y") echo "checked"; ?>/>
										<span class="lbl">&nbsp;회계 반영</span>
									</label>
									<label class="pl-2">
										<input name="switch-field-1" class="ace ace-switch ace-switch-6"  name="purchaseOrderState" id="purchaseOrderState" value='Y' type="checkbox" <? if($t->purchaseOrderState == "Y") echo "checked"; ?>/>
						...
						<table id="warehousing_item" class="table  table-bordered table-hover" style="margin-top:10px">
							<thead>
								<tr>
									...
									<th class="center col-xs-1" style="background-color:#f1f1f1;white-space: nowrap;">수입검사 일자</th>
								</tr>
							</thead>
							<tbody></tbody>
							<tfoot>
		...
		function(json){
			if(json != null) {
				for(var i = 0 ; i < json.length ; i++){
					...
					if(state =="2" || state =="3"){
						tag += "<td><input type='text' class='form-control cnt text-right' name='cnt[]' id='cnt_" + flag + "' onkeyup='calculation(" + flag + ");input_comma(this);' onclick='this.select();' onblur='calculationTotal(" + flag + ");' value='" + json[i].cnt + "' readonly/></td>";
					}else{
					...
					tag += "<td><input type='text' class='form-control unit_price text-right' name='unit_price[]' id='unit_price_" + flag + "' onkeyup='calculation(" + flag + ");input_comma(this);' onclick='this.select();' onblur='calculationTotal(" + flag + ");' value='" + json[i].unit_price + "' readonly/></td>";
					...
					tag += "<td><input type='text' class='form-control' name='inspection_cd[]' id='inspection_cd_" + flag + "' onclick=\"inspectionModifyPop(" + flag + ",'" + json[i].inspection_cd + "')\" value='" + json[i].inspection_dt + "' title='"+ json[i].inspection_cd +"'  readonly /></td>";
					tag += "</tr>";
