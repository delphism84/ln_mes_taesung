					...
					<form name="frm" id="frm" method="post" action="index.php" enctype="multipart/form-data">
						...
						<table id="simple-table" class="table  table-bordered table-hover">
							<tr>
								...
								<td class="col-xs-5">
									<input type="text" name="p_order_dt" id="p_order_dt" value="<?=$t->p_order_dt?>" readonly />-<input type="text" name="p_order_cha" id="p_order_cha" style="width:20pt" value="<?=$t->p_order_cha?>" disabled />
								</td>
								<th class="col-xs-1" style="background-color:#f1f1f1">발주일자서</th>
								<td class="col-xs-5">
							...
							<tr>
								...
								<td class="col-xs-5">
									<select name="state" id="state" onchange="tax_calculation(this.value)">
										<option value="1" <? if($t->state == 1) echo "selected"; ?>>발주진행</option>
