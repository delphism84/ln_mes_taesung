							...
							<table id="estimate_list" class="table  table-bordered table-striped">
								<thead class="thin-border-bottom">
									<tr>
										...
										<th class="col-xs-2"><i class="ace-icon fa fa-caret-right blue"></i> 수주(주문)코드</th>
										<th class="col-xs-2"><i class="ace-icon fa fa-caret-right blue"></i> 희망입고일</th>
										<th class="col-xs-2"><i class="ace-icon fa fa-caret-right blue"></i> 입고창고</th>
										<th class="col-xs-2"><i class="ace-icon fa fa-caret-right blue"></i> 품목수량</th>
