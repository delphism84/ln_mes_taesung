					...
					<table id="account_code_list" class="table  table-bordered table-hover">
						...
						<tbody>
							...
							<tr>
								...
								<?}?>
								<td class="col-xs-3">
									<input type="text" name="approval_name_<?=($i)?>" id="approval_name_<?=($i)?>" />
								</td>
								<td class="col-xs-3">
									<input type="text" name="approval_width_<?=($i)?>" id="approval_width_<?=($i)?>" />
								</td>
								<td class="col-xs-3">
								<select name="approval_font_<?=($i)?>" id="approval_font_<?=($i)?>">
					...
					<table id="account_code_list" class="table  table-bordered table-hover">
						...
						<tbody>
							...
							<tr>
								...
								<?}?>
								<td class="col-xs-3">
									<input type="text" name="approval_name2_<?=($j)?>" id="approval_name2_<?=($j)?>" />
								</td>
								<td class="col-xs-3">
									<input type="text" name="approval_width2_<?=($j)?>" id="approval_width2_<?=($j)?>" />
								</td>
								<td class="col-xs-3">
								<select name="approval_font2_<?=($j)?>" id="approval_font2_<?=($j)?>">
									<option value="9">9px</option>
									<option value="10">10px</option>
									<option value="11">11px</option>
									<option value="12">12px</option>
