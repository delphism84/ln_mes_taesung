		...
		<div class="breadcrumbs ace-save-state" id="breadcrumbs">
				...
				<div class="col-xs-12">
					...
					<form id="ac_frm" method="post" action="index.php">
						...
						<input type="hidden" name="action" id="action" value="registBankInsert" />
						
						<!-- 테이블 -->
						<table id="simple-table" class="table table-bordered table-hover">
							<tr>
								<th class="col-xs-2" style="background-color:#f1f1f1" colspan=2><i class="fa fa-arrow-circle-right" aria-hidden="true"></i> 통장계좌등록</th>
							</tr>
							
							<tr>
								<th class="col-xs-2" style="background-color:#f1f1f1"><i class="cf fa fa-check" aria-hidden="true"></i> 계좌번호</th>
								<td class="col-xs-10"><input type="text" name="bank_num" id="bank_num" /> <input type="button" id="confirmBankNum" value="중복확인" class="btn btn-inverse btn-sm"> <span id="id_signed"></span></td>
							</tr>
							<tr>
								<th class="col-xs-2" style="background-color:#f1f1f1"><i class="cf fa fa-check" aria-hidden="true"></i> 계좌명</th>
								<td class="col-xs-10"><input type="text" class="form-control" name="bank_name" id="bank_name" /></td>
								</tr>
							<tr>
								<th class="col-xs-2" style="background-color:#f1f1f1"><i class="cf fa fa-check" aria-hidden="true"></i> 계정코드</th>
								<td class="col-xs-10">
							...
							<tr>
								<th class="col-xs-2" style="background-color:#f1f1f1">외화통장</th>
								<td class="col-xs-10">
									<select name="pay_account_name" id="pay_account_name">
										<option value="미사용">미사용</option>
										<option value="프랑">프랑</option>
										<option value="달러">달러</option>
										<option value="유로">유로</option>
										<option value="엔화">엔화</option>
										<option value="직접등록가능">직접등록가능</option>
									</select>
								</td>
							</tr>
						</table>
...
<!--
	function formSubmit(){
	if(!check_str($("#bank_num").val(),"계좌번호")) return false;
	if(!check_str($("#bank_name").val(),"계좌명")) return false;
	$("#ac_frm").submit();
}
//-->
</script>
