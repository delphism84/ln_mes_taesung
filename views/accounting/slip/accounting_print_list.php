...
<!-- PAGE CONTENT BEGINS ---------------------------------------------------------------------------------------------------------------------------------------->
					...
					<div class="col-xs-12">
						...
						<table id="simple-table" class="table  table-bordered table-hover">
							...
							<tr>
								<th class="col-xs-2" style="background-color:#f1f1f1">계정</th>
								<td class="col-xs-5">
									<div class="input-group">
										<span class="input-icon input-icon-right">
											<div class="input-group">
								...
								<td class="col-xs-5">
									<input name="etc" id="etc" type="checkbox" checked="checked" value="0"><label for="etc" data-cid="etc" data-role="widget-focus">결산전표 포함</label>&nbsp;<input name="etc" id="etc" type="checkbox" value="1"><label for="etc" data-cid="etc" data-role="widget-focus">수정일자순(정렬)</label>
								</td>
							</tr>
							<tr>
					...
					<div style="margin-top:10px">
						<table id="general_ledger_account_list" class="table  table-bordered table-hover">
							<thead>
								<tr>
									<th class="col-xs-2 center" style="background-color:#f1f1f1" rowspan="2">전표번호</th>
									...
									<th class="col-xs-2 center" style="background-color:#f1f1f1">차변금액</th>
									<th class="col-xs-2 center" style="background-color:#f1f1f1">대변금액</th>
								</tr>
								<tr>
									<th class="col-xs-2 center" style="background-color:#f1f1f1" colspan="4">적요</th>
								</tr>
							</thead>
							<tbody></tbody>
						</table>
		...
		function(json){
			if(json != null) {
				...
				*/
				...
				tag += "<tr class='active'>";
                tag += "<td class='center' colspan='3'><b><style='color:#0066FF'>합계</font></b></td>";
