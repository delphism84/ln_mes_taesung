			...
			<div class="row">
				<div class="col-xs-12">
					...
					<form name="frm" id="frm" method="post" action="index.php">
						...
						<input type="hidden" name="action" id="action" value="registFixedAssetsDecreaseUpdate" />
						<input type="hidden" name="statement_ca" id="statement_ca" value="<?=$t->statement_ca?>" />
						...
						<table id="simple-table" class="table  table-bordered table-hover">
								...
								<td class="col-xs-10">
									<div class="input-group">
										<span class="input-icon input-icon-right">
											<div class="input-group">
												<input type="text" name="department_cd" id="department_cd" value="<?=$t->department_cd?>" readonly />
							...
							<tr>
								...
								<td class="col-xs-10">
									<select name="vattype" id="vattype">
										<option value="1" <? if($t->vattype == "1") echo "selected"; ?>>세금계산서</option>
										<option value="2" <? if($t->vattype == "2") echo "selected"; ?>>영세율</option>
										<option value="3" <? if($t->vattype == "3") echo "selected"; ?>>계산서</option>
										<option value="4" <? if($t->vattype == "4") echo "selected"; ?>>소매매출</option>
										<option value="5" <? if($t->vattype == "5") echo "selected"; ?>>수출</option>
										<option value="6" <? if($t->vattype == "6") echo "selected"; ?>>카드매출</option>
										<option value="7" <? if($t->vattype == "7") echo "selected"; ?>>계산서(고정자산)</option>
										<option value="8" <? if($t->vattype == "8") echo "selected"; ?>>세.계(고정자산)</option>
										<option value="9" <? if($t->vattype == "9") echo "selected"; ?>>소매(면세)</option>
										<option value="10" <? if($t->vattype == "10") echo "selected"; ?>>카드매출(면세)</option>
										<option value="11" <? if($t->vattype == "11") echo "selected"; ?>>현금영수증(면세)</option>
										<option value="12" <? if($t->vattype == "12") echo "selected"; ?>>현금영수증</option>
										<option value="13" <? if($t->vattype == "13") echo "selected"; ?>>매입자발행세금계산서</option>
										<option value="14" <? if($t->vattype == "14") echo "selected"; ?>>영세율(기타)</option>
										<option value="15" <? if($t->vattype == "15") echo "selected"; ?>>기타매출</option>
									</select>
								</td>
							</tr>
							<tr>
								...
								<td class="col-xs-10">
									<input name="tax_deduct" id="tax_deduct" type="radio" checked="checked" value="0" <? if($t->tax_deduct == "0") echo "checked"; ?>><label for="tax_deduct" data-cid="tax_deduct" data-role="widget-focus">정상</label>&nbsp;<input name="tax_deduct" id="tax_deduct" type="radio" value="1" <? if($t->tax_deduct == "1") echo "checked"; ?>><label for="tax_deduct" data-cid="tax_deduct" data-role="widget-focus">예정누락</label>
								</td>
							</tr>
							<tr>
								<th class="col-xs-2" style="background-color:#f1f1f1">세금계산서구분</th>
								<td class="col-xs-10" colspan=3>
									<select name="in_type_ectax_flag" id="in_type_ectax_flag">
										<option value="1" <? if($t->in_type_ectax_flag == "1") echo "selected"; ?>>종이(세금)계산서</option>
										<option value="2" <? if($t->in_type_ectax_flag == "2") echo "selected"; ?>>전자(세금)계산서-신규</option>
										<option value="3" <? if($t->in_type_ectax_flag == "3") echo "selected"; ?>>기재사항착오정정</option>
										<option value="4" <? if($t->in_type_ectax_flag == "4") echo "selected"; ?>>공급가액변동</option>
										<option value="5" <? if($t->in_type_ectax_flag == "5") echo "selected"; ?>>환입</option>
										<option value="6" <? if($t->in_type_ectax_flag == "6") echo "selected"; ?>>계약의해제</option>
										<option value="7" <? if($t->in_type_ectax_flag == "7") echo "selected"; ?>>내국신용장개설</option>
										<option value="8" <? if($t->in_type_ectax_flag == "8") echo "selected"; ?>>착오에의한이중발행</option>
									</select>
								</td>
							</tr>
							<tr>
							...
							<tr>
								<th class="col-xs-2" style="background-color:#f1f1f1">자산코드</th>
								<td class="col-xs-10">
									<div class="input-group">
										<span class="input-icon input-icon-right">
											<div class="input-group">
												<input type="text" name="fac_cd" id="fac_cd" value="<?=$t->fac_cd?>" readonly />
												<input type="text" name="fac_nm" id="fac_nm" value="<?=$t->fac_nm?>" readonly />
									...
									<div id="moreMenu">
										<div class="input-group" style="margin-bottom:2px"><span class="input-group-addon ">수량</span><input type="text" class="text-right" name="fac_qty" id="fac_qty" value="<?=$t->fac_qty?>"  /></div>
										<div class="input-group"><span class="input-group-addon ">잔량</span><input type="text" class="text-right" name="fac_res_qty" id="fac_res_qty" value="<?=$t->fac_res_qty?>"  /></div>
									</div>
								</td>
							</tr>
							
							<tr>
								<th class="col-xs-2" style="background-color:#f1f1f1">구분</th>
								<td class="col-xs-10">
									<input name="fad_gubun" id="fad_gubun" type="radio" checked="checked" value="0"  <? if($t->fad_gubun == "0") echo "checked"; ?>><label for="fad_gubun" data-cid="fad_gubun" data-role="widget-focus">매각</label>&nbsp;<input name="fad_gubun" id="fad_gubun" type="radio" value="1" <? if($t->fad_gubun == "1") echo "checked"; ?>><label for="fad_gubun" data-cid="fad_gubun" data-role="widget-focus">폐기</label>
								</td>
							</tr>
							<tr>
								<th class="col-xs-2" style="background-color:#f1f1f1">취득원가</th>
								<td class="col-xs-10">
									<input type="number" class="form-control text-right" name="acquisition_cost" id="acquisition_cost" onkeyup="calculation()" value="<?=$t->acquisition_cost?>" style="width:150px" /></td>
								</td>
							</tr> 
							<tr>
								<th class="col-xs-2" style="background-color:#f1f1f1">감가상각누계액</th>
								<td class="col-xs-10">
									<input type="text" class="form-control text-right" name="accumulated_amount" id="accumulated_amount" onkeyup="calculation()" value="<?=$t->accumulated_amount?>" style="width:150px" /></td>
								</td>
							</tr>
							<tr>
								<th class="col-xs-2" style="background-color:#f1f1f1">공급가액(매각액)</th>
								<td class="col-xs-10">
									<input type="text" class="form-control text-right" name="unit_price" id="unit_price" onkeyup="calculation()" value="<?=$t->unit_price?>" style="width:150px" /></td>
								</td>
							</tr>
							<tr>
								<th class="col-xs-2" style="background-color:#f1f1f1">부가세</th>
								<td class="col-xs-10">
									<input type="text" class="form-control text-right" name="tax" id="tax" style="width:150px" value="<?=$t->tax?>" /></td>
								</td>
							</tr>
							<tr>
								<th class="col-xs-2" style="background-color:#f1f1f1">수수료</th>
								<td class="col-xs-10">
									<input type="text" class="form-control text-right" name="fee" id="fee" onkeyup="calculation()" style="width:150px" value="<?=$t->fee?>" /></td>
								</td>
							</tr>
							<tr>
								<th class="col-xs-2" style="background-color:#f1f1f1">처분이익또는 처분손실</th>
								<td class="col-xs-10" ><input type="text" class="form-control text-right" name="gain_loss_disposition" id="gain_loss_disposition"  onkeyup="calculation()" style="width:150px" value="<?=$t->gain_loss_disposition?>" /></td>
							</tr>
							<tr>
								<th class="col-xs-2" style="background-color:#f1f1f1">처분손익계정</th>
								<td class="col-xs-10" colspan=3>
								<div class="input-group">
										<span class="input-icon input-icon-right">
											<div class="input-group">
												<input type="text" name="income_account_cd" id="income_account_cd" value="<?=$t->income_account_cd?>" readonly />
												<input type="text" name="income_account_nm" id="income_account_nm" value="<?=$t->income_account_nm?>" readonly />
							...
							<tr>
								...
								<td class="col-xs-10" colspan=3><input type="text" name="remark" id="remark" class="form-control" value="<?=$t->remark?>" /></td>
							</tr>
							<tr>
								<th class="col-xs-2" style="background-color:#f1f1f1">입금된계좌</th>
								<td class="col-xs-10">
									<div class="input-group">
										<span class="input-icon input-icon-right">
											<div class="input-group">
												<input type="text" name="bank_num" id="bank_num" value="<?=$t->bank_num?>" readonly/>
												<input type="text" name="bank_name" id="bank_name" value="<?=$t->bank_name?>" readonly />
							...
							<tr>
								...
								<button class="btn btn-link btn-xs" type="button" onclick="tax_invoice_reg('<?=$t->statement_dt."-".$t->statement_ca?>','s','<?=$t->unit_price?>')">
		...
		<div class="row">
			<div class="col-xs-12">
				<!-- PAGE CONTENT BEGINS ---------------------------------------------------------------------------------------------------------------------------------------->
					...
					<div style="clear:both"></div>
					<div style="margin-top:10px">
						<table id="fixed_assets_code" class="table  table-bordered table-hover">
							<thead>
								<tr>
									<th class="col-xs-6 center" style="background-color:#f1f1f1">자산코드</th>
									<th class="col-xs-6 center" style="background-color:#f1f1f1">자산명</th>
								</tr>
							</thead>
							<tbody></tbody>
						</table>
...
<div id="id-btn-dialog10" class="modal fade" >
...
// 고정자산코드 가져오기
function getfixedAssetsCode() {
	var rpp = 15;
	var adjacents = 4;
	var page = page;
	var tag = "";

	$.getJSON("ajax/fixedasset.php",{"page":page, "mode":"getFixedAssetsCode", "rpp" : rpp, "adjacents" : adjacents},//, "search_choice" : search_choice, "txt" : txt},
		function(json){
			if(json != null) {
				for(var i = 0 ; i < json.length ; i++){
					tag += "<tr>";
					tag += "<td><a href='javascript:void(0);'  onclick=\"postFACData('" + json[i].fac_cd + "', '" + json[i].fac_nm + "')\">" + json[i].fac_cd + "</a></td>";
					tag += "<td><a href='javascript:void(0);'  onclick=\"postFACData('" + json[i].fac_cd + "', '" + json[i].fac_nm + "')\">" + json[i].fac_nm + "</a></td>";
					tag += "</tr>";
				}
			}
			$("#fixed_assets_code tbody").html(tag);
			var table = "erp_fixed_assets_code";
			var where = "";
...
function postAccountCode(code,name){
	...
	$("#income_account_cd").val(code);
	$("#income_account_nm").val(name);
	//}
}
...
function postFACData(cd,nm) {
	$("#dialog-message6").dialog("close");
	$("#fac_cd").val(cd);
	$("#fac_nm").val(nm);

	if($("#moreMenu").css("display") == "none"){ 
		jQuery('#moreMenu').css("display", "block"); 
	} else {
		jQuery('#moreMenu').css("display", "none"); 
	}
...
function calculation() {
	...
	var values							= Number(removeComma(unit_price));
	var fee								= $("#fee").val(); 
	var acquisition_cost				= $("#acquisition_cost").val(); 
	var accumulated_amount				= $("#accumulated_amount").val(); 
	var gain_loss_disposition			= $("#gain_loss_disposition").val(); 
	...
	$("#unit_price").val(Num2Money(unit_price));
	$("#tax").val(commaSplit(Math.round(tax)));

	$("#fee").val(Num2Money(fee));
	$("#acquisition_cost").val(Num2Money(acquisition_cost));
	$("#accumulated_amount").val(Num2Money(accumulated_amount));
	$("#gain_loss_disposition").val(Num2Money(gain_loss_disposition));
...
function search(){
	...
	var arprice = removeComma($("#unit_price").val());
	var statementdt = removeComma($("#statement_dt").val());
	
	var url = "index.php?controller=accounting&action=registTaxInvoicePop&statement_dt="+statementdt+"&statement_no="+cidx+"&pop=Y&statement_type="+type+"&arprice="+arprice+"&dialogid=id-btn-dialog10";
	...
	var arprice = removeComma($("#unit_price").val());
	var url = "index.php?controller=accounting&action=modifyTaxInvoicePop&statement_no="+cidx+"&pop=Y&statement_type="+type+"&arprice="+arprice+"&dialogid=id-btn-dialog10";
	//var url = "./views/accounting/card/cardcompany_remark_list_pop.php?&gid="+cidx+"&pop=Y&ddd="+cidx;
...
jQuery(function($) {
	...
	$( "#id-btn-dialog6" ).on('click', function(e) {
		...
		var dialog = $( "#dialog-message6" ).removeClass('hide').dialog({
			...
			height:500,
			modal: true,
			title: "<div class='widget-header widget-header-small'><h4 class='smaller'><i class='ace-icon fa fa-check'></i>자산코드검색</h4></div>",
			title_html: true,
			buttons: [ 
				{
					text: "Cancel",
