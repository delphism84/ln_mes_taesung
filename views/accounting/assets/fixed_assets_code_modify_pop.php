			...
			<div class="row">
				<div class="col-xs-12">
					...
					<form name="frm" id="frm" method="post" action="index.php">
						...
						<input type="hidden" name="action" id="action" value="registFixedAssetsCodePopUpdate" />
						...
						<table id="simple-table" class="table  table-bordered table-hover">
							...
							<tr>
								<th class="col-xs-2" style="background-color:#f1f1f1">자산명</th>
								<td class="col-xs-10">
									<input type="text" class="form-control " name="fac_nm" id="fac_nm" value="<?=$t->fac_nm?>" />
								</td>
							</tr>
							<tr>
							...
							<tr>
								<th class="col-xs-2" style="background-color:#f1f1f1">고정자산유형</th>
								<td class="col-xs-10">
									<div class="input-group">
										<span class="input-icon input-icon-right">
											<div class="input-group">
												<input type="text" name="fat_cd" id="fat_cd" value="<?=$t->fat_cd?>" readonly />
												<input type="text" name="fat_nm" id="fat_nm" value="<?=$t->fat_nm?>" readonly />
												<span class="input-group-addon btn-purple" id="id-btn-dialog1">
													<i class="ace-icon fa fa-search icon-on-right bigger-110" style="color:#ffffff"></i>
												</span>
											</div>
							...
							<tr>
								...
								<td class="col-xs-10">
									<div class="input-group">
										<span class="input-icon input-icon-right">
											<div class="input-group">
												<input type="text" name="asset_ac_cd" id="asset_ac_cd" value="<?=$t->asset_ac_cd?>" readonly/>
												<input type="text" name="asset_ac_nm" id="asset_ac_nm" value="<?=$t->asset_ac_nm?>" readonly/>
							...
							<tr>
								...
								<td class="col-xs-10">
									<div class="input-group">
										<span class="input-icon input-icon-right">
											<div class="input-group">
												<input type="text" name="allowance_depreciation_cd" id="allowance_depreciation_cd" value="<?=$t->allowance_depreciation_cd?>" readonly />
												<input type="text" name="allowance_depreciation_nm" id="allowance_depreciation_nm" value="<?=$t->allowance_depreciation_nm?>" readonly />
							...
							<tr>
								...
								<td class="col-xs-10">
									<div class="input-group">
										<span class="input-icon input-icon-right">
											<div class="input-group">
												<input type="text" name="depreciation_cost_cd" id="depreciation_cost_cd" value="<?=$t->depreciation_cost_cd?>" readonly />
												<input type="text" name="depreciation_cost_nm" id="depreciation_cost_nm" value="<?=$t->depreciation_cost_nm?>" readonly />
							...
							<tr>
								...
								<td class="col-xs-10">
									<input name="depreciable_type" id="depreciable_type" type="radio" value="1" <? if($t->depreciable_type == "1" || $t->depreciable_type=="") echo "checked"; ?>><label for="tax_deduct" data-cid="tax_deduct" data-role="widget-focus">정액법</label>&nbsp;<input name="depreciable_type" id="depreciable_type" type="radio" value="2" <? if($t->depreciable_type == "2") echo "checked"; ?>><label for="tax_deduct" data-cid="tax_deduct" data-role="widget-focus">정률법</label>
								</td>
							</tr>
							<tr>
								<th class="col-xs-2" style="background-color:#f1f1f1">내용연수단위</th>
								<td class="col-xs-10">
									<input name="service_life_unit" id="service_life_unit" type="radio" checked="checked" value="1" <? if($t->service_life_unit == "1" || $t->service_life_unit=="") echo "checked"; ?>><label for="tax_deduct" data-cid="tax_deduct" data-role="widget-focus">년</label>&nbsp;<input name="service_life_unit" id="service_life_unit" type="radio" value="2" <? if($t->service_life_unit == "2") echo "checked"; ?>><label for="tax_deduct" data-cid="tax_deduct" data-role="widget-focus">월</label>
								</td>
							</tr>
							<tr>
								<th class="col-xs-2" style="background-color:#f1f1f1">내용연수</th>
								<td class="col-xs-10" colspan=3>
									<input type="text" class="form-control text-right" name="service_life" id="service_life" style="width:350px" placeholder="0" value="<?=number_format($t->service_life)?>" />
								</td>
							</tr>
							<tr>
								<th class="col-xs-2" style="background-color:#f1f1f1">잔존가치</th>
								<td class="col-xs-10">
									<input type="text" class="form-control text-right" name="salvage_value" id="salvage_value" onkeyup="calculation()" style="width:350px" placeholder="0" value="<?=number_format($t->salvage_value)?>" />
								</td>
							</tr>
							<tr>
								<th class="col-xs-2" style="background-color:#f1f1f1">상태</th>
								<td class="col-xs-10">
									<select name="status" id="status">
										<option value="1" <? if($t->status == "1") echo "selected"; ?>>보유</option>
										<option value="2" <? if($t->status == "1") echo "selected"; ?>>감가완료</option>
										<option value="3" <? if($t->status == "1") echo "selected"; ?>>매각</option>
										<option value="4" <? if($t->status == "1") echo "selected"; ?>>폐기</option>
									</select>
								</td>
							</tr>
							<tr>
								<th class="col-xs-2" style="background-color:#f1f1f1">비고</th>
								<td class="col-xs-10">
									<input type="text" class="form-control" name="remark" id="remark" value="<?=$t->remark?>" />
								</td>
							</tr>
							<tr>
								<th class="col-xs-2" style="background-color:#f1f1f1">사용중단여부</th>
								<td class="col-xs-10">
									<input name="use_yn" id="use_yn" type="radio" checked="checked" value="1" <? if($t->use_yn == "1" || $t->use_yn=="") echo "checked"; ?>><label for="tax_deduct" data-cid="tax_deduct" data-role="widget-focus">사용</label>&nbsp;<input name="use_yn" id="use_yn" type="radio" value="0" <? if($t->use_yn == "0") echo "checked"; ?>><label for="tax_deduct" data-cid="tax_deduct" data-role="widget-focus">중단</label>
								</td>
							</tr>
						</table>
					</form>
			...
			<div class="col-xs-12">
				<!-- PAGE CONTENT BEGINS ---------------------------------------------------------------------------------------------------------------------------------------->
					...
					<div style="margin-top:10px">
						<table id="fixed_assets_code_list" class="table  table-bordered table-hover">
							<thead>
								<tr>
									<th class="col-xs-6 center" style="background-color:#f1f1f1">유형코드</th>
									<th class="col-xs-6 center" style="background-color:#f1f1f1">유형명</th>
								</tr>
							</thead>
							<tbody></tbody>
						</table>
...
function getEmployee() {
	...
	$.getJSON("ajax/employee.php",{"mode":"getEmployee"},
		function(json){
			if(json != null) {
				for(var i = 0 ; i < json.length ; i++){
					tag += "<tr>";
					tag += "<td><a href='javascript:void(0);'  onclick=\"postEmp('" + json[i].emp_cd + "', '" + json[i].emp_nm + "')\">" + json[i].emp_cd + "</a></td>";
					tag += "<td><a href='javascript:void(0);'  onclick=\"postEmp('" + json[i].emp_cd + "', '" + json[i].emp_nm + "')\">" + json[i].emp_nm + "</a></td>";
					tag += "</tr>";
				}
			}
...
// 고정자산유형 가져오기
function getFixedAssetsType() {
	var rpp = 15;
	var adjacents = 4;
	var page = page;
	var tag = "";

	$.getJSON("ajax/fixedasset.php",{"page":page, "mode":"getFixedAssetsType", "rpp" : rpp, "adjacents" : adjacents},//, "search_choice" : search_choice, "txt" : txt},
		function(json){
			if(json != null) {
				for(var i = 0 ; i < json.length ; i++){
					tag += "<tr>";
					tag += "<td><a href='javascript:void(0);'  onclick=\"postFATData('" + json[i].fat_cd + "', '" + json[i].fat_cd + "')\">" + json[i].fat_cd + "</a></td>";
					tag += "<td><a href='javascript:void(0);'  onclick=\"postFATData('" + json[i].fat_cd + "', '" + json[i].fat_nm + "')\">" + json[i].fat_nm + "</a></td>";
					tag += "</tr>";
				}
			}
			$("#fixed_assets_code_list tbody").html(tag);
			var table = "erp_fixed_assets_type";
			var where = "";
