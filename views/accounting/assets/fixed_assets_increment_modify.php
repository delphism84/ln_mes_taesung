			...
			<div class="row">
				<div class="col-xs-12">
					...
					<form name="frm" id="frm" method="post" action="index.php">
						...
						<input type="hidden" name="action" id="action" value="registFixedAssetsIncrementUpdate" />
						...
						<table id="simple-table" class="table  table-bordered table-hover">
								...
								<td class="col-xs-10">
									<div class="input-group">
										<span class="input-icon input-icon-right">
											<div class="input-group">
												<input type="text" name="department_cd" id="department_cd" value="<?=$t->bank_num?>" readonly />
												<input type="text" name="department_nm" id="department_nm" value="<?=$t->bank_num?>" readonly />
							...
							<tr>
								...
								<td class="col-xs-10">
									<input type="text" class="form-control text-right" name="unit_price" id="unit_price" onkeyup="calculation()" style="width:150px" value="<?=$t->unit_price?>" /></td>
								</td>
							</tr>
							<tr>
