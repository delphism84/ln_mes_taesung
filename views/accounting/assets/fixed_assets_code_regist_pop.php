			...
			<div class="row">
				<div class="col-xs-12">
					...
					<form name="frm" id="frm" method="post" action="index.php">
						...
						<input type="hidden" name="action" id="action" value="registFixedAssetsCodePopInsert" />
						...
						<table id="simple-table" class="table  table-bordered table-hover">
							<tr>
								...
								<td class="col-xs-10">
									<input type="text" class="form-control " name="fac_cd" id="fac_cd" value="<?=$t->fac_cd?>" />
								</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td class="col-xs-10">
									<div class="input-group">
										<span class="input-icon input-icon-right">
											<div class="input-group">
												<input type="text" name="fat_cd" id="fat_cd" readonly />
												<input type="text" name="fat_nm" id="fat_nm" readonly />
							...
							<tr>
								...
								<td class="col-xs-10" colspan=3>
									<input type="text" class="form-control text-right" name="service_life" id="service_life" style="width:350px" placeholder="0" value="<?=$t->service_life?>" />
								</td>
							</tr>
							<tr>
								<th class="col-xs-2" style="background-color:#f1f1f1">잔존가치</th>
								<td class="col-xs-10">
									<input type="text" class="form-control text-right" name="salvage_value" id="salvage_value" onkeyup="calculation()" style="width:350px" placeholder="0" value="<?=$t->salvage_value?>" />
								</td>
							</tr>
							<tr>
								...
								<td class="col-xs-10">
									<select name="status" id="status">
										...
										<option value="2">감가완료</option>
										<option value="3">매각</option>
							...
							<tr>
								...
								<td class="col-xs-10">
									<input type="text" class="form-control" name="remark" id="remark" value="<?=$t->salvage_value?>" />
								</td>
							</tr>
							<tr>
...
function createFixedAssetsCodetCd(){
	var data_string = "mode=fixedAssetsCodetCd";
	$.ajax({
		type : "post",
...
jQuery(function($) {
	...
	$( "#id-btn-dialog2" ).on('click', function(e) {
		...
		var dialog = $( "#dialog-message2" ).removeClass('hide').dialog({
			...
			height:500,
			modal: true,
			title: "<div class='widget-header widget-header-small'><h4 class='smaller'><i class='ace-icon fa fa-check'></i>고정자산유형검색</h4></div>",
			title_html: true,
			buttons: [ 
				{
					text: "Cancel",
