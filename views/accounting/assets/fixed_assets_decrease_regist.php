			...
			<div class="row">
				<div class="col-xs-12">
					...
					<form name="frm" id="frm" method="post" action="index.php">
						...
						<input type="hidden" name="action" id="action" value="registFixedAssetsDecreaseInsert" />
						...
						<table id="simple-table" class="table  table-bordered table-hover">
							...
							<tr>
								...
								<td class="col-xs-10">
									<input name="fad_gubun" id="fad_gubun" type="radio" checked="checked" value="0"><label for="fad_gubun" data-cid="fad_gubun" data-role="widget-focus">매각</label>&nbsp;<input name="fad_gubun" id="fad_gubun" type="radio" value="1"><label for="fad_gubun" data-cid="fad_gubun" data-role="widget-focus">폐기</label>
								</td>
							</tr>
							<tr>
								<th class="col-xs-2" style="background-color:#f1f1f1">취득원가</th>
								<td class="col-xs-10">
									<input type="number" class="form-control text-right" name="acquisition_cost" id="acquisition_cost" onkeyup="calculation()" style="width:150px" /></td>
								</td>
							</tr> 
							<tr>
								<th class="col-xs-2" style="background-color:#f1f1f1">감가상각누계액</th>
								<td class="col-xs-10">
									<input type="text" class="form-control text-right" name="accumulated_amount" id="accumulated_amount" onkeyup="calculation()" style="width:150px" /></td>
								</td>
							</tr>
							<tr>
								<th class="col-xs-2" style="background-color:#f1f1f1">공급가액(매각액)</th>
								<td class="col-xs-10">
									<input type="text" class="form-control text-right" name="unit_price" id="unit_price" onkeyup="calculation()" style="width:150px" /></td>
								</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td class="col-xs-10" ><input type="text" class="form-control text-right" name="gain_loss_disposition" id="gain_loss_disposition"  onkeyup="calculation()" style="width:150px" /></td>
							</tr>
							<tr>
								...
								<div class="input-group">
										<span class="input-icon input-icon-right">
											<div class="input-group">
												<input type="text" name="income_account_cd" id="income_account_cd" value="" readonly />
												<input type="text" name="income_account_nm" id="income_account_nm" value="" readonly />
