...
<?
//	if ($mode=="modify"){
	$sql = "Select * From release_req where num = ".$est_cd;
	//echo $sql."<br>"; 
...
<body>
    ...
    <div id="wrap_pop">
        ...
        <style>
			.companyInfoHead {
				BORDER-BOTTOM: #000 1px solid; TEXT-ALIGN: center; PADDING-BOTTOM: 2px; PADDING-LEFT: 0px; PADDING-RIGHT: 0px; BACKGROUND: #f7f7f7; BORDER-RIGHT: #000 1px solid; PADDING-TOP: 2px;
			}
			.companyInfoContent {
				BORDER-BOTTOM: #000 1px solid; PADDING-BOTTOM: 0px; PADDING-LEFT: 0px; PADDING-RIGHT: 0px; WORD-WRAP: break-word; FONT-SIZE: 11px; BORDER-RIGHT: #000 1px solid; PADDING-TOP: 0px;
			}
			.customerInfoHead {
				BORDER-BOTTOM: #000 1px solid; TEXT-ALIGN: center; BORDER-LEFT: #000 1px solid; PADDING-BOTTOM: 2px; PADDING-LEFT: 0px; PADDING-RIGHT: 0px; BACKGROUND: #f9f9f9; BORDER-TOP: #000 1px solid; FONT-WEIGHT: bold; BORDER-RIGHT: #000 1px solid; PADDING-TOP: 3px
			}
			.customerInfoContent {
				BORDER-BOTTOM: #000 1px solid; WORD-WRAP: break-word; BORDER-TOP: #000 1px solid; BORDER-RIGHT: #000 1px solid
			}
			.bottomBox {
				margin:5px 0px 0px 0px; width:650px; font-size:12px; color:#000; line-height:14px; border-left:1px solid #000; border-top:1px solid #000; border-collapse:collapse; table-layout:fixed
			}
			.bottomHead {
				padding:4px 0 2px 0; text-align:center; font-weight:bold; background:#ececec; word-wrap:break-word; border-right:1px solid #000; border-bottom:1px solid #000
			}
			.bottomContent {
				padding:4px 0 2px 0; text-align:right; word-wrap:break-word; border-right:#000 1px solid; border-bottom:1px solid #000
			}
		</style>
        <center>
		<div id='print_page'>
        ...
        <input type="hidden" id="hidHeightParam" name="hidHeightParam"  /> <!--종이 인쇄시 호환성일경우 Page Break시 hidHeightParam 지정된 높이를 사용함 -->      
					...
					<TBODY>
					<TR>
					<TD style="PADDING-BOTTOM: 10px; LINE-HEIGHT: 25px; PADDING-LEFT: 0px; PADDING-RIGHT: 0px; HEIGHT: 50px; FONT-SIZE: 25px; FONT-WEIGHT: bold; PADDING-TOP: 0px"><U>출고요청서</U></TD></TR>
					<TR>
					...
					<TBODY>
					<TR>
					<TH class="companyInfoHead" rowSpan=4>공<BR><BR>급<BR><BR>자 </TH>
					<TH class="companyInfoHead">일련번호</TH>
					<TD class="companyInfoContent">&nbsp;<?=$out_no?></TD>
					<TH class="companyInfoHead">TEL</TH>
					<TD class="companyInfoContent">&nbsp;<?=$company_tel?></TD></TR>
					<TR>
					<TH class="companyInfoHead">사업자<BR>등록번호</TH>
					<TD class="companyInfoContent">&nbsp;<?=$company_reg_no?></TD>
					<TH class="companyInfoHead">성명</TH>
					<TD class="companyInfoContent">
						&nbsp;<?=$company_representative?>
						<div style="position:absolute">
							<img src="/userfiles/stampimg/stamp.png" style="width:40px;margin:-25px 0 0 30px;">
						</div>						
					</TD></TR>
					<TR>
					<TH class="companyInfoHead">상호</TH>
					<TD class="companyInfoContent" colSpan=3>&nbsp;<?=$company_full_name?></TD></TR>
					<TR>
					<TH class="companyInfoHead">주소</TH>
					<TD class="companyInfoContent" colSpan=3>&nbsp;<?=$company_address?></TD></TR></TBODY></TABLE></TD></TR></TBODY></TABLE>
					...
					<TBODY>
					<TR>
					<TH class="customerInfoHead">출고창고</TH>
					<TD class="customerInfoContent">&nbsp;<?=$wh_name?></TD>
					<TH class="customerInfoHead">출고예정일</TH>
					<TD class="customerInfoContent">&nbsp;<?=$expect_date?></TD></TR>
					<TR>
					<TH class="customerInfoHead">납품지주소</TH>
					<TD class="customerInfoContent" colSpan=3>&nbsp;(<?=$postcode?>)&nbsp;<?=$address?>&nbsp;<?=$address1?></TD></TR></TBODY></TABLE></DIV>
                    <!-- TopSql 끝 -->
                    <!-- 품목리스트 시작 -->
                    <table class="p_rptC" style="width:650px;table-layout:fixed;word-break:break-all; word-wrap: break-word;" >
                        ...
                        <tbody>
						<?
						$sql = "Select * From release_reqSub where out_no = '".$out_no."'";
						//echo $sql."<br>";  
						$result = mysql_query($sql);
						$cnt = mysql_num_rows($result);
						if ($result){
                    ...
                    <!-- 품목리스트 끝 -->
                    <table border="0" cellspacing="0" cellpadding="0" class="bottomBox">  
						<colgroup>
						...
						<tbody>
							<tr>     
								<td class="bottomHead">수량</td>
								<td class="bottomContent"><?=$QtyTotal?>&nbsp;</td>     
								<td class="bottomHead">인수</td>              
								<td class="bottomContent">인&nbsp;</td>          
							</tr>      
						</tbody>  
					</table>
                    <table border="0" cellspacing="0" cellpadding="0" class="bottomBox" style='height:150px;'>  
						<colgroup>
							<col style="width:20px" />
							<col />
						</colgroup>      
						<tbody>
							<tr>     
								<td class="bottomHead">비<br><br><br>고</td>
								<td class="bottomContent" style='text-align:left;vertical-align:top;padding:10px;'><?=$p_des?>&nbsp;</td>     
							</tr>      
						</tbody>  
					</table>                    
