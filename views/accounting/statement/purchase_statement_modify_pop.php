			...
			<div class="row">
				<div class="col-xs-12">
					...
					<form name="frm" id="frm" method="post" action="index.php">
						...
						<input type="hidden" name="action" id="action" value="registPurchaseStatementUpdate" />
						...
						<table id="simple-table" class="table  table-bordered table-hover">
							...
							<tr>
								...
								<td class="col-xs-10">
									<input type="text" class="form-control text-right" name="supply_price" id="supply_price"  value="<?=number_format($t->supply_price)?>" onkeyup="calculation()" style="width:150px" /></td>
								</td>
							</tr>
							<tr>
								<th class="col-xs-2" style="background-color:#f1f1f1">부가세</th>
								<td class="col-xs-10">
									<input type="text" class="form-control text-right" name="tax" id="tax" style="width:150px"  value="<?=number_format($t->tax)?>"/></td>
								</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td class="col-xs-10">
									<div class="input-group">
										<span class="input-icon input-icon-right">
											<div class="input-group">
												<input type="text" name="aci_cd" id="aci_cd"  value="<?=$t->aci_cd?>" readonly/>
												<input type="text" name="aci_nm" id="aci_nm"  value="<?=$t->aci_nm?>" readonly/>
							...
							<tr>
								<th class="col-xs-2" style="background-color:#f1f1f1">출금계좌</th>
								<td class="col-xs-10">
									<div class="input-group">
										<span class="input-icon input-icon-right">
											<div class="input-group">
							...
							<tr>
								...
								<td class="col-xs-10" colspan=3><input type="text" name="etc" id="etc" value="<?=$t->etc?>" class="form-control" /></td>
							</tr>
						</table>
					</form>
				</div>
