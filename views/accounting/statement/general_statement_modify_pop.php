		...
		<div class="page-content">
			...
			<div class="row">
				<div class="col-xs-12">
					...
					<form name="frm" id="frm" method="post" action="index.php">
						...
						<input type="hidden" name="action" id="action" value="registGeneralStatementUpdate" />
						...
						<table id="simple-table" class="table  table-bordered table-hover">
							<tr>
									...
									<div>
										<span class="input-icon input-icon-right">
											<div class="input-group">
												<input  type="text" name="statement_dt" id="statement_dt" value="<?=$t->statement_dt?>" style="width:100px" readonly/>
												<input  type="text" name="statement_ca" id="statement_ca" value="<?=$t->statement_ca?>" style="width:30px" readonly/>
											</div>
										</span>
									</div>
								</td>
								...
								<td class="col-xs-5">
									<select name="statement_type" id="statement_type">
										<option value="일반전표" <? if($t->statement_type == "일반전표") echo "selected"; ?>>일반전표</option>
										<option value="급여전표" <? if($t->statement_type == "급여전표") echo "selected"; ?>>급여전표</option>
										<option value="일용직급여전표" <? if($t->statement_type == "일용직급여전표") echo "selected"; ?>>일용직급여전표</option>
							...
							<tr>
								...
								<td class="col-xs-8" colspan=3><input type="text" name="summary" id="summary" class="form-control" value="<?=$t->summary?>"/></td>
							</tr>
						</table>
						...
						<table id="statement" class="table  table-bordered table-hover" style="margin-top:10px">
							<thead>
								<tr>
									<th class="detail-col center" style="background-color:#f1f1f1;width:30px"></th>
									<th class="center col-xs-1" style="background-color:#f1f1f1">구분</th>
									<th class="center col-xs-1" style="background-color:#f1f1f1">계정코드</th>
									...
									<th class="center col-xs-2" style="background-color:#f1f1f1">차변</th>
									<th class="center col-xs-2" style="background-color:#f1f1f1">대변</th>
									<th class="center col-xs-1" style="background-color:#f1f1f1">적요코드</th>
									<th class="center col-xs-1" style="background-color:#f1f1f1">적요</th>
									<th class="center col-xs-1" style="background-color:#f1f1f1">입력자</th>
								</tr>
							</thead>

							<!-- <input type="hidden" name="idx_arr[]" id="idx_arr[]" value='<?=$idx?>'>
							<td><input type="checkbox" name="check_1" class="check_po"></td>
							<td><input name="rel_date[]" id="plan_date[]" type="text" class="inpt1 w70p" value="<?=$rel_no_arr[0]?>"></td>
							<td><input name="rel_no[]" id="plan_no[]" type="text" class="inpt1 w40p" value="<?=$rel_no_arr[1]?>"></td>
							<td><input name="prod_cd[]" id="prod_cd[]" type="text" class="inpt1 w70p" value="<?=$prod_cd?>" onclick="searchItem('<?=$i?>');"></td>
							<td><input name="prod_des[]" id="prod_des[]" type="text" class="inpt1 w70p" value="<?=$prod_des?>"></td>
							<td><input name="size_des[]" id="size_des[]" type="text" class="inpt1 w70p" value="<?=$size_des?>"></td>
							<td><input name="qty[]" id="qty[]" type="text" class="inpt1 w70p right"  value="<?=$qty?>" onfocus="onFocus(this);" onblur="onBlur(this);calcQtyUnitCost(this);"></td>
							<td><input name="unit[]" id="unit[]" type="text" class="inpt1 w70p" value="<?=$unit?>"></td>
							<td><input name="price[]" id="price[]" type="text" class="inpt1 w70p right" class="text1" value="<?=$price?>" onfocus="onFocus(this);" onblur="onBlur(this);calcQtyUnitCost(this);"></td>
							<td><input name="supply_amt[]" id="supply_amt[]" type="text" class="inpt1 w70p right" value="<?=$supply_amt?>" onfocus="onFocus(this);" onblur="onBlur(this);calcAmount(this);"></td>
							<td><input name="vat_amt[]" id="vat_amt[]" type="text" class="inpt1 w70p right" value="<?=$vat_amt?>" onfocus="onFocus(this);" onblur="onBlur(this);calcTax(this);"></td>
							<td><input name="hap[]" id="hap[]" type="text" class="inpt1 w70p" value="<?=$hap?>"></td>
							<td><input name="remarks[]" id="remarks[]" type="text" class="inpt1 w70p" value="<?=$remarks?>"></td> -->
							...
							<tbody>
								...
								<tr class="item1">
									...
									<td><select name="slip_gubun[]" id="slip_gubun_1" onchange="slipgubunFlag(1);slipType(1)">
										<option value="1">1출</option>
										<option value="2">2입</option>
									...
									<td><input type="text" class="form-control id-btn-dialog1 account_cd" name="account_cd[]" id="account_cd_1" onclick="accountcdFlag(1)" readonly /></td>
									<td><input type="text" class="form-control " name="account_nm[]" id="account_nm_1" onkeyup="calculation(1)" /></td>
									<td><input type="text" class="form-control text-right" name="debtor[]" id="debtor_1" onclick="slipType(1)" onblur="calcDebtorTotal(this,1);" /></td>
									<td><input type="text" class="form-control text-right" name="creditor[]" id="creditor_1" onclick="slipType(1)" onblur="calcCreditorTotal(this,1);"/></td>
									<td><input type="text" class="form-control " name="remark_code[]" id="remark_code_1"  /></td>
									<td><input type="text" class="form-control " name="remark[]" id="remark_1"  /></td>
									<td><input type="text" class="form-control" name="writer[]" id="writer_1"  /></td>
								</tr>
								<tr class="item2">
									<input type="hidden" name="idx_arr[]" id="idx_arr_2" >
									<td class="center"><i class='delBtn fa fa-minus-square fa-1x' aria-hidden='true' onclick='delTr(this)'></i></td>
									<td><select name="slip_gubun[]" id="slip_gubun_2" onchange="slipgubunFlag(2);slipType(2)">
										<option value="1">1출</option>
										<option value="2">2입</option>
										<option value="3">3차</option>		
										<option value="4">4대</option>		
									...
									<td><input type="text" class="form-control id-btn-dialog1 account_cd" name="account_cd[]" id="account_cd_2" onclick="accountcdFlag(2)" readonly /></td>
									<td><input type="text" class="form-control account_nm" name="account_nm[]" id="account_nm_2" onkeyup="calculation(2)" /></td>
									<td><input type="text" class="form-control text-right" name="debtor[]" id="debtor_2" onclick="slipType(2)" onblur="calcDebtorTotal(this,2);"/></td>
									<td><input type="text" class="form-control text-right" name="creditor[]" id="creditor_2" onclick="slipType(2)" onblur="calcCreditorTotal(this,2);" /></td>
									<td><input type="text" class="form-control " name="remark_code[]" id="remark_code_2"  /></td>
									<td><input type="text" class="form-control " name="remark[]" id="remark_2"  /></td>
									<td><input type="text" class="form-control" name="writer[]" id="writer_2"  /></td>
								</tr>
								<tr class="item3">
									<input type="hidden" name="idx_arr[]" id="idx_arr_3" >
									<td class="center"><i class='delBtn fa fa-minus-square fa-1x' aria-hidden='true' onclick='delTr(this)'></i></td>
									<td><select name="slip_gubun[]" id="slip_gubun_3" onchange="slipgubunFlag(3);slipType(3)">
										<option value="1">1출</option>
										<option value="2">2입</option>
										<option value="3">3차</option>		
										<option value="4">4대</option>		
									...
									<td><input type="text" class="form-control id-btn-dialog1 account_cd" name="account_cd[]" id="account_cd_3" onclick="accountcdFlag(3)" readonly/></td>
									<td><input type="text" class="form-control account_nm" name="account_nm[]" id="account_nm_3" onkeyup="calculation(3)" /></td>
									<td><input type="text" class="form-control text-right" name="debtor[]" id="debtor_3" onclick="slipType(3)" onblur="calcDebtorTotal(this,3);" /></td>
									<td><input type="text" class="form-control text-right" name="creditor[]" id="creditor_3" onclick="slipType(3)" onblur="calcCreditorTotal(this,3);" /></td>
									<td><input type="text" class="form-control " name="remark_code[]" id="remark_code_3"  /></td>
									<td><input type="text" class="form-control " name="remark[]" id="remark_3"  /></td>
									<td><input type="text" class="form-control" name="writer[]" id="writer_3"  /></td>
								</tr>
								<tr class="item4">
									<input type="hidden" name="idx_arr[]" id="idx_arr_4" >
									<td class="center"><i class='delBtn fa fa-minus-square fa-1x' aria-hidden='true' onclick='delTr(this)'></i></td>
									<td><select name="slip_gubun[]" id="slip_gubun_4" onchange="slipgubunFlag(4);slipType(4)">
										<option value="1">1출</option>
										<option value="2">2입</option>
										<option value="3">3차</option>		
										<option value="4">4대</option>		
									...
									<td><input type="text" class="form-control id-btn-dialog1 account_cd" name="account_cd[]" id="account_cd_4" onclick="accountcdFlag(4)" readonly/></td>
									<td><input type="text" class="form-control account_nm" name="account_nm[]" id="account_nm_4" onkeyup="calculation(4)" /></td>
									<td><input type="text" class="form-control text-right" name="debtor[]" id="debtor_4" onclick="slipType(4)" onblur="calcDebtorTotal(this,4);" /></td>
									<td><input type="text" class="form-control text-right" name="creditor[]" id="creditor_4" onclick="slipType(4)" onblur="calcCreditorTotal(this,4);" /></td>
									<td><input type="text" class="form-control " name="remark_code[]" id="remark_code_4"  /></td>
									<td><input type="text" class="form-control " name="remark[]" id="remark_4"  /></td>
									<td><input type="text" class="form-control" name="writer[]" id="writer_4"  /></td>
								</tr>
								<tr>
									<th class="detail-col center" style="background-color:#f1f1f1;height:30px"><SPAN>&nbsp;</SPAN></th>
									<th class="center col-xs-1" style="background-color:#f1f1f1"><SPAN>&nbsp;</SPAN></th>
									<th class="center col-xs-1" style="background-color:#f1f1f1"><SPAN>&nbsp;</SPAN></th>
									<th class="center col-xs-1" style="background-color:#f1f1f1"><SPAN>&nbsp;</SPAN></th>
									<th class="center col-xs-1" style="background-color:#f1f1f1"><SPAN>&nbsp;</SPAN></th>
									<th class="center col-xs-1" style="background-color:#f1f1f1"><SPAN>&nbsp;</SPAN></th>
									<th class="center col-xs-2" style="background-color:#f1f1f1"><SPAN class="debtorTotal"></SPAN></th>
									<th class="center col-xs-2" style="background-color:#f1f1f1"><SPAN class="creditorTotal"></SPAN></th>
									<th class="center col-xs-1" style="background-color:#f1f1f1"><SPAN class="remarkAmount "></SPAN></th>
									<th class="center col-xs-1" style="background-color:#f1f1f1"><SPAN>&nbsp;</SPAN></th>
									<th class="center col-xs-1" style="background-color:#f1f1f1"><SPAN>&nbsp;</SPAN></th>
								</tr>
							</tbody>
						...
						<!-- <table class="table table-bordered" style="margin-top:-20px;">
							<thead>
								<tr>
									<th class="detail-col center" style="height:30px"></th>
									<th class="center col-xs-1" style="background-color:#f1f1f1"></th>
									<th class="center col-xs-1" style="background-color:#f1f1f1"></th>
									<th class="center col-xs-1" style="background-color:#f1f1f1"></th>
									<th class="center col-xs-1" style="background-color:#f1f1f1"></th>
									<th class="center col-xs-1" style="background-color:#f1f1f1"></th>
									<th class="center col-xs-2" style="background-color:#f1f1f1"></th>
									<th class="center col-xs-2" style="background-color:#f1f1f1"></th>
									<th class="center col-xs-1" style="background-color:#f1f1f1"></th>
									<th class="center col-xs-1" style="background-color:#f1f1f1"></th>
									<th class="center col-xs-1" style="background-color:#f1f1f1"></th>
			...
			<div class="clearfix form-actions center">
				<div class="col-md-12">
					...
					<button class="btn " type="button" onclick="javascript:openWinPrint();">
						<i class="ace-icon fa fa-minus-square bigger-110"></i>
						전표인쇄
					</button>
...
function addTr(){
	...
	tag += "<td><select name='slip_gubun[]' id='slip_gubun_" + currentFlag + "' onchange='slipType(" + currentFlag + ")'>";
	tag += "<option value='1'>1출</option>";
	tag += "<option value='2'>2입</option>";
	tag += "<option value='3'>3차</option>";		
	tag += "<option value='4'>4대</option>";		
	tag += "</select></td>";
	tag += "<td><input type='text' class='form-control id-btn-dialog aci_cd' name='aci_cd[]' id='aci_cd_" + currentFlag + "' onclick='acicdFlag(" + currentFlag + ")'  placeholder='품목선택을 하시려면 클릭하세요' readonly /></td>";
	tag += "<td><input type='text' class='form-control aci_nm' name='aci_nm[]' id='aci_nm_" + currentFlag + "' readonly /></td>";
	tag += "<td><input type='text' class='form-control id-btn-dialog1 account_cd' name='account_cd[]' id='account_cd_" + currentFlag + "' onclick='accountcdFlag(" + currentFlag + ")' readonly /></td>";
	tag += "<td><input type='text' class='form-control account_nm' name='account_nm[]' id='account_nm_" + currentFlag + "' onkeyup='calculation(" + currentFlag + ")' readonly/></td>";
	tag += "<td><input type='text' class='form-control text-right' name='debtor[]' id='debtor_" + currentFlag + "' onclick='slipType(" + currentFlag + ")' onblur='calcDebtorTotal(this," + currentFlag + ");'/></td>";
	tag += "<td><input type='text' class='form-control text-right' name='creditor[]' id='creditor_" + currentFlag + "' onclick='slipType(" + currentFlag + ")' onblur='calcCreditorTotal(this," + currentFlag + ");' /></td>";
	tag += "<td><input type='text' class='form-control' name='remark_code[]' id='remark_code_" + currentFlag + "'  /></td>";
...
function openWinPrint(){  
    window.open("/views/accounting/doc_form/print/statement_print.php", "전표인쇄", "width=800, height=700, toolbar=no, menubar=no, scrollbars=yes, resizable=yes" );  
}  
//-->  
</script> 
<script>
...
function getGeneralStatementItem(){
	var gid = $("#gid").val();
	var currentFlag = $("#flag").val();
	var tag = "";

	$.getJSON("ajax/statement.php",{"mode":"getGeneralStatementItem", "gid" : gid},
		function(json){
			if(json != null) {
				for(var i = 0 ; i < json.length ; i++){
					if(i < 4) {
						$("#idx_arr_" + currentFlag).val(json[i].uid);
						$("#slip_gubun_" + currentFlag).val(json[i].slip_gubun);
						$("#aci_cd_" + currentFlag).val(json[i].aci_cd);
						$("#aci_nm_" + currentFlag).val(json[i].aci_nm);
						$("#account_cd_" + currentFlag).val(json[i].account_cd);
						$("#account_nm_" + currentFlag).val(json[i].account_nm);
						$("#debtor_" + currentFlag).val(json[i].debtor);
						$("#creditor_" + currentFlag).val(json[i].creditor);
						$("#remark_code_" + currentFlag).val(json[i].remark_code);
						$("#remark_" + currentFlag).val(json[i].remark);
						$("#writer_" + currentFlag).val(json[i].writer);
					} else {
						tag += "<tr class='item" + currentFlag + "'>";
					...
					debtorTotalPrice('',currentFlag);
					creditorTotalPrice('',currentFlag);
...
function calculation(flag) {
	var slip_gubun = $("#slip_gubun option:selected").val();
