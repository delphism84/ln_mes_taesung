...
if ($arprice !="")
{
	...
	if ($statement_dt==""){
		...
		//$dt = substr($statement_dt,6,8);
		$date=str_replace(".","-",$statement_dt);
		$date=str_replace("/","-",$date);
		$date = date('m', strtotime($statement_dt));
		$day = date('d', strtotime($statement_dt));
	}
?>
					...
					<form name="frm" id="frm" method="post" action="index.php" >
						...
						<table id="simple-table" class="table  table-bordered table-hover">
							<tr>
								...
								<td class="col-xs-5">
									<input name="tax_invoice_dt" id="tax_invoice_dt" type="text" value='<?=date('Ymd')."-".$tax_invoice_ca?>'/>
								</td>
								<th class="col-xs-1" style="background-color:#f1f1f1">청구/영수</th>
								<td class="col-xs-5">
									<label>
										<input type="radio" class="ace" name="settle" id="settle" value="1" checked />
										<span class="lbl"> 청구</span>
									</label>

									<label>
										<input type="radio" class="ace" name="settle" id="settle" value="2" />
							...
							<tr>
								...
								<td class="col-xs-5">
									<input type="text" name="settle_amt1" id="settle_amt1" value="0" />
								</td>
								<th class="col-xs-1" style="background-color:#f1f1f1">수표</th>
								<td class="col-xs-5">
									<input type="text" name="settle_amt2" id="settle_amt2" value="0" />
								</td>
							</tr>
							<tr>
								<th class="col-xs-1" style="background-color:#f1f1f1">어음</th>
								<td class="col-xs-5"><input type="text" name="settle_amt3" id="settle_amt3" value="0" /></td>
								<th class="col-xs-1" style="background-color:#f1f1f1">외상매출금</th>
								<td class="col-xs-5">
									<input type="text" name="settle_amt4" id="settle_amt4" value="<?=@number_format($arprice)?>"/>
								</td>
							</tr>
							<tr>
								<th class="col-xs-1" style="background-color:#f1f1f1">비고</th>
								<td colspan="3" class="col-xs-11"><input type="text" class="form-control" name="summary" id="summary" /></td>
							</tr>
						</table>
							...
							<tbody>
								<tr class="item1">
									...
									<td ><select name="purchasedt1[]" id="purchasedt1_1" >
										<option value="1" <?echo $date == "1" ? "selected":""?>>1월</OPTION>
										<option value="2" <?echo $date == "2" ? "selected":""?>>2월</OPTION>
										<option value="3" <?echo $date == "3" ? "selected":""?>>3월</OPTION>
										<option value="4" <?echo $date == "4" ? "selected":""?>>4월</OPTION>
										<option value="5" <?echo $date == "5" ? "selected":""?>>5월</OPTION>
										<option value="6" <?echo $date == "6" ? "selected":""?>>6월</OPTION>
										<option value="7" <?echo $date == "7" ? "selected":""?>>7월</OPTION>
										<option value="8" <?echo $date == "8" ? "selected":""?>>8월</OPTION>
										<option value="9" <?echo $date == "9" ? "selected":""?>>9월</OPTION>
										<option value="10" <?echo $date == "10" ? "selected":""?>>10월</OPTION>
										<option value="11" <?echo $date == "11" ? "selected":""?>>11월</OPTION>
										<option value="12" <?echo $date == "12" ? "selected":""?>>12월</OPTION>
									</select>&nbsp;<input type="text" name="purchasedt2[]" id="purchasedt2_1" value="<?=$day?>" class="box" maxlength="2" style="width:30px" tabindex="1" ></td>
									...
									<td><input type="text" class="form-control cnt text-right" name="cnt[]" id="cnt_1" onkeyup="calculation(1)" value="0"/></td>
									<td><input type="text" class="form-control unit_price text-right" name="unit_price[]" id="unit_price_1" onkeyup="calculation(1)" value="0"/></td>
								...
								<tr class="item2">
									...
									<td><input type="text" class="form-control cnt text-right" name="cnt[]" id="cnt_2" onkeyup="calculation(2)" /></td>
								...
								<tr class="item3">
									...
									<td><input type="text" class="form-control cnt text-right" name="cnt[]" id="cnt_3" onkeyup="calculation(3)" /></td>
								...
								<tr class="item4">
									...
									<td><input type="text" class="form-control cnt text-right" name="cnt[]" id="cnt_4" onkeyup="calculation(4)" /></td>
								...
								<tr><th class="center" style="background-color:#f1f1f1;height:30px"><SPAN></SPAN></th>
									...
									<th class="center " style="background-color:#f1f1f1"><SPAN></SPAN></th>
									<th class="center " style="background-color:#f1f1f1"><SPAN ></SPAN></th>
									<th class="center " style="background-color:#f1f1f1"><SPAN class="supply_price_Total"><?=@number_format($supply_price)?></SPAN></th>
									<th class="center " style="background-color:#f1f1f1"><SPAN class="tax_Total "><?=@number_format($tax)?></SPAN></th>
									<th class="center " style="background-color:#f1f1f1;height:30px"><SPAN></SPAN></th>
								</tr>
							</tbody>
						</table>
...
function addTr(){
	...
	tag += "<td><input type='text' class='form-control ' name='remark[]' id='remark_" + currentFlag + "' readonly /></td>";
	tag += "</tr>";
