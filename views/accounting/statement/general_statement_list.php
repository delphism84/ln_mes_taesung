		...
		function(json){
			if(json != null) {
				...
				for(var i = 0 ; i < json.length ; i++){
					...
					tag += "<td class='center'>" + json[i].statement_type + "</td>";
...
<!--
	...
	var url = "index.php?controller=accounting&action=modifyGeneralStatementPop&gid="+gid+"&pop=Y&statement_dt="+dt+"&statement_ca="+ca+"&dialogid=id-btn-dialog2";
	//var url = "./views/accounting/card/cardcompany_remark_list_pop.php?&gid="+cidx+"&pop=Y&ddd="+cidx;
