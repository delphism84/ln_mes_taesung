...
<!-- PAGE CONTENT BEGINS ---------------------------------------------------------------------------------------------------------------------------------------->
					...
					<div class="col-xs-12">
						...
						<table id="simple-table" class="table  table-bordered table-hover">
							...
							<tr>
								<th class="col-xs-1" style="background-color:#f1f1f1">조회일자</th>
								<td class="col-xs-5">
									<div>
										<span class="input-icon input-icon-right">
											<div class="input-group">
												<input name="division" id="division" type="radio" checked="checked" value="0"><label for="division" data-cid="division" data-role="widget-focus">누계</label>&nbsp;<input name="division" id="division" type="radio" value="1"><label for="division" data-cid="division" data-role="widget-focus">월계</label>
							...
							<tr>
								...
								<td class="col-xs-5">
									<input name="etc" id="etc" type="checkbox" checked="checked" value="0"><label for="etc" data-cid="etc" data-role="widget-focus">결재방표시</label>&nbsp;<input name="etc" id="etc" type="checkbox" value="1"><label for="etc" data-cid="etc" data-role="widget-focus">천단위</label>&nbsp;<input name="etc" id="etc" type="checkbox" value="1"><label for="etc" data-cid="etc" data-role="widget-focus">결산후</label>
								</td>
							</tr>
							<tr>
					...
					<div style="margin-top:10px">
						<div class="col-xs-12 center"><H2>합계잔액시산표</H2></div>
						<div class="input-group col-xs-12 text-right"><span><?=date('Y/m')?></span></div>
						<table id="general_ledger_account_list" class="table  table-bordered table-hover">
							<thead>
								<tr>
									...
									<th class="col-xs-2 center" style="background-color:#f1f1f1">차변잔액</th>
									<th class="col-xs-2 center" style="background-color:#f1f1f1">차변합계</th>
									<th class="col-xs-2 center" style="background-color:#f1f1f1">계정명</th>
									<th class="col-xs-2 center" style="background-color:#f1f1f1">대변합계</th>
									<th class="col-xs-2 center" style="background-color:#f1f1f1">대변잔액</th>
								</tr>
							</thead>
							<tbody></tbody>
						</table>
