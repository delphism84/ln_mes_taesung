...
<!-- PAGE CONTENT BEGINS ---------------------------------------------------------------------------------------------------------------------------------------->
					...
					<div class="col-xs-12">
						...
						<table id="simple-table" class="table  table-bordered table-hover">
							<tr>
								...
								<td class="col-xs-1" colspan="3"><input name="division" id="division" type="radio" checked="checked" value="0"><label for="division" data-cid="division" data-role="widget-focus">전표입력계정</label>&nbsp;<input name="division" id="division" type="radio" value="1"><label for="division" data-cid="division" data-role="widget-focus">집계계정</label></td>
								</td>
							</tr>
							<tr>
							...
							<tr>
								<th class="col-xs-1" style="background-color:#f1f1f1">계정</th>
								<td class="col-xs-5">
									<div class="input-group">
										<span class="input-icon input-icon-right">
											<div class="input-group">
							...
							<tr>
								...
								<td class="col-xs-11" colspan="3">
									<input name="etc" id="etc" type="checkbox" checked="checked" value="0"><label for="etc" data-cid="etc" data-role="widget-focus">결재란표시</label>&nbsp;<input name="etc" id="etc" type="checkbox" checked="checked" value="0"><label for="etc" data-cid="etc" data-role="widget-focus">전월이월포함</label>							
								</td>
							</tr>
							<tr>
					...
					<div style="margin-top:10px">
						 ...
						 <div class="row">
							<div class="col-md-10 text-left">현금</div><div class="col-md-2 text-right">2017/11/19 ~ 2017/11/19 (단위 : 원)</div>
						</div>
						<table id="general_ledger_account_list" class="table  table-bordered table-hover">
							<thead>
								<tr>
									<th class="col-xs-4 center" style="background-color:#f1f1f1">계정명</th>
									<th class="col-xs-4 center" style="background-color:#f1f1f1">거래처명</th>
									<th class="col-xs-4 center" style="background-color:#f1f1f1">전일잔액</th>
									<th class="col-xs-4 center" style="background-color:#f1f1f1">증가</th>
									<th class="col-xs-4 center" style="background-color:#f1f1f1">감소</th>
									<th class="col-xs-4 center" style="background-color:#f1f1f1">금일잔액</th>
								</tr>
							</thead>
							<tbody></tbody>
						</table>
					...
					<div style="margin-top:10px">
						 ...
						 <div class="row">
							<div class="col-md-10 text-left">보통예금</div><div class="col-md-2 text-right">2017/11/19 ~ 2017/11/19 (단위 : 원)</div>
						</div>
						<table id="general_ledger_account_list" class="table  table-bordered table-hover">
							<thead>
								<tr>
									<th class="col-xs-4 center" style="background-color:#f1f1f1">계정명</th>
									<th class="col-xs-4 center" style="background-color:#f1f1f1">거래처명</th>
									<th class="col-xs-4 center" style="background-color:#f1f1f1">금액</th>
								</tr>
							</thead>
							<tbody></tbody>
						</table>
					...
					<div style="margin-top:10px">
						 ...
						 <div class="row">
							<div class="col-md-10 text-left">외상매출금</div><div class="col-md-2 text-right">2017/11/19 ~ 2017/11/19 (단위 : 원)</div>
						</div>
						<table id="general_ledger_account_list" class="table  table-bordered table-hover">
							<thead>
								<tr>
					...
					<div style="margin-top:10px">
						 ...
						 <div class="row">
							<div class="col-md-10 text-left">받을어음</div><div class="col-md-2 text-right">2017/11/19 ~ 2017/11/19 (단위 : 원)</div>
						</div>
						<table id="general_ledger_account_list" class="table  table-bordered table-hover">
							<thead>
								<tr>
					...
					<div style="margin-top:10px">
						 ...
						 <div class="row">
							<div class="col-md-10 text-left">가지급금</div><div class="col-md-2 text-right">2017/11/19 ~ 2017/11/19 (단위 : 원)</div>
						</div>
						<table id="general_ledger_account_list" class="table  table-bordered table-hover">
							<thead>
								<tr>
					...
					<div style="margin-top:10px">
						 ...
						 <div class="row">
							<div class="col-md-10 text-left">부가세대급금</div><div class="col-md-2 text-right">2017/11/19 ~ 2017/11/19 (단위 : 원)</div>
						</div>
						<table id="general_ledger_account_list" class="table  table-bordered table-hover">
							<thead>
								<tr>
					...
					<div style="margin-top:10px">
						 ...
						 <div class="row">
							<div class="col-md-10 text-left">외상매입금</div><div class="col-md-2 text-right">2017/11/19 ~ 2017/11/19 (단위 : 원)</div>
						</div>
						<table id="general_ledger_account_list" class="table  table-bordered table-hover">
							<thead>
								<tr>
					...
					<div style="margin-top:10px">
						 ...
						 <div class="row">
							<div class="col-md-10 text-left">지급어음</div><div class="col-md-2 text-right">2017/11/19 ~ 2017/11/19 (단위 : 원)</div>
						</div>
						<table id="general_ledger_account_list" class="table  table-bordered table-hover">
							<thead>
								<tr>
					...
					<div style="margin-top:10px">
						 ...
						 <div class="row">
							<div class="col-md-10 text-left">예수금</div><div class="col-md-2 text-right">2017/11/19 ~ 2017/11/19 (단위 : 원)</div>
						</div>
						<table id="general_ledger_account_list" class="table  table-bordered table-hover">
							<thead>
								<tr>
					...
					<div style="margin-top:10px">
						 ...
						 <div class="row">
							<div class="col-md-10 text-left">부가세예수금</div><div class="col-md-2 text-right">2017/11/19 ~ 2017/11/19 (단위 : 원)</div>
						</div>
						<table id="general_ledger_account_list" class="table  table-bordered table-hover">
							<thead>
								<tr>
					...
					<div style="margin-top:10px">
						 ...
						 <div class="row">
							<div class="col-md-10 text-left">퇴직급여(판)</div><div class="col-md-2 text-right">2017/11/19 ~ 2017/11/19 (단위 : 원)</div>
						</div>
						<table id="general_ledger_account_list" class="table  table-bordered table-hover">
							<thead>
								<tr>
					...
					<div style="margin-top:10px">
						 ...
						 <div class="row">
							<div class="col-md-10 text-left">제품매출</div><div class="col-md-2 text-right">2017/11/19 ~ 2017/11/19 (단위 : 원)</div>
						</div>
						<table id="general_ledger_account_list" class="table  table-bordered table-hover">
							<thead>
								<tr>
					...
					<div style="margin-top:10px">
						 ...
						 <div class="row">
							<div class="col-md-10 text-left">잡손실</div><div class="col-md-2 text-right">2017/11/19 ~ 2017/11/19 (단위 : 원)</div>
						</div>
						<table id="general_ledger_account_list" class="table  table-bordered table-hover">
							<thead>
								<tr>
					...
					<div style="margin-top:10px">
						 ...
						 <div class="row">
							<div class="col-md-10 text-left">복리후생비(판)</div><div class="col-md-2 text-right">2017/11/19 ~ 2017/11/19 (단위 : 원)</div>
						</div>
						<table id="general_ledger_account_list" class="table  table-bordered table-hover">
							<thead>
								<tr>
...
<div id="dialog-message3" class="dialog-view hide">
	<table id="account_list" class="table  table-bordered table-hover">
		<thead>
			<tr>
				<th class="col-xs-4 center" style="background-color:#f1f1f1">거래처구분</th>
	...
	$.getJSON("ajax/ledger.php",{"page":page, "mode":"getGeneralLedgerAccount", "rpp" : rpp, "adjacents" : adjacents, "where":search, "search_checked1":search_checked1, "search_checked2" : search_checked2, "base_sdate" : base_sdate, "base_edate" : base_edate, "department_cd" : department_cd, "department_nm" : department_nm, "project_cd" : project_cd, "project_nm" : project_nm, "account_cd" : account_cd, "account_nm" : account_nm, "aci_cd" : aci_cd, "aci_nm" : aci_nm, "etc" : etc, "table" : table},
		function(json){
			if(json != null) {
				...
				tag += "<tr>";
					tag += "<td colspan=6 class='center'>등록된 데이터가 없습니다.";
					tag += "</td>";
				tag += "</tr>";
			}	
				/*
