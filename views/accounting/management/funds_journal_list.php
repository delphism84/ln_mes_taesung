...
<!-- PAGE CONTENT BEGINS ---------------------------------------------------------------------------------------------------------------------------------------->
					...
					<div class="col-xs-12">
						...
						<table id="simple-table" class="table  table-bordered table-hover">
							<tr>
								<th class="col-xs-1" style="background-color:#f1f1f1">표시방법</th>
								<td class="col-xs-1" colspan="3"><input name="division" id="division" type="radio" checked="checked" value="0"><label for="division" data-cid="division" data-role="widget-focus">상대계정</label>&nbsp;<input name="division" id="division" type="radio" value="1"><label for="division" data-cid="division" data-role="widget-focus">본계정(상대분개포함)</label></td>
								</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td class="col-xs-11" colspan="3">
									<input name="etc" id="etc" type="checkbox" checked="checked" value="0"><label for="etc" data-cid="etc" data-role="widget-focus">결재란표시</label>							
								</td>
							</tr>
							<tr>
					...
					<div style="margin-top:10px">
						<!-- <div class="col-xs-12 center"><H2>자금일보</H2></div> -->
						 <table class="table">
						 <tbody>
						 <tr>
						...
						<div class="row">
							<div class="col-md-10 text-left">1. 자금현황</div><div class="col-md-2 text-right">2017/11/19 ~ 2017/11/19 (단위 : 원)</div>
						</div>
						<table id="general_ledger_account_list" class="table  table-bordered table-hover">
							<thead>
								<tr>
									...
									<th class="col-xs-2 center" style="background-color:#f1f1f1">전일잔액</th>
									<th class="col-xs-2 center" style="background-color:#f1f1f1">증가</th>
									<th class="col-xs-2 center" style="background-color:#f1f1f1">감소</th>
									<th class="col-xs-2 center" style="background-color:#f1f1f1">금일잔액</th>
								</tr>
							</thead>
							<tbody></tbody>
						</table>
