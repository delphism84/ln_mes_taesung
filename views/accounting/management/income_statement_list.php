...
<!-- PAGE CONTENT BEGINS ---------------------------------------------------------------------------------------------------------------------------------------->
						...
						<table id="simple-table" class="table  table-bordered table-hover">
							...
							<tr>
								...
								<td class="col-xs-11" colspan="3">
									<input name="etc" id="etc" type="checkbox" checked="checked" value="0"><label for="etc" data-cid="etc" data-role="widget-focus">천단위</label>&nbsp;<input name="etc" id="etc" type="checkbox" value="1"><label for="etc" data-cid="etc" data-role="widget-focus">잔액0포함</label>&nbsp;<input name="etc" id="etc" type="checkbox" value="1"><label for="etc" data-cid="etc" data-role="widget-focus">내역없는부서/프로젝트제외</label>&nbsp;<input name="etc" id="etc" type="checkbox" value="1"><label for="etc" data-cid="etc" data-role="widget-focus">전표발생계정</label>&nbsp;<input name="etc" id="etc" type="checkbox" value="1"><label for="etc" data-cid="etc" data-role="widget-focus">사용중단/삭제포함</label>&nbsp;<input name="etc" id="etc" type="checkbox" value="1"><label for="etc" data-cid="etc" data-role="widget-focus">기초,당기,기말표시</label>								
								</td>
							</tr>
							<tr>
					...
					<div style="margin-top:10px">
						<!-- <div class="col-xs-12 center"><H2>손익계산서</H2></div> -->
						 <table class="table">
						 <tbody>
						 <tr>
