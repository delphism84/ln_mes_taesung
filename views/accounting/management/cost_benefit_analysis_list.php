...
<!-- PAGE CONTENT BEGINS ---------------------------------------------------------------------------------------------------------------------------------------->
						...
						<table id="simple-table" class="table  table-bordered table-hover">
							...
							<tr>
								...
								<td class="col-xs-11" colspan="3">
									<input name="etc" id="etc" type="checkbox" value="1"><label for="etc" data-cid="etc" data-role="widget-focus">결재랑표시</label>&nbsp;<input name="etc" id="etc" type="checkbox" value="1"><label for="etc" data-cid="etc" data-role="widget-focus">기초,당기,기말표시</label>								
								</td>
							</tr>
							<tr>
					...
					<div style="margin-top:10px">
						<!-- <div class="col-xs-12 center"><H2>월별손익분석</H2></div> -->
						 <table class="table">
						 <tbody>
						 <tr>
						...
						<div class="row">
							<div class="col-md-10 text-left">&nbsp;</div><div class="col-md-2 text-right">2017/11/19 ~ 2017/11/19 (단위 : 원)</div>
						</div>
						<!-- <div class="input-group col-xs-12 text-right">2017/11/19 ~ 2017/11/19</div> -->
						<table id="general_ledger_account_list" class="table  table-bordered table-hover">
							<thead>
								<tr>
									<th class="center" style="background-color:#f1f1f1">계정명</th>
									<th class="center" style="background-color:#f1f1f1">2017년 1월</th>
									<th class="center" style="background-color:#f1f1f1">2017년 2월</th>
									<th class="center" style="background-color:#f1f1f1">2017년 3월</th>
									<th class="center" style="background-color:#f1f1f1">2017년 4월</th>
									<th class="center" style="background-color:#f1f1f1">2017년 5월</th>
									<th class="center" style="background-color:#f1f1f1">2017년 6월</th>
									<th class="center" style="background-color:#f1f1f1">2017년 7월</th>
									<th class="center" style="background-color:#f1f1f1">2017년 8월</th>
									<th class="center" style="background-color:#f1f1f1">2017년 9월</th>
									<th class="center" style="background-color:#f1f1f1">2017년 10월</th>
									<th class="center" style="background-color:#f1f1f1">2017년 11월</th>
									<th class="center" style="background-color:#f1f1f1">2017년 12월</th>
									<th class="center" style="background-color:#f1f1f1">집계</th>
								</tr>
							</thead>
							<tbody></tbody>
						</table>
	...
	$.getJSON("ajax/ledger.php",{"page":page, "mode":"getGeneralLedgerAccount", "rpp" : rpp, "adjacents" : adjacents, "where":search, "search_checked1":search_checked1, "search_checked2" : search_checked2, "base_sdate" : base_sdate, "base_edate" : base_edate, "department_cd" : department_cd, "department_nm" : department_nm, "project_cd" : project_cd, "project_nm" : project_nm, "account_cd" : account_cd, "account_nm" : account_nm, "aci_cd" : aci_cd, "aci_nm" : aci_nm, "etc" : etc, "table" : table},
		function(json){
			if(json != null) {
				...
				tag += "<tr>";
					tag += "<td colspan=14 class='center'>등록된 데이터가 없습니다.";
					tag += "</td>";
				tag += "</tr>";
			}	
				/*
