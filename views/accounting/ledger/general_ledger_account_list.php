					...
					<div class="col-xs-12">
						...
						<table id="simple-table" class="table  table-bordered table-hover">
							<tr>
								...
								<td class="col-xs-11" colspan=3><input name="division" id="division" type="radio" checked="checked" value="0"><label for="division" data-cid="division" data-role="widget-focus">건별</label>&nbsp;<input name="division" id="division" type="radio" value="1"><label for="division" data-cid="division" data-role="widget-focus">일별</label>&nbsp;<input name="division" id="division" type="radio" value="2"><label for="division" data-cid="division" data-role="widget-focus">월별</label></td>
							</tr>
							<tr>
								<th class="col-xs-1" style="background-color:#f1f1f1">기준일자</th>
								<td class="col-xs-5">
									<div>
							...
							<tr>
								...
								<th class="col-xs-1" style="background-color:#f1f1f1">기타설정</th>
								<td class="col-xs-5">
									<input name="etc" id="etc" type="checkbox" checked="checked" value="0"><label for="etc" data-cid="etc" data-role="widget-focus">결재방표시</label>&nbsp;<input name="etc" id="etc" type="checkbox" value="1"><label for="etc" data-cid="etc" data-role="widget-focus">전월이월표시</label>
								</td>
							</tr>
							<tr>
						...
						<table id="general_ledger_account_list" class="table  table-bordered table-hover">
							<thead>
								<tr>
									...
									<th class="col-xs-2 center" style="background-color:#f1f1f1">차변</th>
									<th class="col-xs-2 center" style="background-color:#f1f1f1">대변</th>
									<th class="col-xs-2 center" style="background-color:#f1f1f1">잔액</th>
								</tr>
							</thead>
							<tbody></tbody>
						</table>
...
<div id="id-btn-dialog10" class="modal fade" >
    <div class="modal-dialog modal-lg" style="width:70%">
        <div class="modal-content" >
            <div class="modal-header" id="modal-header10">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
...
<!--
  ...
  $('#id-btn-dialog10').attr('src', url);
	  $("#id-btn-dialog10").draggable({
      handle: "#modal-header10"
});
//-->
</script>
<style type="text/css">
	...
	$.getJSON("ajax/ledger.php",{"page":page, "mode":"getGeneralLedgerAccount", "rpp" : rpp, "adjacents" : adjacents, "where":search, "search_checked1":search_checked1, "search_checked2" : search_checked2, "base_sdate" : base_sdate, "base_edate" : base_edate, "department_cd" : department_cd, "department_nm" : department_nm, "project_cd" : project_cd, "project_nm" : project_nm, "account_cd" : account_cd, "account_nm" : account_nm, "aci_cd" : aci_cd, "aci_nm" : aci_nm, "etc" : etc, "table" : table},
		function(json){
			if(json != null) {
				...
				tag += "<td class='center' colspan='2'><span style='color:#cc0000;font-weight:bold'>전월이월</span></td>";
				tag += "<td class='center'></td>";
				tag += "<td class='center'></td>";
				tag += "<td class='center'></td>";
				tag += "</tr>";
				...
				for(var i = 0 ; i < json.length ; i++){
					...
					//tag += "</label>";
					//tag += "</td>";
					//tag += "<td class='center' ><a href='javascript:void(0);'  onclick='GeneralLedgerAccount_modiy(" + json[i].uid + "," + json[i].statement_no + ",\"" + json[i].statement_dt + "\", " + json[i].statement_ca + ",\"" + json[i].trade_type_code + "\",\"" + json[i].trade_type + "\")' >" + json[i].statement_dt + "-" + json[i].statement_ca + "</a></td>";
					...
					tag += "<td class='center'>" + commaSplit(json[i].balance) + "</td>";
					tag += "</tr>";
...
function statement_modiy(uid, mid, dt, ca, tp, tt)
	...
	var url = "index.php?controller=accounting&action="+action+ id+"&pop=Y&statement_dt="+dt+"&statement_ca="+ca+"&tp="+tp+"&dialogid=id-btn-dialog10";
