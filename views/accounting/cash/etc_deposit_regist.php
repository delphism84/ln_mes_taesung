			...
			<div class="row">
				<div class="col-xs-12">
					...
					<form name="frm" id="frm" method="post" action="index.php">
						...
						<input type="hidden" name="action" id="action" value="registEtcDepositInsert" />
						<input type="hidden" name="etc_deposit_ca" id="etc_deposit_ca" value="" />
						...
						<table id="simple-table" class="table  table-bordered table-hover">
									...
									<div>
										<span class="input-icon input-icon-right">
											<div class="input-group">
												<input class=" date-picker" name="etc_deposit_dt" id="etc_deposit_dt" type="text" value="<?=date('Y/m/d')?>" data-date-format="yyyy/mm/dd" />
							...
							<tr>
								<th class="col-xs-2" style="background-color:#f1f1f1">차변계정</th>
								<td class="col-xs-10">
									<div class="input-group">
										<span class="input-icon input-icon-right">
											<div class="input-group">
												<input type="text" name="debtor_cd" id="debtor_cd" readonly />
												<input type="text" name="debtor_nm" id="debtor_nm" readonly />
							...
							<tr>
								<th class="col-xs-2" style="background-color:#f1f1f1">대변계정</th>
								<td class="col-xs-10">
									<div class="input-group">
										<span class="input-icon input-icon-right">
											<div class="input-group">
												<input type="text" name="creditor_cd" id="creditor_cd" readonly />
												<input type="text" name="creditor_nm" id="creditor_nm" readonly />
												<span class="input-group-addon btn-purple" id="id-btn-dialog4">
													<i class="ace-icon fa fa-search icon-on-right bigger-110" style="color:#ffffff"></i>
												</span>
											</div>
