			...
			<div class="row">
				<div class="col-xs-12">
					...
					<form name="frm" id="frm" method="post" action="index.php">
						...
						<input type="hidden" name="action" id="action" value="registGeneralReceiptsUpdate" />
						...
						<table id="simple-table" class="table  table-bordered table-hover">
									...
									<div>
										<span class="input-icon input-icon-right">
											<div class="input-group">
												<input class=" date-picker" name="general_receipts_dt" id="general_receipts_dt" type="text" value="<?=date('Y/m/d')?>" data-date-format="yyyy/mm/dd" />
							...
							<tr>
								<th class="col-xs-2" style="background-color:#f1f1f1">사용계정</th>
								<td class="col-xs-10">
									<div class="input-group">
										<span class="input-icon input-icon-right">
											<div class="input-group">
							...
							<tr>
								<th class="col-xs-2" style="background-color:#f1f1f1">사용자</th>
								<td class="col-xs-10">
									<div class="input-group">
										<span class="input-icon input-icon-right">
											<div class="input-group">
												<input type="text" name="emp_cd" id="emp_cd" readonly/>
												<input type="text" name="emp_nm" id="emp_nm" readonly />
