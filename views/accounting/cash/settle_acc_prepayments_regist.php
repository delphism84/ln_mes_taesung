			...
			<div class="row">
				<div class="col-xs-12">
					...
					<form name="frm" id="frm" method="post" action="index.php">
						...
						<input type="hidden" name="action" id="action" value="registSettleAccPrepaymentsInsert" />
						<input type="hidden" name="settle_acc_prepayments_ca" id="settle_acc_prepayments_ca" value="" />
									...
									<div>
										<span class="input-icon input-icon-right">
											<div class="input-group">
												<input class=" date-picker" name="settle_acc_prepayments_dt" id="settle_acc_prepayments_dt" type="text" value="<?=date('Y/m/d')?>" data-date-format="yyyy/mm/dd" />
						...
						<table id="settle_acc_prepayments" class="table  table-bordered table-hover" style="margin-top:10px">
							<thead>
								<tr>
									<th class="center" style="background-color:#f1f1f1;width:30px"></th>
									<th class="center col-xs-1" style="background-color:#f1f1f1">정산자코드</th>
									<th class="center col-xs-1" style="background-color:#f1f1f1">정산대상자명</th>
									<th class="center col-xs-1" style="background-color:#f1f1f1">계정코드(차변)</th>
							...
							<tbody>
								<tr class="item1">
									...
									<td><input type="text" class="form-control id-btn-dialog1 emp_cd" name="emp_cd[]" id="emp_cd_1"  onclick="empFlag(1)"  placeholder="정산자코드" readonly /></td>
									<td><input type="text" class="form-control emp_nm" name="emp_nm[]" id="emp_nm_1" readonly /></td> 
								...
								<tr class="item2">
									<td class="center"><i class='delBtn fa fa-minus-square fa-1x' aria-hidden='true' onclick='delTr(this)'></i></td>
									<td><input type="text" class="form-control id-btn-dialog1 emp_cd" name="emp_cd[]" id="emp_cd_2"  onclick="empFlag(2)"  placeholder="정산자코드" readonly /></td>
									<td><input type="text" class="form-control emp_nm" name="emp_nm[]" id="emp_nm_2" readonly /></td> 
								...
								<tr class="item3">
									<td class="center"><i class='delBtn fa fa-minus-square fa-1x' aria-hidden='true' onclick='delTr(this)'></i></td>
									<td><input type="text" class="form-control id-btn-dialog1 emp_cd" name="emp_cd[]" id="emp_cd_3"  onclick="empFlag(3)"  placeholder="정산자코드" readonly /></td>
									<td><input type="text" class="form-control emp_nm" name="emp_nm[]" id="emp_nm_3" readonly /></td> 
								...
								<tr class="item4">
									<td class="center"><i class='delBtn fa fa-minus-square fa-1x' aria-hidden='true' onclick='delTr(this)'></i></td>
									<td><input type="text" class="form-control id-btn-dialog1 emp_cd" name="emp_cd[]" id="emp_cd_4"  onclick="empFlag(4)"  placeholder="정산자코드" readonly /></td>
									<td><input type="text" class="form-control emp_nm" name="emp_nm[]" id="emp_nm_4" readonly /></td> 
...
<input type="hidden" name="empFlag" id="empFlag" value="" />
...
<div id="dialog-message1" class="dialog-view hide">
	<table id="emp_list" class="table  table-bordered">
		<thead>
			<tr>
				<th class="col-xs-6 center" style="background-color:#f1f1f1">정산자코드</th>
				<th class="col-xs-6 center" style="background-color:#f1f1f1">정산자명</th>
			</tr>
		</thead>
		<tbody></tbody>
	</table>
...
function addTr(){
	...
	tag += "<td><input type='text' class='form-control id-btn-dialog1 emp_cd' name='emp_cd[]' id='emp_cd_" + currentFlag + "' onclick='empFlag(" + currentFlag + ")'  placeholder='정산자코드' readonly /></td>";
	tag += "<td><input type='text' class='form-control emp_nm' name='emp_nm[]' id='emp_nm__" + currentFlag + "' readonly /></td>";
	...
	tag += "</tr>";
	$("#settle_acc_prepayments").append(tag);
...
function postEmp(code,name){
	$("#dialog-message1").dialog("close");
	var arr = [];
	$.each($(".emp_cd") , function () {
		arr.push($(this).val());
	});
	var idx = jQuery.inArray(code, arr);
	//if(idx >= 0) {
	//	alert("동일 거래처를 이미 선택하셨습니다");
	//} else {
		var flag = $("#empFlag").val();
		$("#emp_cd_" + flag).val(code);
		$("#emp_nm_" + flag).val(name);
	//}
}
...
jQuery(function($) {
	...
	$( ".id-btn-dialog1" ).on('click', function(e) {
		...
		var dialog = $( "#dialog-message1" ).removeClass('hide').dialog({
			...
			height:500,
			modal: true,
			title: "<div class='widget-header widget-header-small'><h4 class='smaller'><i class='ace-icon fa fa-minus-square'></i>사원검색</h4></div>",
			title_html: true,
			buttons: [ 
				{
					text: "Cancel",
