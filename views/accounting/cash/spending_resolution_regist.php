			...
			<div class="row">
				<div class="col-xs-12">
					...
					<form name="frm" id="frm" method="post" action="index.php">
						...
						<input type="hidden" name="action" id="action" value="registSpendingResolutionInsert" />
						<input type="hidden" name="spending_resolution_ca" id="spending_resolution_ca" value="" />
									...
									<div>
										<span class="input-icon input-icon-right">
											<div class="input-group">
												<input class=" date-picker" name="spending_resolution_dt" id="spending_resolution_dt" type="text" value="<?=date('Y/m/d')?>" data-date-format="yyyy/mm/dd" />
						...
						<table id="spending_resolution" class="table  table-bordered table-hover" style="margin-top:10px">
							<thead>
								<tr>
									<th class="center" style="background-color:#f1f1f1;width:30px"></th>
									<th class="center col-xs-1" style="background-color:#f1f1f1">출금된계좌코드</th>
									<th class="center col-xs-1" style="background-color:#f1f1f1">출금된계좌명</th>
...
function addTr(){
	...
	tag += "</tr>";
	$("#spending_resolution").append(tag);
...
function calcAmountTotal(Obj,flag) {
	if ($(Obj).attr('readonly'))
		return;
	var Debtor = Money2Num($(Obj).parent().parent().find("input[name='amount[]']").val());
