			...
			<div class="row">
				<div class="col-xs-12">
					...
					<form name="frm" id="frm" method="post" action="index.php">
						...
						<input type="hidden" name="action" id="action" value="registCardSalesSlipsInsert" />
						<input type="hidden" name="card_sales_slips_ca" id="card_sales_slips_ca" value="" />
						...
						<table id="simple-table" class="table  table-bordered table-hover">
									...
									<div>
										<span class="input-icon input-icon-right">
											<div class="input-group">
												<input class=" date-picker" name="card_sales_slips_dt" id="card_sales_slips_dt" type="text" value="<?=date('Y/m/d')?>" data-date-format="yyyy/mm/dd" />
							...
							<tr>
								<th class="col-xs-2" style="background-color:#f1f1f1">카드번호</th>
								<td class="col-xs-10">
									<div class="input-group">
										<span class="input-icon input-icon-right">
											<div class="input-group">
												<input type="text" name="card_no" id="card_no" readonly/>
												<input type="text" name="card_nm" id="card_nm" readonly />
