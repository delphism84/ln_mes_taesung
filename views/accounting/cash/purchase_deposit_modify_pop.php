			...
			<div class="row">
				<div class="col-xs-12">
					...
					<form name="frm" id="frm" method="post" action="index.php">
						...
						<input type="hidden" name="action" id="action" value="registPurchaseDepositInsert" />
						...
						<table id="simple-table" class="table  table-bordered table-hover">
							<tr>
								<th class="col-xs-2" style="background-color:#f1f1f1">출금일자</th>
								<td class="col-xs-10">
									<div>
										<span class="input-icon input-icon-right">
											<div class="input-group">
												<input class=" date-picker" name="purchase_deposit_dt" id="purchase_deposit_dt" type="text" value="<?=date('Y/m/d')?>" data-date-format="yyyy/mm/dd" />
