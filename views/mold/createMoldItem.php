			...
			<div class="page-content">
						...
						<form name="frmMold" id="frmMold" method="post" action="index.php" enctype="multipart/form-data" />
							...
							<table id="simple-table" class="table  table-bordered table-hover">
								...
								<tbody style="border-bottom: 1px solid #dddddd">
									...
									<td><input type="text" class="form-control text-right cnt" name="cnt" id="cnt" onKeyPress=="onlyNumber(this);" onkeyup="input_comma(this)"  onclick="this.select();" required/><label for="cnt" style="display:none;">수량을 입력하세요.</label></td>
									<td><input type="text" class="form-control text-right valid_item_hit_cnt" name="valid_item_hit_cnt" id="valid_item_hit_cnt" onKeyPress=="onlyNumber(this);" onkeyup="input_comma(this);" onclick="this.select();" required/><label for="valid_item_hit_cnt" style="display:none;">유효타수를 입력하세요.</label></td>
				...
				<div class="clearfix  center">
					<div class="col-md-12">
						...
						<button class="btn btn-xs" type="reset" onclick="window.parent.closeModal('<?=$dialogID?>');">
...
function insertMoldItem(fid) {
		...
		$.ajax({
			...
			success : function(str) {
				...
				window.parent.getMoldItemList(fid);
			}
		});
	//}
}
