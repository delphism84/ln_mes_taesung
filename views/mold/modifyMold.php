						...
						<div class="widget-main no-padding">
							<table class="table table-bordered table-striped no-padding table-condensed" >
								...
								<tr>
									...
									<td class="col-xs-3">
										<input name="mold_cd" id="mold_cd" type="text" value="<?=$t-mold_cd?>"/>
									</td>
										...
										<div class="input-group">
											<span class="input-icon input-icon-right">
												<div class="input-group">
													...
													<input type="text" name="mold_group_nm" id="mold_group_nm" readonly/>
									...
									<td class="col-xs-3">
										<span class="input-icon input-icon-right">
											<div class="input-group">
												...
												<input type="text" name="mold_location_nm" id="mold_location_nm" readonly/>
									...
									<td class="col-xs-3">
										<span class="input-icon input-icon-right">
											<div class="input-group">
												...
												<input type="text" name="mold_type_nm" id="mold_type_nm" readonly/>
									...
									<td class="col-xs-3">
										<span class="input-icon input-icon-right">
											<div class="input-group">
												...
												<input type="text" name="mold_divide_nm" id="mold_divide_nm" readonly/>
									...
									<td class="col-xs-3">
										<span class="input-icon input-icon-right">
											<div class="input-group">
												...
												<input type="text" name="mold_class_nm" id="mold_class_nm" readonly/>
									...
									<td class="col-xs-3">
										<span class="input-icon input-icon-right">
											<div class="input-group">
												...
												<input type="text" name="mold_state_nm" id="mold_state_nm" readonly/>
									...
									<td class="col-xs-3">
										<span class="input-icon input-icon-right">
											<div class="input-group">
												...
												<input type="text" name="product_account_nm" id="product_account_nm" onclick="moldPopup('21')" readonly />
