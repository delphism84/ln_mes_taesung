					...
					<form id="ac_frm" method="post" action="index.php">
						...
						<table id="simple-table" class="table  table-bordered table-hover">
							<tr>
								...
								<td class="col-xs-5">
									<label>
										<input type="radio" class="ace" name="account_gb" id="account_gb" value="매입" checked <? if($_SESSION['auto_code'] == "y") echo "onclick='createAccountCode()'"; ?> />
										<span class="lbl"> 매입</span>
									</label>

									<label>
										<input type="radio" class="ace" name="account_gb" id="account_gb" value="매출" <? if($_SESSION['auto_code'] == "y") echo "onclick='createAccountCode()'"; ?> />
								...
								<td class="col-xs-5"><input type="text" name="account_cd" id="account_cd" <? if($_SESSION['auto_code'] == "y") echo "readonly"; ?> /></td>
							</tr>
							<tr>
								<th class="col-xs-1" style="background-color:#f1f1f1"><i class="cf fa fa-check" aria-hidden="true"></i> 거래처명</th>
								<td class="col-xs-5"><input type="text" name="account_nm" id="account_nm" /></td>
							...
							<tr>
								<th class="col-xs-1" style="background-color:#f1f1f1"><i class="fa fa-check red" aria-hidden="true"></i> 대표이메일</th>
								<td class="col-xs-5"><input type="text" name="corp_email" id="corp_email" /></td>
								<th class="col-xs-1" style="background-color:#f1f1f1"><i class="fa fa-check red" aria-hidden="true"></i> 담당자</th>
								<td class="col-xs-5"><input type="text" name="manager" id="manager" /></td>
							</tr>
							<tr>
								<th class="col-xs-1" style="background-color:#f1f1f1">주소</th>
								<td class="col-xs-11" colspan="3">
									<div class="input-group">
										<input type="text" class="search-query" placeholder="우편번호" name="corp_zipcode" id="corp_zipcode" style="width:200px" readonly />
									...
									<div style="margin-top:5px">
										<input type="text" class="search-query" placeholder="주소" name="corp_address" id="corp_address" style="width:300px" />
									</div>
								</td>
							</tr>
							<tr>
...
function createAccountCode() {
	...
	var dataString = "mode=createAccountCode&account_gb=" + account_gb;
...
function formSubmit(){
	...
	if(!check_str2($("#corp_email").val(),"대표이메일")) return false;
	if(!check_str($("#manager").val(),"담당자")) return false;
...
jQuery(function($) {
	...
	$('.input-mask-bissno').mask('999-99-99999');
