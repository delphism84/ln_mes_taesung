			...
			<div class="row">
				<div class="col-xs-12">
					...
					<form name="frm" id="frm" method="post" action="index.php" enctype="multipart/form-data">
						...
						<input type="hidden" name="action" id="action" value="updateStandardCode" />
...
function formSubmits() {
	//if(!check_str($("#standard").val(),"로트NO 코드")) return false;
	//if(!check_str($("#standard_cd").val(),"로트NO 명")) return false;
