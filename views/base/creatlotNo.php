			...
			<div class="row">
				<div class="col-xs-12">
					...
					<form name="frm" id="frm" method="post" action="index.php" >
						...
						<input type="hidden" name="action" id="action" value="registLotNoInput" />
						...
						<table id="simple-table" class="table  table-bordered table-hover">
							<tr>
								...
								<td class="col-xs-5">
									<input type="text" name="lot_no_cd" id="lot_no_cd" value="<?=date('Y/m/d')?>" /><? //if($_SESSION['auto_code'] == "y") echo "readonly"; ?> 
								</td>
							</tr>
							<tr>
								<th class="col-xs-3" style="background-color:#f1f1f1"><i class="cf fa fa-check" aria-hidden="true"></i> 로트No 항목명</th>
								<td class="col-xs-5">
									<input type="text" name="lot_no_nm" id="lot_no_nm" <? if($_SESSION['auto_code'] == "y") echo "readonly"; ?> />
								</td>
							</tr>
							<tr>
									...
									<div style="float:left">
										<span class="input-icon input-icon-right">
											<div class="input-group">
												<input class="date-picker" name="lot_no_dt" id="lot_no_dt" type="text" data-date-format="yyyy/mm/dd" />
							...
							<tr>
								<th class="col-xs-3" style="background-color:#f1f1f1"></i> 메모</th>
								<td class="col-xs-5">
									<input type="text" name="etc" id="etc" <? if($_SESSION['auto_code'] == "y") echo "readonly"; ?> />
								</td>
							</tr>
						</table>
					</form>
