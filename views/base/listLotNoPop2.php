							...
							<table id="lot_no_list" class="table table-bordered table-striped">
								<thead class="thin-border-bottom">
									<tr>
										...
										<th class="col-xs-2"><i class="ace-icon fa fa-caret-right blue"></i>품목Lot 첫입고일</th>
										<th class="col-xs-1"><i class="ace-icon fa fa-caret-right blue"></i> 메모</th>
									</tr>
								</thead>
								<tbody></tbody>
							</table>
		...
		function(json){
			if(json != null) {
				for(var i = 0 ; i < json.length ; i++){
					...
					<?}?>
					*/
					tag += "<td><a href='javascript:void(0);'  onclick=\"postLotNo('" + json[i].lot_no_cd + "','" + json[i].remain_cnt + "','" + json[i].warehouse_cd + "','" + json[i].warehouse_nm + "')\">" + json[i].lot_no_cd + "</a></td>";
					...
					tag += "<td><a href='javascript:void(0);'  onclick=\"postLotNo('" + json[i].lot_no_cd + "','" + json[i].remain_cnt + "','" + json[i].warehouse_cd + "','" + json[i].warehouse_nm + "')\">" + json[i].item_cd + "</td>";
					tag += "<td><a href='javascript:void(0);'  onclick=\"postLotNo('" + json[i].lot_no_cd + "','" + json[i].remain_cnt + "','" + json[i].warehouse_cd + "','" + json[i].warehouse_nm + "')\">" + json[i].standard1 + "</td>";
...
function postLotNo( lnc , remain_cnt ,warehouse_cd , warehouse_nm ){
		if( remain_cnt <= 0 ){
			alert("재고가 없습니다.");
			return false;
		}
		...
		//먼저 들어온 재고가 있는지 확인.
		var dataString = "mode=searchItemLot3&item_cd="+ $("#item_cd").val() + "&standard1=" + $("#standard1").val()+ "&lot_no=" + lnc;
		$.ajax({
			type : "post",
			url : "ajax/lot_no.php",
			data : dataString,
