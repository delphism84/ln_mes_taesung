		...
		$(function () {
			...
			$('#tree')
				...
				.on('create_node.jstree', function (e, data) {
					$.get('/views/base/response.php?operation=create_node', { 'type' : data.node.type, 'id' : data.node.parent, 'text' : data.node.text })
						.done(function (d) {
				...
				.on('move_node.jstree', function (e, data) {
					$.get('/views/base/response.php?operation=move_node', { 'id' : data.node.id, 'parent' : data.parent })
						.done(function (d) {
				...
				.on('copy_node.jstree', function (e, data) {
					$.get('/views/base/response.php?operation=copy_node', { 'id' : data.original.id, 'parent' : data.parent })
						.done(function (d) {
							//data.instance.load_node(data.parent);
							data.instance.refresh();
						})
				...
				.on('changed.jstree', function (e, data) {
					if(data && data.selected && data.selected.length) {
						$.get('/views/base/response.php?operation=get_content&id=' + data.selected.join(':'), function (d) {
