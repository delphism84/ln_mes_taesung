					...
					<form name="frm" id="frm" method="post" action="index_.php">
						...
						<table id="simple-table" class="table  table-bordered table-hover">
									...
									<div class="input-group">
										<span class="input-icon input-icon-right">
											<div class="input-group">
												...
												<input type="text" name="process_nm" id="process_nm" value="검사ㅣ포장" readonly/>
											</div>
										</span>
										<span class="input-icon input-icon-right">
											<div class="input-group">
												<input type="hidden" name="machine_uid" id="machine_uid" value="27"/>
												<input type="text" name="machine_nm" id="machine_nm" value="1호기" readonly/>
							...
							<tr>
								...
								<td class="col-xs-5">
									<input type="text" name="loss_time" id="loss_time" class="onlynum text-right" value="<?=number_format($t->loss_time)?>" /> 시간(분)
								</td>
							</tr>
							<tr>
