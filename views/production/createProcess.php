			...
			<div class="row">
				<div class="col-xs-12">
					...
					<form id="frm" method="post" action="index.php">
						...
						<input type="hidden" name="action" id="action" value="registProcess" />
						<!-- 테이블 -->
						<table id="simple-table" class="table  table-bordered table-hover">
							<tr>
								...
								<td class="col-xs-5">
									<label>
										<input type="radio" class="ace" name="process_gb" id="process_gb" value="1" checked onclick="createProcessCode()" />
										<span class="lbl"> 내부공정</span>
									</label>

									<label>
										<input type="radio" class="ace" name="process_gb" id="process_gb" value="2" onclick="createProcessCode()" />
								...
								<td class="col-xs-5"><input type="text" class="form-control" name="process_cd" id="process_cd" readonly /></td>
							</tr>
							<tr>
