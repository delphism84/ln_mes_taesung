					...
					<form name="frm" id="frm" method="post" action="index.php">
						...
						<table id="simple-table" class="table  table-bordered table-hover">
									...
									<div class="input-group">
										<span class="input-icon input-icon-right">
											<div class="input-group">
												...
												<input type="text" name="item_nm" id="item_nm" onclick="centerOpenWindow('views/popup/itemListPut.php', '품목 리스트', 800, 500)" readonly/>
												<span class="input-group-addon btn-purple" style="cursor:pointer" onclick="centerOpenWindow('views/popup/itemListPut.php', '품목 리스트', 800, 500)">
													<i class="ace-icon fa fa-search icon-on-right bigger-110" style="color:#ffffff"></i>
												</span>
											</div>
										</span>
									</div>
									<input type="text" name="standard1" id="standard1" class="standard1"/>
									<input type="text" name="standard2" id="standard2" class="standard2"/>
								</td>
							</tr>
							<tr>
								<th class="col-xs-1" style="background-color:#f1f1f1">생산기기</th>
								<td class="col-xs-5">
									<div class="input-group">
										<span class="input-icon input-icon-right">
											<div class="input-group">
												<input type="hidden" name="process_cd" id="process_cd" />
												<input type="text" name="machine_nm" id="machine_nm" onclick="centerOpenWindow('views/popup/machineListPut.php', '기기리스트', 400, 600)" readonly/>
												<span class="input-group-addon btn-purple" style="cursor:pointer" onclick="centerOpenWindow('views/popup/machineListPut.php', '기기리스트', 400, 600)">
													<i class="ace-icon fa fa-search icon-on-right bigger-110" style="color:#ffffff"></i>
												</span>
								...
								<th class="col-xs-1" style="background-color:#f1f1f1">합격량</th>
								<td class="col-xs-5">
									<input type="text" name="pass_qty" id="pass_qty" class="onlynum text-right"/>
								</td>
							</tr>
							<tr>
								<th class="col-xs-1" style="background-color:#f1f1f1">계획시간</th>
								<td class="col-xs-5">
									<div class="input-group">
										<div class="input-group bootstrap-timepicker">
											<input name="p_plan_tm1" id="timepicker1" type="text" style="width:70px" data-date-format="HH:mm:ss'"/>
											<span class="input-group-addon">
												<i class="fa fa-clock-o bigger-110"></i>
											</span>
											 ~	
											<input name="p_plan_tm2" id="timepicker2" type="text" style="width:70px" data-date-format="HH:mm:ss'"/>
											<span class="input-group-addon">
												<i class="fa fa-clock-o bigger-110"></i>
											</span>
										</div>
								...
								<th class="col-xs-1" style="background-color:#f1f1f1">생산번호</th>
								<td class="col-xs-5">
									<div class="input-group">
										<span class="input-icon input-icon-right">
											<div class="input-group">
												<input type="text" name="work_cd" id="work_cd" onclick="centerOpenWindow('views/popup/workListPut.php', '작업지시서 리스트', 800, 500)" readonly/>
							...
							<tr>
								...
								<td class="col-xs-5">
									<input type="text" name="order_qty" id="order_qty" class="onlynum text-right" />
								</td>
								<th class="col-xs-1" style="background-color:#f1f1f1">발행량</th>
								<td class="col-xs-5">
									<input type="text" name="publish_qty" id="publish_qty" class="onlynum text-right"/>
								</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td class="col-xs-5">
									<input type="text" name="target_qty" id="target_qty" class="onlynum text-right"/>
								</td>
								<th class="col-xs-1" style="background-color:#f1f1f1">생산량</th>
								<td class="col-xs-5">
									<input type="text" name="output_qty" id="output_qty" class="onlynum text-right"/>
								</td>
							</tr>
							<tr>
								<th class="col-xs-1" style="background-color:#f1f1f1">작업효율</th>
								<td class="col-xs-5">
									<input type="text" name="working_efficiency" id="working_efficiency" class="onlynum text-right"/>
								</td>
							...
							<tr>
								...
								<td class="col-xs-5">
									<input type="text" name="faulty_qty1" id="faulty_qty1" class="onlynum text-right"/>
								</td>
								<th class="col-xs-1" style="background-color:#f1f1f1">불량유형1</th>
								<td class="col-xs-5">
									<input type="text" name="faulty_type1" id="faulty_type1" />
								</td>
							</tr>
							<tr>
								<th class="col-xs-1" style="background-color:#f1f1f1">불량수량2</th>
								<td class="col-xs-5">
									<input type="text" name="faulty_qty2" id="faulty_qty2" class="onlynum text-right"/>
								</td>
								<th class="col-xs-1" style="background-color:#f1f1f1">불량유형2</th>
								<td class="col-xs-5">
									<input type="text" name="faulty_type2" id="faulty_type2" />
								</td>
							</tr>
						</table>
					</form>
