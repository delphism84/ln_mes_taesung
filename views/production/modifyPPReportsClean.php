			...
			<div class="row">
				<div class="col-xs-12">
					...
					<form name="frm" id="frm" method="post" action="index_.php">
						...
						<input type="hidden" name="action" id="action" value="updatePagePPReportsClean" />
						...
						<table id="simple-table" class="table  table-bordered table-hover">
							...
							<tr>
								...
								<td class="col-xs-5">
									<div class="input-group">
										<span class="input-icon input-icon-right">
											<div class="input-group">
												<input type="hidden" name="process_cd" id="process_cd" value="P02" />
												<input type="text" name="process_nm" id="process_nm" value="세척" readonly/>
											</div>
										</span>
										<span class="input-icon input-icon-right">
											<div class="input-group">
												<input type="hidden" name="machine_uid" id="machine_uid" value="18"/>
												<input type="text" name="machine_nm" id="machine_nm" value="세척1호기" readonly/>
							...
							<tr>
								<th class="col-xs-1" style="background-color:#f1f1f1"> 세척수량</th>
								<td class="col-xs-5">
							...
							<tr>
								...
								<td class="col-xs-5">
									<input type="text" name="publish_qty" id="publish_qty" value="<?=number_format($t->publish_qty)?>" class="text-right" onKeyPress="onlyNumber();" onclick='this.select();' onKeyUp="input_comma(this);" style="ime-mode:disabled"/> ※세척수량 / 박스당수량
								</td>

							</tr>
							<tr>
								<th class="col-xs-1" style="background-color:#f1f1f1">불량수량</th>
								<td class="col-xs-5">
									<input type="text" name="faulty_qty1" id="faulty_qty1" value="<?=number_format($t->faulty_qty1)?>" class="onlynum text-right" value='0' onclick='this.select();' class="text-right" onKeyPress="onlyNumber();" onKeyUp="input_comma(this);" > 
								</td>
								<th class="col-xs-1" style="background-color:#f1f1f1">불량유형</th>
								<td class="col-xs-5">
									<div class="row">
										<div class="input-group">
										<div class="col-xs-3">
										...
										?>
										<SELECT name="faulty_type1" id="faulty_type1" onchange="setText()">
											<option value='' <?if ($ts->defect_nm=="") echo "selected"?>>선택</option>
										<?
											while($ts = mysql_fetch_object($result)) {
										?>
											<option value='<?=$ts->defect_nm?>' <?if ($t->faulty_type1==$ts->defect_nm) echo "selected"?>><?=$ts->defect_nm?></option>
										<?}?>
											<option value='기타' <?if ($ts->defect_nm=="기타") echo "selected"?>>기타</option>
										</SELECT>
										</div>
										<div class="left col-xs-8 layer" style="margin-left:5pt">
											<input type="text" name="faulty_type2" id="faulty_type2" value="<?=$t->faulty_type2?>" class="input-sm"></td>
										</div>
										</div>
									</div>	
								</td>
							...
							<tr>
								...
								<td class="col-xs-5">
									<input type="text" name="loss_time" id="loss_time" value="<?=$t->loss_time?>" class="onlynum text-right" />분
								</td>
							</tr>
						</table>
					</form>
...
function formSubmit(){
	...
	var faulty_type_val = $('#faulty_type1 option:selected').val();

	if (faulty_type_val=="기타")
	{
		var faulty_type_text = $("#faulty_type2").val();
	}else{
		var faulty_type_text = faulty_type_val;
	}
	
	$('#faulty_type1 option:selected').val(faulty_type_text);
