...
$sql55 = "select * from erp_product_perf_repost where uid=".$uid;
$t55 = mysql_fetch_object(mysql_query($sql55));
$work_dt = substr($t55->work_cd,0,10); //작업지시 날자 가져오기
									...
									<td style='width:50%;'>
										<table class="table table-bordered" style='width:100%;height:190px;border:2px solid #000000'>
											...
											<tr>
												...
												<th class="col-xs-2" style="vertical-align: middle;white-space:nowrap"> 작업자/작업자명</th>
											...
											<tr>	
												...
												<td style="vertical-align: middle;white-space:nowrap"><?=$work_dt?></td>

												<th class="col-xs-2" style="vertical-align: middle;white-space:nowrap"> 도금입고일</th>
											...
											<tr>	
												<th class="col-xs-2" style="vertical-align: middle;white-space:nowrap">출력공정</th>
										 		<td style="vertical-align: middle;white-space:nowrap"> 도 금</td>

												<th class="col-xs-2" style="vertical-align: middle;white-space:nowrap"></th>
