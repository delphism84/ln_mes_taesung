			...
			<div class="row">
				<div class="col-xs-12">
					...
					<form name="frm" id="frm" method="post" action="index_.php">
						...
						<input type="hidden" name="action" id="action" value="inputPagePPReportsClean" />
						...
						<table id="simple-table" class="table  table-bordered table-hover">
							...
							<tr>
								...
								<td class="col-xs-5">
									<input type="text" name="publish_qty" id="publish_qty" class="text-right" onKeyPress="onlyNumber();" onclick='this.select();' onKeyUp="input_comma(this);" style="ime-mode:disabled"/> ※세척수량 / 박스당수량
								</td>
							...
							<tr>
								...
								<td class="col-xs-5">
									<input type="text" name="faulty_qty1" id="faulty_qty1" class="onlynum text-right" value='0' onclick='this.select();' class="text-right" onKeyPress="onlyNumber();" onKeyUp="input_comma(this);" > 
								</td>
								...
								<td class="col-xs-5">
									<div class="row">
										...
										<div class="left col-xs-8 layer" style="margin-left:5pt">
											<input type="text" name="faulty_type2" id="faulty_type2"  class="input-sm">
										</div>
										</div>
									</div>	
								</td>
							...
							<tr>
								...
								<td class="col-xs-5">
									...
									<option value="1">설비고장</option>
									<option value="2">금형수리</option>
									<option value="3">품질확인</option>
									<option value="4">자재결품</option>
									<option value="5">기타</option>
									</select>
								</td>
								<th class="col-xs-1" style="background-color:#f1f1f1">유실시간</th>
								<td class="col-xs-5">
									<input type="text" name="loss_time" id="loss_time" class="onlynum text-right" onclick='this.select();'/>시간(분)
								</td>
							</tr>
						</table>
					</form>
