			...
			<div class="row">
				<div class="col-xs-12">
					...
					<form name="frm" id="frm" method="post" action="index.php" enctype="multipart/form-data">
						...
						<input type="hidden" name="action" id="action" value="inputPageProductionWearing" />
						...
						<table id="simple-table" class="table table-bordered table-hover">
							<tr>
								<th class="col-xs-1" style="background-color:#f1f1f1">작업지시서 일자</th>
								<td class="col-xs-5">
									<input type="text" name="wearing_dt" id="wearing_dt" value="<?=date('Y/m/d')?>" <? if($_SESSION['auto_code'] == "y") echo "readonly"; ?> />
								</td>
								<th class="col-xs-1" style="background-color:#f1f1f1">작업지지서</th>
								<td class="col-xs-5">
									<div class="input-group">
										<span class="input-icon input-icon-right">
											<div class="input-group">
												<input type="hidden" name="work_uid" id="work_uid" readonly />
												<input type="text" name="work_cd" id="work_cd" onclick="centerOpenWindow('views/popup/workToWearingList.php', '작업지시서 리스트',900, 600)" readonly />
												<span class="input-group-addon btn-purple" onclick="centerOpenWindow('views/popup/workToWearingList.php', '작업지시서 리스트', 900, 600)">
							...
							<tr>
								...
								<td class="col-xs-5">
									<span class="input-icon input-icon-right">
										<div class="input-group">
											<input type="hidden" name="wh_cd_f" id="wh_cd_f" />
											<input type="text" name="wh_nm_f" id="wh_nm_f" onclick="centerOpenWindow('views/popup/warehouseList.php', '창고리스트', 400, 600)" />
								...
								<td class="col-xs-5">
									<span class="input-icon input-icon-right">
										<div class="input-group">
											<input type="hidden" name="wh_cd_t" id="wh_cd_t" />
											<input type="text" name="wh_nm_t" id="wh_nm_t" onclick="centerOpenWindow('views/popup/warehouseList.php', '창고리스트', 400, 600)" />
											<span class="input-group-addon btn-purple" style="cursor:pointer" onclick="centerOpenWindow('views/popup/warehouseList.php', '창고리스트', 400, 600)">
												<i class="ace-icon fa fa-search icon-on-right bigger-110" style="color:#ffffff"></i>
											</span>
										</div>
							...
							<tr>
								...
								<td class="col-xs-5">
									<div class="input-group">
										<span class="input-icon input-icon-right">
											<div class="input-group">
												<input type="hidden" name="emp_id" id="emp_id" value='<?=$_SESSION['login_id']?>' readonly />
												<input type="text" name="emp_nm" id="emp_nm" value='<?=$_SESSION['login_nm']?>' readonly onclick="centerOpenWindow('views/popup/employeeList.php', '사원리스트', 800, 500)" />
												<span class="input-group-addon btn-purple" onclick="centerOpenWindow('views/popup/employeeList.php', '사원리스트', 800, 500)"">
													<i class="ace-icon fa fa-search icon-on-right bigger-110" style="color:#ffffff"></i>
												</span>
											</div>
										</span>
							...
							<tr>
								...
								<td colspan="3" class="col-xs-11"><textarea name="remark" id="remark" class="form-control col-xs-2" rows="1" style="width:70%"></textarea></td>
							</tr>
						...
						<a class="btn btn-xs btn-success" onclick="centerOpenWindow('views/popup/workToWearingListPut.php', '품목 리스트', 900, 600)">품목선택</a>
						
						<table id="workorder_item" class="table table-bordered table-hover" style="margin-top:10px">
							<thead>
								<tr>
									<th class="detail-col center" style="background-color:#f1f1f1"></th>
									<th class="center col-xs-1" style="background-color:#f1f1f1">생산품목코드</th>
									<th class="center col-xs-1" style="background-color:#f1f1f1">생산품목명</th>
									...
									<th class="center col-xs-1" style="background-color:#f1f1f1;">외주비단가</th>
									<th class="center col-xs-1" style="background-color:#f1f1f1;">외주비합계</th>
									<th class="center col-xs-1" style="background-color:#f1f1f1;">외주비부가세</th>
									<th class="center col-xs-1" style="background-color:#f1f1f1;">적요</th>
									<th class="center col-xs-1" style="background-color:#f1f1f1;">생산시간</th>
									<th class="center col-xs-1" style="background-color:#f1f1f1;">시리얼</th>
								</tr>
							</thead>
							<tbody>
								<tr>
							...
							<tfoot>
								<tr>
									...
									<th class="center col-xs-1" style="background-color:#f1f1f1"><SPAN>&nbsp;</SPAN></th>
									<th class="center col-xs-1" style="background-color:#f1f1f1"><SPAN>&nbsp;</SPAN></th>
									<th class="center col-xs-1" style="background-color:#f1f1f1" style="text-align:right;"><SPAN>&nbsp;</SPAN></th>
								</tr>
							<tfoot>			
						</table>
					</form>
...
<input type="hidden" name="serialnocdFlag" id="serialnocdFlag" value="1" />
        ...
        <div class="modal-content" >
            <div class="modal-header" id="modal-header1">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                 <h4 class="modal-title">시리얼/로트No.선택</h4>

            </div>
            <div class="modal-body">
                <p><iframe src="" id="serial_no_reg_frame" frameborder="0" width="99%" height="370" marginwidth="0" marginheight="0" scrolling="yes"></iframe></p>
            </div>
...
<div id="dialog-message" class="hide">
	<table class="table  table-bordered table-hover" style="margin-top:10px">
		...
		<tbody>
			<tr>
				<th class="center col-xs-4" style="background-color:#f1f1f1">로트넘버 항목코드</th><td class="center col-xs-8"><input type="text" name="serialnocd" id="serialnocd"></td>
			</tr>
			<tr>
				<th class="center col-xs-4" style="background-color:#f1f1f1">로트넘버 항목명</th><td class="center col-xs-8" ><input type="text" name="serialnonm" id="serialnonm"></td>
			</tr>
		</tbody>
	</table>
</div><!-- #dialog-message -->
...
$(document).ready(function(){
	...
	<? if($_SESSION['auto_code'] == "y") { ?>createWorkCodesssss();<?}?>
	var page = $("#page").val();
		//getSerialNo(page);
});
...
function  calculationTotal() {
	...
	$("input[name='outsourcing_unit_price[]']").each(function () {
		var unit_price = removeComma(this.value);
		if ($("input[name='outsourcing_unit_price[]']").length > 0 && !isNaN(unit_price)){
			 unitPriceTotal += Number(removeComma(this.value));
		}
	});
	var priceTotal = 0;
	$("input[name='outsourcing_total_price[]']").each(function () {
		var priceTotal = removeComma(this.value);
		if ($("input[name='outsourcing_total_price[]']").length > 0 && !isNaN(priceTotal)){
			 priceTotal += Number(removeComma(this.value));
		}
	});
	var taxTotal = 0;
	$("input[name='outsourcing_tax[]']").each(function () {
		var tax = removeComma(this.value);
		if ($("input[name='outsourcing_tax[]']").length > 0 && !isNaN(tax)){
...
function formSubmit(){
	...
	if($(".cntTotal").text() == 0 || $(".priceTotal").text() == "") {
...
function serialnocdFlag(flag) {
	$("#serialnocdFlag").val(flag);
}
...
function getSerialNo(page) {
	...
	$.getJSON("ajax/serial_no.php",{"page":page, "mode":"get_serial_no", "rpp" : rpp, "adjacents" : adjacents, "where":search, "serial_no_cd":serial_no_cd},//, "search_choice" : search_choice, "txt" : txt},
		function(json){
			if(json != null) {
				//$("#total_num").html(json[0].total_num);
				for(var i = 0 ; i < json.length ; i++){
					//if(json[i].Serial_no_cd == "purchase") var clas = "매입";
					//else var clas = "매출";
			...
			if(serial_no_cd == "" || serial_no_cd == "all") {
				...
				var where = $("#where").val() + " and serial_no_cd='"  + serial_no_cd + "'";
			}
...
function postSerialNo(lnc,lnn){
	...
	//} else {
		...
		var flag = $("#serialnocdFlag").val();
		$("#serial_no_cd_" + flag).val(lnc);
		$("#serial_no_nm_" + flag).val(lnn);
	//}
}

function registSerialNo(){
	if(!check_str($("#serial_no_cd").val(),"로트넘버 항목코드")) return false;
	if(!check_str($("#serial_no_nm").val(),"로트넘버 항목명")) return false;

	//var dataString = "mode=registSerialNo&uid=" + $("#uid").val() + "&Serial_no_cd=" + $("#Serial_no_cd").val() + "&Serial_no_nm=" + $("#Serial_no_nm").val();
	var dataString = "mode=registSerialNo&Serial_no_cd=" + $("#serial_no_cd").val() + "&serial_no_nm=" + $("#serial_no_nm").val();
	$.ajax({
		type : "post",
		data : dataString,
...
function serial_no_reg(cidx,obj1,obj2,obj3,obj4,obj5)
{
	$("#id-btn-dialog1").modal({
		show: true,
		title : "시리얼/로트No.선택",
	...
	var url = "index.php?controller=base&action=listPageSerialNoPop&idx="+cidx+"&pop=Y&dialogID=id-btn-dialog1";
