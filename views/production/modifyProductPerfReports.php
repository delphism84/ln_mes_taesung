			...
			<div class="row">
				<div class="col-xs-12">
					...
					<form name="frm" id="frm" method="post" action="index_.php">
						...
						<input type="hidden" name="production_cd" id="production_cd" value="<?=$t->production_cd?>" />
						<!-- 테이블 -->
						<table id="simple-table" class="table  table-bordered table-hover">
									...
									<div class="input-group">
										<span class="input-icon input-icon-right" >
											<div class="input-group">
												...
												<input type="text" name="mold_nm" id="mold_nm" placeholder="금형명" value="<?=$t->mold_nm?>" onclick="centerOpenWindow('views/popup/moldListPut.php', '금형리스트', 500, 500)" readonly/>
								...
								<td class="col-xs-5">
									<div class="input-group">
										...
										-->
											<div class="input-group">
												<input type="hidden" name="material" id="material" value="<?=$t->material?>" />
												<input type="text" name="item_nm" id="item_nm" value="<?=$t->item_nm?>"  readonly/>
											</div>
										</span>
									</div>
							...
							<tr>
								...
								<td class="col-xs-5">
									<input type="text" name="LOT_NO" id="LOT_NO" class="text-left" value="<?=$t->LOT_NO?>" readonly/> ex)<?="TS-LOT".date("Ymdhi",time())?>
								</td>
							...
							<tr>
								...
								<td class="col-xs-5">
									<input type="text" name="faulty_qty1" id="faulty_qty1" class="onlynum text-right" value='<?=$t->faulty_qty1?>' />
									<input type='hidden' name='faulty_type1' value='초품불량' readonly />
								</td>
								<th class="col-xs-1" style="background-color:#f1f1f1">BURR 불량수량</th>
								<td class="col-xs-5">
									<input type="text" name="faulty_qty2" id="faulty_qty2" class="onlynum text-right" value='<?=$t->faulty_qty2?>' />
							...
							<tr>
								...
								<td class="col-xs-5">
									<input type="text" name="faulty_qty3" id="faulty_qty3" class="onlynum text-right" value='<?=$t->faulty_qty3?>' />
									<input type='hidden' name='faulty_type3' value='녹불량' readonly />
								</td>
								<th class="col-xs-1" style="background-color:#f1f1f1">스크래치 불량수량</th>
								<td class="col-xs-5">
									<input type="text" name="faulty_qty4" id="faulty_qty4" class="onlynum text-right" value='<?=$t->faulty_qty4?>' />
							...
							<tr>
								...
								<td class="col-xs-5">
									<input type="text" name="faulty_qty5" id="faulty_qty5" class="onlynum text-right" value='<?=$t->faulty_qty5?>' />
									<input type='hidden' name='faulty_type5' value='치수' readonly />
								</td>
								<th class="col-xs-1" style="background-color:#f1f1f1">변형 불량수량</th>
								<td class="col-xs-5">
									<input type="text" name="faulty_qty6" id="faulty_qty6" class="onlynum text-right" value='<?=$t->faulty_qty6?>' />
							...
							<tr>
								...
								<td class="col-xs-11" colspan='3'>
									<input type="text" name="faulty_qty7" id="faulty_qty7" class="onlynum text-right" value='<?=$t->faulty_qty7?>' />
							...
							<tr>
								...
								<td class="col-xs-5">
									<input type="text" name="loss_item" id="loss_item" value="<?=$t->loss_item?>" />
								</td>
...
function centerOpenWindow(theURL, winName, width, height, fstate, scrollbars){ 
	...
	if (theURL=="views/popup/moldItemListPut.php")
	{	var mold_cd = $("#mold_cd").val();
		theURL = theURL+"?mold_cd="+mold_cd 
	}
...
function formSubmit(){
	...
	if(faulty_type1_val != "기타") $("#faulty_type1_1").val("");
	if(faulty_type2_val != "기타") $("#faulty_type2_1").val("");
