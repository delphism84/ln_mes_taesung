							...
							<tr>
								...
								<td class="col-xs-5">
									...
									<span class="panel panel-default" disabled>
											<?=$t->work_cha?>
									</span><!-- <input type="text" value="<?=$t->work_cha?>" style='width:50px' disabled /> -->
								</td>
									...
									<div class="input-group">
										<span class="input-icon input-icon-right">
											<div class="input-group">
												...
												<input type="text" name="workplan_cd" id="workplan_cd" onclick="centerOpenWindow('views/popup/wPlanList.php', '생산계획서 리스트',900, 600)" value="<?=$t->workplan_cd?>" readonly />
