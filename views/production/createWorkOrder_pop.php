			...
			<div class="row">
				<div class="col-xs-12">
					...
					<form name="frm" id="frm" method="post" action="index.php" enctype="multipart/form-data">
						...
						<input type="hidden" name="action" id="action" value="inputPageWorkOrder" />
						...
						<table id="simple-table" class="table table-bordered table-hover">
								...
								<td class="col-xs-5">
									<span class="input-icon input-icon-right">
										<div class="input-group">
											<input class=" date-picker" type="text" data-date-format="yyyy/mm/dd" name="work_dt" id="work_dt" value="<?=date('Y/m/d')?>" readonly/>
									...
									<div class="input-group">
										<span class="input-icon input-icon-right">
											<div class="input-group">
												...
												<input type="text" name="workplan_cd" id="workplan_cd" onclick="centerOpenWindow('views/popup/wPlanList.php', '생산계획서 리스트',900, 600)" readonly />
												<span class="input-group-addon btn-purple" onclick="centerOpenWindow('views/popup/wPlanList.php', '생산계획서 리스트', 900, 600)">
							...
							<tr>
								...
								<td class="col-xs-5">
									<span class="input-icon input-icon-right">
										<div class="input-group">
											<input class=" date-picker" type="text" data-date-format="yyyy-mm-dd" name="work_start_dt" id="work_start_dt" readonly/>
											<span class="input-group-addon">
												<i class="fa fa-calendar bigger-110"></i>
											</span>
										</div>
							...
							<tr>
								...
								<tr>
									...
									<td class="col-xs-5"><textarea name="remark" id="remark" class="form-control col-xs-2" rows="1" style="width:70%"></textarea></td>

									<th class="col-xs-1" style="background-color:#f1f1f1"><i class="ace-icon fa fa-caret-right blue"></i> 첨부</th>
									<td colspan="3" class="col-xs-11"><input type="file" name="attach" id="attach" style="width:50%" value="" /></td>
								</tr>
						...
						<!-- <table id="bom_list" class="table  table-bordered table-hover" style="margin-top:10px">
							<thead>
								<tr>
									<th style="background-color:#f1f1f1" colspan="7">BOM 소요량</th>
								</tr>
								<tr>
									...
									<th style="background-color:#f1f1f1">재고수량</th>
								</tr>
							</thead>
							<tbody></tbody>
						</table> -->
