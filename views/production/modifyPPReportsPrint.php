			...
			<div class="row">
				<div class="col-xs-12">
					...
					<form name="frm" id="frm" method="post" action="index_.php">
						...
						<input type="hidden" name="action" id="action" value="updatePagePPReportsPrint" />
						...
						<table id="simple-table" class="table  table-bordered table-hover">
							<tr>
								...
								<td class="col-xs-5">
									<input type="text" name="lot_no" id="lot_no" class="text-left"/> ex)<?="TS-LOT".date("Ymdhi",time())?> ← 미입력시 자동부여
								</td>
							</tr>
							<tr>
									...
									<div class="input-group">
										<span class="input-icon input-icon-right">
											<div class="input-group">
												...
												<input type="text" name="item_nm" id="item_nm" onclick="centerOpenWindow('views/popup/ProductPerfReportsLotNo.php', '품목 리스트', 900, 500)" readonly/>
												<span class="input-group-addon btn-purple" style="cursor:pointer" onclick="centerOpenWindow('views/popup/ProductPerfReportsLotNo.php', '품목 리스트', 900, 500)">
								...
								<th class="col-xs-1" style="background-color:#f1f1f1">공급자</th>
								<td class="col-xs-5">
									<div class="input-group">
										<span class="input-icon input-icon-right">
											<div class="input-group">
												<input type="hidden" name="account_cd" id="account_cd" />
												<input type="text" name="account_nm" id="account_nm" onclick="centerOpenWindow('views/popup/accountList.php', '공급자리스트', 600, 500)" readonly />
												<span class="input-group-addon btn-purple" style="cursor:pointer" onclick="centerOpenWindow('views/popup/accountList.php', '공급자리스트', 600, 500)" >
													<i class="ace-icon fa fa-search icon-on-right bigger-110" style="color:#ffffff"></i>
												</span>&nbsp;
											</div>
										</span>
							...
							<tr>
								...
								<td class="col-xs-5">
									<input type="text" name="output_qty" id="output_qty" class="text-right" value='0' onKeyPress="onlyNumber();" onKeyUp="input_comma(this);" onclick='this.select();' onblur="publishQty()" style="ime-mode:disabled"/>
								</td>
							...
							<tr>
								...
								<td class="col-xs-5">
									<input type="text" name="publish_qty" id="publish_qty" value='1' class="text-right" onKeyPress="onlyNumber();" onclick='this.select();' onKeyUp="input_comma(this);" style="ime-mode:disabled"/> ※포장수량 / 박스당수량
								</td>
								<th class="col-xs-1" style="background-color:#f1f1f1">도번</th>
								<td class="col-xs-5">
									<input type="text" name="dobeon" id="dobeon" onclick='this.select();' style="ime-mode:disabled"/>
								</td>
							</tr>
							<tr>
								<th class="col-xs-1" style="background-color:#f1f1f1"> 제조일자</th>
								<td class="col-xs-5">
									<span class="input-icon input-icon-right">
										<div class="input-group">
											<input class=" date-picker" name="manufacture_dt" id="manufacture_dt" type="text" value="<?=date('Y-m-d')?>" data-date-format="yyyy-mm-dd" readonly/>
											<span class="input-group-addon">
												<i class="fa fa-calendar bigger-110"></i>
											</span>&nbsp;
										</div>
								...
								<th class="col-xs-1" style="background-color:#f1f1f1"> 납품일자</th>
								<td class="col-xs-5">
									<span class="input-icon input-icon-right">
										<div class="input-group">
											<input class=" date-picker" name="delivery_dt" id="delivery_dt" type="text" value="<?=date('Y-m-d')?>" data-date-format="yyyy-mm-dd" readonly/>
											<span class="input-group-addon">
												<i class="fa fa-calendar bigger-110"></i>
											</span>&nbsp;
										</div>
...
function publishQty(){
	...
	$("#publish_qty").val(addcomma(Math.ceil(pq)))
}
...
var wcd = $("#work_cd").val();
	getPPRWorkDateCheck(wcd);
}

function getPPRWorkDateCheck(wcd){
	
	var data_string = "mode=getPPRWorkDateCheck&work_cd=" + wcd;
...
function getProductPerfReportsVal(wcd){
	$.getJSON("ajax/production.php",{"mode":"getProductPerfReportsVal","work_cd":wcd},
		function(json){
			if(json != null) {
