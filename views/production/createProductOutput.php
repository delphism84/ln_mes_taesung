			...
			<div class="row">
				<div class="col-xs-12">
					...
					<form name="frm" id="frm" method="post" action="index.php">
						...
						<input type="hidden" name="action" id="action" value="inputProductOutput" />
						...
						<table id="simple-table" class="table  table-bordered table-hover">
									...
									<div class="input-group">
										<span class="input-icon input-icon-right">
											<div class="input-group">
												...
												<input type="text" name="item_cd" id="item_cd" class="item_cd" style='width:120px' readonly/>
												<input type="text" name="standard1" id="standard1" class="standard1" style='width:120px' readonly/>
											</div>
										</span>
									</div>
								...
								<td class="col-xs-5">
									<div class="input-group">
										...
										<!-- <div class="input-group bootstrap-timepicker">
											<input name="p_plan_tm1" id="timepicker1" type="text" style="width:70px" data-date-format="HH:mm'"/>
											<span class="input-group-addon">
												<i class="fa fa-clock-o bigger-110"></i>
											</span>
											~
											<input name="p_plan_tm2" id="timepicker2" type="text" style="width:70px" data-date-format="HH:mm'"/>
											<span class="input-group-addon">
												<i class="fa fa-clock-o bigger-110"></i>
											</span>
										</div> -->
							...
							<tr>
								...
								<td class="col-xs-11" colspan="3" id="">
									<!-- <div class="input-group">
										<span class="input-icon input-icon-right">
											<div class="input-group">
												<input type="hidden" name="lot_no_cd" id="lot_no_cd" value="<?=$t->lot_no_cd?>" />
												<select multiple name="lot_no_nm" size="5" style="width:350px" class="form-control" value="<?=$t->lot_no_nm?>" />
												</select>
												<span class="input-group-addon btn-purple" style="cursor:pointer" onclick="centerOpenWindow('views/popup/lotNoListPut.php', '로트NO리스트', 800, 600)">
														<i class="ace-icon fa fa-search icon-on-right bigger-110" style="color:#ffffff"></i>
												</span>
											</div>
										</span>
							...
							<tr>
								...
								<td class="col-xs-5">
									<input type="text" name="loss_time" id="loss_time" class="onlynum text-right" />분
								</td>
							</tr>
						</table>
					</form>
