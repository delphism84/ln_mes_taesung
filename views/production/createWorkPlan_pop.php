			...
			<div class="row">
				<div class="col-xs-12">
					...
					<form name="frm" id="frm" method="post" action="index.php" enctype="multipart/form-data">
						...
						<input type="hidden" name="action" id="action" value="inputPageWorkPlan" />
						<input type="hidden" name="cntTotal" id="cntTotal" />
						<input type="hidden" name="dialogID" id="dialogID" value="<?=$dialogID?>" />
						<!-- 테이블 -->
						<table id="simple-table" class="table  table-bordered table-hover">
							<tr>
								<th class="col-xs-1" style="background-color:#f1f1f1"><i class="ace-icon fa fa-caret-right red"></i> 생산유형</th>
							...
							<tr>
								<th class="col-xs-1" style="background-color:#f1f1f1"><i class="ace-icon fa fa-caret-right red"></i> 생산계획일자</th>
								<td class="col-xs-5" >
									<div>
										<span class="input-icon input-icon-right">
											<div class="input-group">
												<input class=" date-picker" name="workplan_dt" id="workplan_dt" type="text" data-date-format="yyyy/mm/dd" placeholder="생성일자" value="<?=date("Y/m/d");?>" readonly/>
									...
									<div class="input-group">
										<span class="input-icon input-icon-right">
											<div class="input-group">
												...
												<input type="text" name="order_cd" id="order_cd" onclick="centerOpenWindow('views/popup/orderList.php', '수주서 리스트',600, 500)" readonly />
							...
							<tr>
								<th class="col-xs-1" style="background-color:#f1f1f1"><i class="ace-icon fa fa-caret-right red"></i> 생산계획명</th>
								<td class="col-xs-11" colspan="3">
							...
							<tr>
								<th class="col-xs-1" style="background-color:#f1f1f1"><i class="ace-icon fa fa-caret-right red"></i> 생산계획기간</th>
								<td class="col-xs-11" colspan="3">
									<div>
										<span class="input-icon input-icon-right">
											<div class="input-group">
