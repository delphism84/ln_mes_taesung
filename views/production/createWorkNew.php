			...
			<div class="row">
				<div class="col-xs-12">
					...
					<form name="frm" id="frm" method="post" action="index.php" enctype="multipart/form-data">
						...
						<input type="hidden" name="action" id="action" value="inputWorkNew" />
						...
						<table id="simple-table" class="table table-bordered table-hover">
							...
							<tr>
								...
								<tr>
									...
									<td><input type="hidden" name="workplan_uid" id="workplan_uid" /><input type="text" name="workplan_cd" id="workplan_cd" /></td>
								</tr>
							</thead>
							<tbody></tbody>
						</table>
						...
						<a class="btn btn-xs btn-info" onclick="centerOpenWindow('views/popup/wPlanList.php', '생산계획서 리스트', 900, 600)">생산계획서 품목가져오기</a>
