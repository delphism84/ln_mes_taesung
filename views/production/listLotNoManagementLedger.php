			...
			if(json != null) {
				for(var i = 0 ; i < json.length ; i++){
					...
					tag += "<tr class='detail-row'>";
						tag += "<td colspan='14'>";
							tag += "<form name='LotForm"+i+"' id='LotForm"+i+"'>";
										...
										tag += "<table id='lot_no_list_"+i+"' class='table  table-bordered table-hover'>";
											tag += "<thead class='thin-border-bottom'>";
												tag += "<tr>";
													...
													tag += "<th class='col-xs-1'><i class='ace-icon fa fa-caret-right blue'></i> 1공장세척/도금";
													tag += "<div id='Demo-BS' style='padding:0px;float:right'>";
													tag += "<button type='button' class='btn btn-primary btn-xs'>완료</button></div>";
													tag += "</div>";
													tag += "</th>";
													tag += "<th class='col-xs-1'><i class='ace-icon fa fa-caret-right blue'></i> 불량/수량/완료여부</th>";
													tag += "<th class='col-xs-1'><i class='ace-icon fa fa-caret-right blue'></i> 1공장 검사";
													tag += "<div id='Demo-BS' style='padding:0px;float:right'>";
													tag += "<button type='button' class='btn btn-primary btn-xs'>완료</button></div>";
													tag += "</div>";
													tag += "</th>";
													tag += "<th class='col-xs-1'><i class='ace-icon fa fa-caret-right blue'></i> 불량/수량/완료여부</th>";
													tag += "<th class='col-xs-1'><i class='ace-icon fa fa-caret-right blue'></i> 1공장 출하";
													tag += "<div id='Demo-BS' style='padding:0px;float:right'>";
													tag += "<button type='button' class='btn btn-primary btn-xs'>완료</button></div>";
													tag += "</div>";
													tag += "</th>";
													...
													tag += "</tr>";
													tag += "<tr>";
													tag += "<th class='col-xs-1'><i class='ace-icon fa fa-caret-right blue'></i> 2공장 입고";
													tag += "<div id='Demo-BS' style='padding:0px;float:right'>";
													tag += "<button type='button' class='btn btn-primary btn-xs'>완료</button></div>";
													tag += "</div>";
													tag += "</th>";
													tag += "<th class='col-xs-1'><i class='ace-icon fa fa-caret-right blue'></i> 불량/수량/완료여부</th>";
													tag += "<th class='col-xs-1'><i class='ace-icon fa fa-caret-right blue'></i> 2공장 사출";
													tag += "<div id='Demo-BS' style='padding:0px;float:right'>";
													tag += "<button type='button' class='btn btn-primary btn-xs'>완료</button></div>";
													tag += "</div>";
													tag += "</th>";
													tag += "<th class='col-xs-1'><i class='ace-icon fa fa-caret-right blue'></i> 불량/수량/완료여부</th>";
													tag += "<th class='col-xs-1'><i class='ace-icon fa fa-caret-right blue'></i> 2공장 검사1";
													tag += "<div id='Demo-BS' style='padding:0px;float:right'>";
													tag += "<button type='button' class='btn btn-primary btn-xs'>완료</button></div>";
													tag += "</div>";
													tag += "</th>";
													tag += "<th class='col-xs-1'><i class='ace-icon fa fa-caret-right blue'></i> 불량/수량/완료여부</th>";
													tag += "<th class='col-xs-1'><i class='ace-icon fa fa-caret-right blue'></i> 2공장 검사2";
													tag += "<div id='Demo-BS' style='padding:0px;float:right'>";
													tag += "<button type='button' class='btn btn-primary btn-xs'>완료</button></div>";
													tag += "</div>";
													tag += "</th>";
													tag += "<th class='col-xs-1'><i class='ace-icon fa fa-caret-right blue'></i> 불량/수량/완료여부</th>";
													tag += "<th class='col-xs-1'><i class='ace-icon fa fa-caret-right blue'></i> 2공장 출하";
													tag += "<div id='Demo-BS' style='padding:0px;float:right'>";
													tag += "<button type='button' class='btn btn-primary btn-xs'>완료</button></div>";
													tag += "</div>";
													tag += "</th>";
