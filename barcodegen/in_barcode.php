   ...
   <div id="conWrap">
     ...
     <div id="contents" class="">
        <div  id="">
			...
			<div id="salesList_layer" class="popLayer105">
				<div class="popContainer">		
					...
					<div class="popConts br_none">
						<iframe  src="" id="salesList_frame" name="salesList" frameborder="0" width="100%" height="600px" scrolling="yes" title="물품등록"></iframe>
					</div><!---//popConts-->
			...
			<input type="hidden" name="state" id="state" value="in_barcode" />
			...
			<div class="tblArea" style="margin-top:3px;">
					...
					<tr>
						...
						<td class="text-center" style="background-color:#f4f3f3"><strong>입고창고</strong></td>
					 ...
					 <table border="0" cellspacing="0" cellpadding="0" class="TblEst st1_tbl" id="barcodeTable1">
                      <colgroup>
						<col width="5%">
						<col width="15%">
						<col width="35%">
					  ...
					  <tbody>
						...
						<tr class='ItemBlock'>
							...
							<td>
								<input name="in_unitprice[]" id="in_unitprice_1" type="text" class="inpt1 w80p"> <strong> 원 / 개</strong>
							</td>
						...
						<tr class='ItemBlock'>
							...
							<td>
								<input name="in_unitprice[]" id="in_unitprice_2" type="text" class="inpt1 w80p"> <strong> 원 / 개</strong>
							</td>
						...
						<tr class='ItemBlock'>
							...
							<td>
								<input name="in_unitprice[]" id="in_unitprice_3" type="text" class="inpt1 w80p"> <strong> 원 / 개</strong>
							</td>
						...
						<tr class='ItemBlock'>
							...
							<td>
								<input name="in_unitprice[]" id="in_unitprice_4" type="text" class="inpt1 w80p"> <strong> 원 / 개</strong>
							</td>
						...
						<tr class='ItemBlock'>
							...
							<td>
								<input name="in_unitprice[]" id="in_unitprice_5" type="text" class="inpt1 w80p"> <strong> 원 / 개</strong>
							</td>
						...
						<tr class='ItemBlock'>
							...
							<td>
								<input name="in_unitprice[]" id="in_unitprice_6" type="text" class="inpt1 w80p"> <strong> 원 / 개</strong>
							</td>
						...
						<tr class='ItemBlock'>
							...
							<td>
								<input name="in_unitprice[]" id="in_unitprice_7" type="text" class="inpt1 w80p"> <strong> 원 / 개</strong>
							</td>
						...
						<tr class='ItemBlock'>
							...
							<td>
								<input name="in_unitprice[]" id="in_unitprice_8" type="text" class="inpt1 w80p"> <strong> 원 / 개</strong>
							</td>
						...
						<tr class='ItemBlock'>
							...
							<td><input name="product[]" id="product_9" type="text" class="inpt1 w96p" /><input type="hidden" name="is_pd[]" id="is_pd_9" />
								<input type="hidden" name="itemcd[]" id="itemcd_9" />
							</td>
							<td>
								<input name="in_unitprice[]" id="in_unitprice_9" type="text" class="inpt1 w80p"> <strong> 원 / 개</strong>
							</td>
						...
						<tr class='ItemBlock'>
							...
							<td>
								<input name="in_unitprice[]" id="in_unitprice_10" type="text" class="inpt1 w80p"> <strong> 원 / 개</strong>
							</td>
...
<div id="layer2" class="popLayer2">
	<div class="popContainer">		
		<div class="popConts  br_none">
			<p class="ctxt" id="actBtn_text">등록하시겠습니까?</p>
		</div>
		<div class="btnArea2">
...
<script type="text/javascript">
		...
		if($("#barcode_1").val() == "") {
			...
			for(i=1; i<11; i++) {
				...
				if($("#barcode_" + i).val() != "") {
					...
					if($("#in_unitprice_" + i).val() != "") {
						layer_open('layer2');
					} else {
						$("<p class='ctxt' id='actBtn_text3'>입고단가를 입력해주세요.</p>").replaceAll("#actBtn_text3");
						layer_open('layer3');
					}
				} else {
	...
	//ENTER 키 입력 Event(바코드 기기 - 숫자입력 + Enter 키 입력)
		...
		if(window.event.keyCode == 13){
			...
			$.ajax({ 
				...
				, success: function(data) {
					...
					var price_id = "in_unitprice_"+bar_num;
					...
					if(res.rst == 1){
						...
						autoBarcode("입고",res.itemcd,res.barcode);	
					}else{
						var bar_confirm = confirm("등록되지 않은 품목입니다. 상품을 등록하시겠습니까?");
						if(bar_confirm){
							...
							var url = "/weberp/barcodegen/in_barcode_res.php?submode=inbarcode&barcode="+Obj.value+"&inputnum="+bar_num;
	...
	function onFocusBarcode(Obj){
		...
		$("#barcodeTable").append("<tr class='ItemBlock'><td class=\"text-center\"><input type=\"checkbox\" name=\"check_1\" class=\"check_po\"></td><td><input name=\"barcode[]\" id=\"barcode_"+bar_num+"\" type=\"text\" class=\"inpt1 w96p\" onkeydown=\"onKeyDownBarcode(this)\" onfocus=\"onFocusBarcode(this)\" tabindex='"+bar_num+"'></td><td><input name=\"product[]\" id=\"product_"+bar_num+"\" type=\"text\" class=\"inpt1 w96p\"><input type=\"hidden\" name=\"is_pd[]\" id=\"is_pd_"+bar_num+"\" /><input type=\"hidden\" name=\"itemcd[]\" id=\"itemcd_"+bar_num+"\" /><input type=\"hidden\" name=\"in_unitprice[]\" id=\"in_unitprice_"+bar_num+"\" /></td><td><span class=\"button105\"><a href=\"javascript:minusNum("+bar_num+")\" title=\"-\" class=\"cbtn\">-</a></span><input name=\"qty[]\" id=\"qty_"+bar_num+"\" type=\"text\" class=\"inpt1 w60p text-center\"><span class=\"button105\"><a href=\"javascript:plusNum("+bar_num+")\" title=\"+\" class=\"cbtn\">+</a></span></td></tr>");
	}
