...
<div id="wrapper">
	...
	<div id="headWrap">
		<!-- header code here -->
		<div class="header">
			<h1><a href="/weberp/index.php"><img src="/weberp/img/<?=$company_logo_file?>" alt="<?=$company_name?> ERP 시스템" class="logo"></a></h1>
			<div class="topLog">
				<span class="logTxt" title="user2">* <strong><?=$memberCname?></strong>님이 로그인 하셨습니다.</span>
				<span class="logOut"><a href="/weberp/logout.php" title="로그아웃"><img src="/weberp/img/btn_logout.png" alt="로그아웃"></a></span>
		</div>
		<!-- header //-->
	</div>
	<div class="gnbWrap">
