			...
			<table><tr><td>
				<div>
					...
					<div class="menu" style="z-index:9999; position:fixed; top:0;">
						<!--상단 -->					
						<div class="top_menu">
							<span>xxxxx님 환영합니다</span>		
							<!-- btn_04 슬라이드 메뉴 닫는 제이쿼리 class -->
								...
								<ul class="main_menu">
									...
									<li class="main_menu01">
										<a href="#a" style="color: #fff">
											<span class="glyphicon glyphicon-file icon_bakccolor" aria-hidden="true" style="color: #fff">기준정보관리</span>									
										</a>
									...
									<li class="main_menu01">
										<a href="#a" style="color: #fff">
											<span class="glyphicon glyphicon-file icon_bakccolor" aria-hidden="true" style="color: #fff">수주/영업관리</span>
										</a>									
										<ul class="sub_menu">
											<li>
									...
									<li class="main_menu01">
										<a href="#a" style="color: #fff">
											<span class="glyphicon glyphicon-file icon_bakccolor" aria-hidden="true" style="color: #fff">생산관리</span>
										</a>
										<ul class="sub_menu">
											<li class="sub_menu01">
									...
									<li class="main_menu01">
										<a href="#a" style="color: #fff">
											<span class="glyphicon glyphicon-file icon_bakccolor" aria-hidden="true" style="color: #fff">품질관리</span> 
										</a>
										<ul class="sub_menu">
											<!--
											<li class="sub_menu01">
									...
									<li class="main_menu01">
										<a href="#a" style="color: #fff">
											<span class="glyphicon glyphicon-file icon_bakccolor" aria-hidden="true" style="color: #fff">외주/사급관리</span> 
										</a>
										<ul class="sub_menu">
											<li>
											...
											<li>
												<a href="#a" onclick="location.href='../mobile/index.php?controller=outsourcing&action=frmBringinMaterialPurchase'"><span class="glyphicon glyphicon-minus" aria-hidden="true">사급자재구매관리</span></a>
											</li>
											<li>
									...
									<li class="main_menu01">
										<a href="#a" style="color: #fff">
											<span class="glyphicon glyphicon-file icon_bakccolor" aria-hidden="true" style="color: #fff">구매/입고관리</span> 
										</a>
										<ul class="sub_menu">
											<li>
									...
									<li class="main_menu01">
										<a href="#a" style="color: #fff">
											<span class="glyphicon glyphicon-file icon_bakccolor" aria-hidden="true" style="color: #fff">출고/출하관리</span> 
										</a>
										<ul class="sub_menu">
											<li>
									...
									<li class="main_menu01">
										<a href="#a" style="color: #fff;">
											<span class="glyphicon glyphicon-file icon_bakccolor" aria-hidden="true" style="color: #fff">재고관리</span> 
										</a>
										<ul class="sub_menu">
											<li class="sub_menu01">
									...
									<li class="main_menu01">
										<a href="#a" style="color: #fff;">
											<span class="glyphicon glyphicon-file icon_bakccolor" aria-hidden="true" style="color: #fff">그룹웨어</span> 
										</a>
										<ul class="sub_menu">
											<!--
											<li class="sub_menu01">
									...
									<li class="main_menu01">
										...
										<ul class="sub_menu">
											<li class="sub_menu01">
												<a href="#a"><span class="glyphicon glyphicon-minus" aria-hidden="true"></span>매입 <span class="glyphicon glyphicon-chevron-down" aria-hidden="true"></span></a>
											<ul class="sub_menu02">
											<li>
												<a href="#a" onclick="location.href='../mobile/index.php?controller=accounting&action=frmAccountPurchase'"><span class="glyphicon glyphicon-minus" aria-hidden="true"></span>업체별 매입현황</a>
											</li>
											<li>  
												<a href="#a" onclick="location.href='../mobile/index.php?controller=accounting&action=frmItemOrder'"><span class="glyphicon glyphicon-minus" aria-hidden="true"></span>품목별 매입현황</a>
											</li>
											<li>  
												<a href="#a" onclick="location.href='../mobile/index.php?controller=accounting&action=frmPeriodOrder'"><span class="glyphicon glyphicon-minus" aria-hidden="true"></span>기간별 매입현황</a>
											</li>
											<li>  
												<a href="#a" onclick="location.href='../mobile/index.php?controller=accounting&action=frmAccountPurchaseChart'"><span class="glyphicon glyphicon-minus" aria-hidden="true"></span>업체별 매입순위표</a>
											</li>
										</ul>
									</li>  
									<li class="sub_menu01">
										<a href="#a"><span class="glyphicon glyphicon-minus" aria-hidden="true"></span>미수급 / 미지급금 관리 <span class="glyphicon glyphicon-chevron-down" aria-hidden="true"></span></a>
										<ul class="sub_menu02">
											<li>
												<a href="#a" onclick="location.href='../mobile/index.php?controller=accounting&action=frmReceivables'"><span class="glyphicon glyphicon-minus" aria-hidden="true"></span>미수금 내역</a>
											</li>
											<li>  
												<a href="#a" onclick="location.href='../mobile/index.php?controller=accounting&action=frmPayable'"><span class="glyphicon glyphicon-minus" aria-hidden="true"></span>미지급금 내역</a>
											</li>                           
										</ul>
									</li>  
									<li class="sub_menu01">
										<a href="#a"><span class="glyphicon glyphicon-minus" aria-hidden="true"></span>판매 <span class="glyphicon glyphicon-chevron-down" aria-hidden="true"></span></a>
										<ul class="sub_menu02">
											<li>
												<a href="#a" onclick="location.href='../mobile/index.php?controller=accounting&action=frmAccountSales'"><span class="glyphicon glyphicon-minus" aria-hidden="true"></span>업체별 판매현황</a>
											</li>
											<li>  
												<a href="#a" onclick="location.href='../mobile/index.php?controller=accounting&action=frmItemSales'"><span class="glyphicon glyphicon-minus" aria-hidden="true"></span>품목별 판매현황</a>
											</li>
											<li>  
												<a href="#a" onclick="location.href='../mobile/index.php?controller=accounting&action=frmPeriodSales'"><span class="glyphicon glyphicon-minus" aria-hidden="true"></span>기간별 판매현황</a>
											</li>
											<li>  
												<a href="#a" onclick="location.href='../mobile/index.php?controller=accounting&action=frmAccountSalesChart'"><span class="glyphicon glyphicon-minus" aria-hidden="true"></span>업체별 판매순위표</a>
											</li>
											<li>  
												<a href="#a" onclick="location.href='../mobile/index.php?controller=accounting&action=frmSalesChart'"><span class="glyphicon glyphicon-minus" aria-hidden="true"></span>년, 월 판매 집계표 (업체)</a>
											</li>                           
										</ul>
									</li>
									-->
