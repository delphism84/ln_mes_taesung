				...
				<div class="wrap_box">
							...
							<div class="widget-main no-padding">
								<table id="tb" class="table table-bordered table-striped">
									<thead class="thin-border-bottom">
										<tr>														
											<th>
												<i class="ace-icon fa fa-caret-right blue"></i> 일자
											</th>				
											<th>
												<i class="ace-icon fa fa-caret-right blue"></i> 순위
											</th>				
											<th>
												<i class="ace-icon fa fa-caret-right blue"></i> 매입업체명
											</th>				
											<th>
											...
											<th>
												<i class="ace-icon fa fa-caret-right blue"></i> 합계금액
											</th>														
											<th style="width:30%;">
					...
					<div class="bottom_box">
						...
						<span class="bottom_box_right">
							<button type="button" class="btn btn-primary margin-left15">세부(D)</button>
