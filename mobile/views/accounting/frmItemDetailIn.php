				...
				<div class="wrap_box">
						...
						<div style="width:50%; height:100%; float:left;padding:10px;">
							<table>
								<tr>
									...
									<td style="width:30%;">
										품목앞글자가 같은경우검색! 품목리스트에서선택시 [해당품목] 정확히검색!
									</td>
							...
							<div class="widget-main no-padding">
								<table id="tb" class="table table-bordered table-striped">
									<thead class="thin-border-bottom">
										<tr>														
											<th>
												<i class="ace-icon fa fa-caret-right blue"></i> 품목
											</th>				
											<th>
											...
											<th>
												<i class="ace-icon fa fa-caret-right blue"></i> 거래일자
											</th>				
											<th>
												<i class="ace-icon fa fa-caret-right blue"></i> 업체
											</th>				
											<th>
												<i class="ace-icon fa fa-caret-right blue"></i> 매입수량
											</th>				
											<th>
												<i class="ace-icon fa fa-caret-right blue"></i> 매입단가
											</th>				
											<th>
												<i class="ace-icon fa fa-caret-right blue"></i> 매입금액
											</th>				
											<th>
					...
					<div class="bottom_box">
						...
						<span class="bottom_box_right">
							<button type="button" class="btn btn-primary margin-left15">업체지정</button>
