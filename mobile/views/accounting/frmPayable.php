		...
		<div class="wrap_search_pop">	
			<div class="search_pop_content">
				<div class="input-group">
					<div class="col-xs-12">
						<? $this->periodSearch("searchDate()","발생일 검색"); ?>
					</div>
		...
		<div class="page-content">
			<div>				
				<div class="col-xs-12">
					<div class="col-xs-12">
						<?						
						echo "<input type='button' class='comm_title' value='기간별 판매현황' />";
						echo "</div>";
...
<!-- 상세보기 -->
<div class="modal fade" id="viewPayableModal" data-backdrop="static" data-keyboard="false">
			...
			<!-- 내용 -->
				<form id="frm">
					...
					<table class="table table-bordered">
						...
						<tr>
							<th class='' style="background-color:#f1f1f1; vertical-align:middle; "><i class="ace-icon fa fa-caret-right blue"></i>매입합계</th>
							<td><span id="a_amount"></span></td>
						</tr>
						<tr>
							<th class='' style="background-color:#f1f1f1; vertical-align:middle; "><i class="ace-icon fa fa-caret-right blue"></i>지불합계</th>
							<td><span id="a_provide_amount"></span></td>
						</tr>
						<tr>
						...
						<tr>
							<th class='' style="background-color:#f1f1f1; vertical-align:middle; "><i class="ace-icon fa fa-caret-right blue"></i>최종지불일</th>
							<td><span id="a_last_provide_dt"></span></td>
						</tr>
						<tr>
						...
						<tr>
							<th class='' style="background-color:#f1f1f1; vertical-align:middle; "><i class="ace-icon fa fa-caret-right blue"></i>지불예정일</th>
							<td><span id="a_next_provide_dt"></span></td>
						</tr>
					</table>
...
<table width="700" border="1" cellspacing="0" cellpadding="0" align="center">	
  ...
  <tr> 
	  ...
	  <td>
		<table width="100%" border="1" cellspacing="0" cellpadding="0">
			<tr>
				...
				<td width="359" align="center"><span class="ctit">세 금 계 산 서</span><span class="ccmt2">(공급받는자 보관용)</span></td>
				<td width="201">
	...
	<tr> 
	  <td>
	    <table width="100%" class="cborder" style="border-left-style:none; border="1" cellspacing="0" cellpadding="0">
	     <tr>
	       <td width="50%">
		<table width="100%" border="1" cellspacing="0" cellpadding="0">
		     <tr> 
		       <td width="18" align="center" class="cborder" style="border-left-style:none; border-bottom-style:none;">
			...
			<td>
			  ...
			  <table width="100%" height="100%" border="1" cellspacing="0" cellpadding="0">
			    <tr height="35"> 
			      ...
			      <td width="80%" class="cborder corp_reg_no_deal" align="center"><span class="taxidno" ></span></td>
			    </tr>
			    <tr height="72"> 
			      ...
			      <td>
			       <table width="100%" height="100%" border="1" cellspacing="0" cellpadding="0">
				  <tr> 
				    <td class="cborder account_nm_deal" style="border-top-style:none" align="center" id="account_nm"></td>
				    <td class="cborder" style="border-top-style:none" align="center" width="30"><span class="ttxt">성<br>명</span></td>
				    <td class="cborder" style="border-top-style:none" align="center" width="100"><span class="owner_deal"></span>&nbsp;
				    <span class="ttxt">(인)</span></td>
				  </tr>
			       </table>
			      </td>
			    </tr>
			    ...
			    <tr height="35"> 
			      <td align="center" class="cborder" style="border-top-style:none; border-bottom-style:none;"><span class="ttxt">업 태</span></td>
			      <td>
				<table width="100%" height="100%" border="1" cellspacing="0" cellpadding="0">
				  <tr>
				    <td class="cborder" style="border-top-style:none; border-bottom-style:none;" align="center">
					<span class="corp_condition_deal"></span>
				    <td class="cborder" style="border-top-style:none; border-bottom-style:none;" width="30" align="center">
					<span class="ttxt">종<br>목</span></td>
				    <td class="cborder" style="border-top-style:none; border-bottom-style:none;" align="center">
					<span class="corp_event_deal"></span></td>
				  </tr>
				</table>
			      </td>
			    </tr>
	       ...
	       <td width="50%">
	        <table width="100%" border="1" cellspacing="0" cellpadding="0">
		  <tr> 
	            <td class="cborder" style="border-bottom-style:none;" width="18" align="center">
			<span class="ttxt" style="line-height:20px">공<br>급<br>받<br> 는<br>자</span></td>
		    <td>
		      <table width="100%" height="100%" border="1" cellspacing="0" cellpadding="0">
			<tr height="35"> 
			  <td width="20%" align="center" class="cborder"><span class="ttxt">등록번호</span></td>
			  <td width="80%" class="cborder business_no" align="center"><span ></td>
			</tr>
			<tr height="35"> 
			  <td align="center" class="cborder" style="border-top-style:none"><span class="ttxt">상 호<br>(법인명)</span></td>
			  <td>
			   <table width="100%"border="1" cellspacing="0" cellpadding="0">
			    <tr>
			      <td class="cborder" style="border-top-style:none" align="center"><span class="corp_nm"></span></td>
			      <td class="cborder" style="border-top-style:none" align="center" width="30"><span class="ttxt">성<br>명</span></td>
			      <td class="cborder" style="border-top-style:none" width="50" align="center"><span class="owner" ></span></td>
			      <td class="cborder" style="border-top-style:none;" width="70" align="center"><span class="sign" style="display:inline-block; transform:scale(0.5)" ></span></td>
			    </tr>
			   </table>
			  </td>
			</tr>
			...
			<tr height="35"> 
				...
				<table width="100%" height="100%" border="1" cellspacing="0" cellpadding="0">
				  <tr> 
				    <td class="cborder" style="border-top-style:none; border-bottom-style:none;" align="center">
					<span class="corp_type"></span></td>
				    <td class="cborder" style="border-top-style:none; border-bottom-style:none;" width="30" align="center">
					<span class="ttxt">종<br> 목</span></td>
				    <td class="cborder" style="border-top-style:none; border-bottom-style:none;" align="center">
					<span class="corp_event"></span></td>
				  </tr>
			        </table>
			    </td>
			</tr>
	...
	<tr> 
	  <td>
	    <table width="100%" border="1" cellspacing="0" cellpadding="0" class="cborder" style="border-top-style:none;border-left-style:none">
	      <tr height="20"> 
  ...
  <tr>
	...
	<tr>
	  <br><td class="ccmt">[직인과 일련번호가 있어야 유효합니다]</td>
	</tr>
      </table>
    </td>
  </tr>
  ...
  <tr> 
    <td width="700">
      <table width="100%" cellpadding="1" cellspacing="0" class="bout2">
        <tr> 
          <td><table width="100%" border="1" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="201"><table width="100%" height="100%" border="1" cellspacing="0" cellpadding="0">
                    <tr>
        ...
        <tr> 
          <td><table width="100%" class="cborder2" style="border-left-style:none" border="1" cellspacing="0" cellpadding="0">
              <tr>
                <td width="50%"><table width="100%" border="1" cellspacing="0" cellpadding="0">
                    <tr> 
                      <td width="18" align="center" class="cborder2" style="border-left-style:none; border-bottom-style:none;">
		       ...
		       <div class="sign_area">
		        <table width="100%" height="100%" border="1" cellspacing="0" cellpadding="0">
			     ...
			     <table width="100%" height="100%" border="1" cellspacing="0" cellpadding="0">
					...
					<span Class="owner_deal"></span>&nbsp;<span class="ttxt2">(인)</span>
				  </td>
                                </tr>
                             </table>
			    </td>
                          ...
                          <tr height="35"> 
                            ...
                            <td class="cborder2" style="border-top-style:none;" align="center"><span class="corp_address_deal"></td>
                          </tr>
                          <tr height="35"> 
                            <td align="center" class="cborder2" style="border-top-style:none; border-bottom-style:none;"><span class="ttxt2">업 태</span></td>
                            <td>
			       <table width="100%" height="100%" border="1" cellspacing="0" cellpadding="0">
                                <tr>
                                  <td class="cborder2" style="border-top-style:none; border-bottom-style:none;" align="center">
					<span class="corp_condition_deal"></span></td>
                                  <td class="cborder2" style="border-top-style:none; border-bottom-style:none;" width="30" align="center">
					<span class="ttxt2">종<br>목</span></td>
                                  <td class="cborder2" style="border-top-style:none; border-bottom-style:none;" align="center">
					<span class="corp_event_deal"></td>
                                </tr>
                              </table>
			    </td>
                          </tr>
                ...
                <td width="50%"><table width="100%" border="1" cellspacing="0" cellpadding="0">
                    <tr> 
                      <td class="cborder2" width="18" align="center" style="border-bottom-style:none;">
			<span class="ttxt2" style="line-height:20px">공<br> 급<br> 받<br>는<br> 자</span>
			       ...
			       <table width="100%" height="100%" border="1" cellspacing="0" cellpadding="0">
                                <tr> 
                                  <td class="cborder2" style="border-top-style:none" align="center"><span class="corp_nm"></span></td>
                                  <td class="cborder2" style="border-top-style:none" align="center" width="30"><span class="ttxt2">성<br>명</span></td>
                                  <td class="cborder2" style="border-top-style:none" width="50" align="center"><span class="owner"></span> &nbsp;</td>
				  <td class="cborder2" style="border-top-style:none" width="70" align="center"><span class="sign" style="display:inline-block; transform:scale(0.5)" ></span></td>
                                </tr>
                               </table>
			     </td>
                          </tr>
                          <tr height="35"> 
                            <td align="center" class="cborder2" style="border-top-style:none"><span class="ttxt2">사업장<br> 주 소</span></td>
                            <td class="cborder2" style="border-top-style:none" align="center"><span class="address"></span></td>
                          </tr>
                          <tr height="35"> 
                            <td align="center" class="cborder2" style="border-top-style:none;  border-bottom-style:none;"><span class="ttxt2">업 태</span></td>
                            <td>
...
<table id="payable1" width="95%" border="1" cellspacing="0" cellpadding="0" style='border-collapse:collapse;border:none;' align='center'>
	...
	<tr>
		...
		<td colspan="3" valign="middle" style='width:56px;height:26px;border-left:solid #0059ff 0.4pt;border-right:solid #0059ff 0.4pt;border-top:solid #0059ff 1.1pt;border-bottom:solid #0059ff 0.4pt;padding:1.4pt 5.1pt 1.4pt 5.1pt'>
			...
			<span style='font-size:10pt;font-family:"돋음";color:#0059ff;line-height:160% weight:200px;'>일자</span></p>
		</td>
	...
	<tr>
		...
		<td colspan="14" valign="middle" style='width:304px;height:26px;border-left:solid #0059ff 0.4pt;border-right:solid #0059ff 1.1pt;border-top:solid #0059ff 0.4pt;border-bottom:solid #0059ff 1.1pt;padding:1.4pt 5.1pt 1.4pt 5.1pt'>
			<p class=Hstyle0 style='text-align:center;'>
			<span style='font-family:"돋음";color:#0059ff;font-weight:bold' class="corp_phone_deal"></span></p>
		</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td colspan="3" valign="middle" style='width:65px;height:23px;border-left:solid #0059ff 0.4pt;border-right:none;border-top:solid #0059ff 0.4pt;border-bottom:solid #0059ff 0.4pt;padding:1.4pt 5.1pt 1.4pt 5.1pt'>
			<p class=Hstyle0 style='text-align:left;'>
			<span style='font-size:8.0pt;font-family:"돋음";line-height:160%' CLASS="owner_deal"></span></p>
		</td>
		<td colspan="2" valign="middle" style='width:36px;height:23px;border-left:none;border-right:solid #0059ff 0.4pt;border-top:solid #0059ff 0.4pt;border-bottom:solid #0059ff 0.4pt;padding:1.4pt 5.1pt 1.4pt 5.1pt'>
			<p class=Hstyle0 style='text-align:center;'>
			<span style='font-size:8.0pt;font-family:"돋음";color:#0059ff;line-height:160%'>(인)</span></p>
		</td>
	...
	<tr>
		...
		<td colspan="2" valign="middle" style='width:123px;height:23px;border-left:solid #0059ff 0.4pt;border-right:solid #0059ff 0.4pt;border-top:solid #0059ff 0.4pt;border-bottom:solid #0059ff 1.1pt;padding:1.4pt 5.1pt 1.4pt 5.1pt'>
			<p class=Hstyle0 style='text-align:center;'>
			<span style='font-size:8.0pt;font-family:"돋음";color:#0059ff;line-height:160%' class="corp_condition_deal"></span></p>
		</td>
		...
		<td colspan="6" valign="middle" style='width:131px;height:23px;border-left:solid #0059ff 0.4pt;border-right:solid #0059ff 0.4pt;border-top:solid #0059ff 0.4pt;border-bottom:solid #0059ff 1.1pt;padding:1.4pt 5.1pt 1.4pt 5.1pt'>
			<p class=Hstyle0 style='text-align:center;'>
			<span style='font-size:8.0pt;font-family:"돋음";color:#0059ff;line-height:160%' class="corp_event_deal"></span></p>
		</td>
...
<table id="payable2"  width="95%" border="1" cellspacing="0" cellpadding="0" style='border-collapse:collapse;border:none;' align='center'>
	...
	<tr>
		...
		<td colspan="14" valign="middle" style='width:304px;height:26px;border-left:solid #ff0052 0.4pt;border-right:solid #ff0052 1.1pt;border-top:solid #ff0052 0.4pt;color:#ff0052border-bottom:solid #ff0052 1.1pt;padding:1.4pt 5.1pt 1.4pt 5.1pt'>
			<p class=Hstyle0 style='text-align:center;'>
			<span style='font-family:"돋음";color:#ff0052;font-weight:bold' class="corp_phone_deal"></span></p>
		</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td colspan="3" valign="middle" style='width:153px;height:23px;border-left:solid #ff0052 0.4pt;border-right:solid #ff0052 0.4pt;border-top:solid #ff0052 0.4pt;border-bottom:solid #ff0052 0.4pt;padding:1.4pt 5.1pt 1.4pt 5.1pt'>
			<p class=Hstyle0 style='text-align:center;'>
			<span style='font-size:8.0pt;font-family:"돋음";color:#ff0052;line-height:160%' class="account_nm_deal"></span></p>
		</td>
		...
		<td colspan="6" valign="middle" style='width:165px;height:23px;border-left:solid #ff0052 0.4pt;border-right:solid #ff0052 0.4pt;border-top:solid #ff0052 0.4pt;border-bottom:solid #ff0052 0.4pt;padding:1.4pt 5.1pt 1.4pt 5.1pt'>
			<p class=Hstyle0 style='text-align:center;'>
			<span style='font-size:10pt;font-family:"돋음";color:#ff0052;line-height:160%' class="corp_nm" ></span></p>
		</td>
		<td colspan="3" valign="middle" style='width:37px;height:23px;border-left:solid #ff0052 0.4pt;border-right:solid #ff0052 0.4pt;border-top:solid #ff0052 0.4pt;border-bottom:solid #ff0052 0.4pt;padding:1.4pt 5.1pt 1.4pt 5.1pt'>
			<p class=Hstyle0 style='text-align:center;'>
			<span style='font-size:8.0pt;font-family:"돋음";color:#ff0052;line-height:160%'>성명</span></p>
	...
	<tr>
		...
		<td colspan="3" valign="middle" style='width:123px;height:23px;border-left:solid #ff0052 0.4pt;border-right:solid #ff0052 0.4pt;border-top:solid #ff0052 0.4pt;border-bottom:solid #ff0052 1.1pt;padding:1.4pt 5.1pt 1.4pt 5.1pt'>
			<p class=Hstyle0 style='text-align:center;'>
			<span style='font-size:8.0pt;font-family:"돋음";color:#ff0052;line-height:160%' class="corp_condition_deal"></span></p>
		</td>
		...
		<td colspan="5" valign="middle" style='width:131px;height:23px;border-left:solid #ff0052 0.4pt;border-right:solid #ff0052 0.4pt;border-top:solid #ff0052 0.4pt;border-bottom:solid #ff0052 1.1pt;padding:1.4pt 5.1pt 1.4pt 5.1pt'>
			<p class=Hstyle0 style='text-align:center;'>
			<span style='font-size:8.0pt;font-family:"돋음";color:#ff0052;line-height:160%' class="corp_event_deal"></span></p>
		</td>
...
function getData(page){
	var tag = "";
	var parameter = {"mode" : "getPayableList", "rpp" : $("#per").val(), "adjacents" : 4, "page" : page, "where" : $("#where").val()};

	$.getJSON("ajax.php",{"parameter" : parameter},	function(json){
			if(json != null) {
				for(var i = 0 ; i < json.length ; i++){
					
					tag += "<tr onclick='toggle(this); payableData(" + json[i].uid + ");' style='cursor:pointer'>";
					...
					//tag += "<td style='vertical-align:middle; text-align:right'>" + comma(json[i].provide_amount) + "</td>";
					tag += "<td style='vertical-align:middle; text-align:right'>" + comma(json[i].remain_amount) + "</td>";
					//tag += "<td style='vertical-align:middle; text-align:right'>" + json[i].last_provide_dt + "</td>";
					...
					//tag += "<td>" + json[i].next_provide_dt + "</td>";

					//tag += "<td style='vertical-align:middle'><input type='hidden' class='btn btn-xs btn-primary' value='세금계산서' onclick=\"postData(" + json[i].uid + ",'" + json[i].account_cd + "','" + json[i].account_nm + "', '" + json[i].amount + "','" + json[i].create_dt + "' , '" + json[i].owner + "' , '" + json[i].provide_amount + "' , '" + json[i].remain_amount + "' , '" + json[i].telephone + "' , 'taxModal' )\" /> ";
...
//상세보기
function payableData(uid) {
	$("#uid").val(uid);
	var parameter = {"mode" : "getPayable", "uid":uid}
	$.getJSON("ajax.php", {"parameter":parameter}, function(json){
		if(json != null){
			...
			$("#a_provide_amount").html(comma(json.provide_amount));
			$("#a_remain_amount").html(comma(json.remain_amount));
			$("#a_last_provide_dt").html(json.last_provide_dt);
			$("#a_telephone").html(json.telephone);
			$("#a_mobile").html(json.mobile);
			$("#a_next_provide_dt").html(json.next_provide_dt);
		}
	});
	showModal('viewPayableModal');
}
//==================================================
// 세금계산서 ㅣ 거래명세서
//==================================================
function postData(uid , account_cd , account_nm , amount , create_dt , owner , provide_amount , remain_amount , telephone , Modal ){
	...
	var tag3 ="";
	var tag4 ="";
	var parameter = {"mode": "getPayableItemList" , "fid" : uid }
	$.getJSON("ajax.php", {"parameter" : parameter}, function(json){
		if(json != null){
			...
			for(var i=0 ; i<json.length ; i++){
				var price = Math.round(Number(json[i].cnt)*Number(json[i].cost));
				...
				tag1+="<td class='cborder' colspan='3' valign='middle style='width:45px;height:23px;border-left:solid #0059ff 1.1pt;border-right:solid #0059ff 0.4pt;border-top:solid #0059ff 1.1pt;border-bottom:solid #0059ff 0.4pt;padding:1.4pt 5.1pt 1.4pt 5.1pt'><p class=Hstyle0 style='text-align:center;'><span style='font-size:10pt; color:#0059ff;line-height:160%'>"+comma(json[i].cost)+"</span></p></td>";
				...
				tag3+="<td class='cborder' style='border-top-style:none' align='center'>"+comma(json[i].cost)+"</td>";
				tag3+="<td class='cborder' style='border-top-style:none' align='center'>"+comma(supply_price)+"</td>";
				tag3+="<td class='cborder' style='border-top-style:none' align='center'>"+comma(tax)+"</td>";
				...
				tag4+="<td class='cborder2' style='border-top-style:none' align='center'>"+comma(json[i].cost)+"</td>";
				tag4+="<td class='cborder2' style='border-top-style:none' align='center'>"+comma(supply_price)+"</td>";
				tag4+="<td class='cborder2' style='border-top-style:none' align='center'>"+comma(tax)+"</td>";
		...
		$("#payable1 tbody").html( tag1 );		//공급받는자 보관용(파란색)
		$("#payable2 tbody").html( tag2 );		//공급자 보관용(빨간색)
		$("#order_item_list1 tbody").html( tag3 );
		$("#order_item_list2 tbody").html( tag4 );
		$(".price_sum").text(comma(totalprice));

		calculation( supply_priceSum , taxSum );	//공급가액, 세액 합계 한 글자씩 자르기.
...
//==================================================
// 세금계산서 ㅣ 거래명세서 total공급가액 과 total세액 다루기.
//==================================================
