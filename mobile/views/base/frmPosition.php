				...
				<div class="col-xs-12">
					...
					<div style="float:left;">
						<form name="frm" id="frm">
							<input type="hidden" name="mode" id="mode" value="registPosition" />
							<input type="hidden" name="uid" id="uid" />
							<input type="hidden" name="max_seq" id="max_seq" />

							<input type="button" class="btn btn-xs" value="직위명" style="margin-bottom:4px"/>
							<input type="text" name="position_nm" id="position_nm" validation="yes" err="직위명을 입력하세요" />
					...
					<div>
						<div class="col-xs-12">
							<div class="widget-main no-padding">
								<? $this->table("position_list", "직위명=>6,출력순서=>6"); ?>
							</div>
						</div>
					</div>
				</div>
...
function getData(){
	var tag = "";
	var parameter = {"mode" : "getPosition"};
