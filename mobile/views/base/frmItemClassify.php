				...
				<div class="col-xs-12" >
					...
					<div style="float:left;">
						<form name="frm" id="frm">
							<input type="hidden" name="mode" id="mode" value="registItemClassify" />
							...
							<table style="width:100%;">
								<tr>
									...
									<td>
										<input type="text" name="classify_nm" id="classify_nm" validation="yes" err="구분명을 입력하세요" / style="width:100%;">
									</td>
								</tr>
								<tr>
									<td>
									...
									<td>
										<input type="text" name="seq" id="seq" / style="width:100%;"> 
									</td>
								</tr>
							</table>
...
function getData(){
	var tag = "";
	var parameter = {"mode" : "getItemClassifyList"};
