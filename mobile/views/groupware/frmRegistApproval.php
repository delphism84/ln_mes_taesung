...
?>
						...
						<table id="simple-table" class="table  table-bordered table-hover">
							<tr>
								...
								<td class="col-xs-5"><input type="text" name="approval_cd" id="approval_cd" validation="yes" err="문서번호를 입력하세요" /></td>
								<th class="col-xs-1" style="background-color:#f1f1f1">기안제목</th>
								<td class="col-xs-5"><input type="text" class="form-control" name="title" id="title" validation="yes" err="기안제목을 입력하세요" /></td>
							</tr>
							<tr>
									...
									<div class="input-group">
										<span class="input-icon input-icon-right">
											<div class="input-group">
												...
												<input type="hidden" name="approval_uid" id="approval_uid" validation="yes" err="결재자를 지정하세요" />
							...
							<tr>
								...
								<td>
									<div>
										...
										<textarea class="form-control" id="estimate_txt" name="estimate_txt"></textarea>
									</div>
								</td>
								<th class="col-xs-1" style="background-color:#f1f1f1; vertical-align:middle">
								...
								<td>
									<div>
										<input type="hidden" name="purchase_cd" id="purchase_cd" />												
										<textarea class="form-control" id="purchase_txt" name="purchase_txt"></textarea>
									</div>
								</td>
							</tr>
							<tr>
								...
								<td>
									<div>
										<input type="hidden" name="shipment_cd" id="shipment_cd" />
										<textarea class="form-control" id="shipment_txt" name="shipment_txt"></textarea>
									</div>
								</td>
								<th class="col-xs-1" style="background-color:#f1f1f1; vertical-align:middle">
								...
								<td>
									<div>
										<input type="hidden" name="spending_cd" id="spending_cd" value="<?=$_GET['shipment_cd'] ?>" />
										<textarea class="form-control" id="spending_txt" name="spending_txt"></textarea>
									</div>
								</td>
							</tr>
							<tr>
