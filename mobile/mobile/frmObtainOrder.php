					...
					<div style="width: 100%; height: 100%;" class="wrap_box_float">
						...
						<div class="search_box box_after rel">							
							...
							<span class="floatright">
								...
								<div class="textaling_div margintop">
									<button class="newly_btn" data-toggle="modal" data-target="#shipment_pop">
										<span>출하지시</span>
									</button>
								</div>								
							</span>		
						...
						<div class="general_box">
							...
							<table class="general_table jquery_tap01">
								...
								<tbody>
									<tr>	
										<td class="checkbox_middle" data-toggle="modal" data-target="#details_pop">
											<input type="checkbox"/>
										</td>
										<td class="paddingleft on" data-toggle="modal" data-target="#details_pop">
											2018..
										</td>
										<td class="paddingleft on" data-toggle="modal" data-target="#details_pop">
											동일..
										...
										<td class="paddingleft on">
											...
											<button class="table_btn margintop" data-toggle="modal" data-target="#more_order_pop">
												<span>재수주</span>
											</button>											
										</td>
									</tr>										
								...
								<div class="search_wrap_box box_after">
									<div class="search_body">
										...
										<div class="textaling_div">
											<button type="button" class="close_btn" data-dismiss="modal">수주일자검색</button>
										</div>
										<div class="margintop">
						...
						<!-- 재수주 -->
						<div class="modal fade" id="more_order_pop" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
							<div class="modal-dialog">
								<div class="search_wrap_box box_after">
									<div class="pop_head">
										<h4>수주서</h4>
						...
						<!-- 출하지시 -->
						<div class="modal fade" id="shipment_pop" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
							<div class="modal-dialog">
								<div class="search_wrap_box box_after">
									<div class="pop_head">
										<h4>출하지시서</h4>
									...
									<div class="search_body">										
										<table class="enrollment_table ">
											<tr>
												...
												<td>
													<input type="text"/ value="20181113-01" class="full_size">
												</td>
											</tr>																					
											<tr>
												<th>
												...
												<td>
													<input type="text"/ value="후지라이테그(주)" class="full_size">
												</td>
											</tr>																					
											<tr>
												<th>
									...
									<div class="srcoll_box margintop">										
										<table class="general_table jquery_tap01">
											<thead>
												<tr>													
													<th class="paddingleft">
											...
											<tbody>
												<tr>														
													<td class="paddingleft on" style="padding:0;">
														<input type="text"/ value="366069705" class="full_size" disabled>
													</td>
													<td class="paddingleft on">
														<input type="text"/ value="EI-4035 (V) 14P" class="full_size" disabled>
													</td>
													<td class="paddingleft on">
														<input type="text"/ value="ALL" class="full_size" disabled>
													</td>
													<td class="paddingleft on">
														<input type="text"/ value="0" class="full_size" disabled>
													</td>
													<td class="paddingleft on">
														<input type="text"/ value="10" class="full_size">
													</td>													
												</tr>	
											</tbody>
										</table>
						...
						<!-- 상세보기 -->
						<div class="modal fade" id="details_pop" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
							<div class="modal-dialog">
								<div class="search_wrap_box box_after">
									<div class="pop_head">
										<h4>상세보기</h4>
