					...
					<div style="width: 100%; height: 100%;" class="wrap_box_float">
						...
						<div class="top_title">
							<ul>
								...
								<li>기준정보관리</li>
								<li>></li>
								<li style="color:#d15b47">사원 관리</li>
							</ul>
						</div>
							...
							<div class="modal-dialog">
								<div class="search_wrap_box box_after">
									<div class="search_body">
										...
										<div class="margintop">
											<input type="search"/ class="full_size" placeholder="사원 리스트 검색">
									...
									<div class="search_body">
										...
										<table class="enrollment_table ">
											...
											<tr>
												...
												<td>
													<input type="password"/ class="full_size">
												</td>
											</tr>	
											<tr>
												<th>
											...
											<tr>
												...
												<td>
													<input type="checkbox"/><span>국민연금</span><br>
													<input type="checkbox"/><span>고용보험</span><br>
													<input type="checkbox"/><span>건강보험</span><br>
													<input type="checkbox"/><span>장기요양보험</span>
												</td>
											</tr>	
											<tr>
												<th>
											...
											<tr>
												...
												<td>
													<select class="full_size" style="width:45%;">
														<option>==선택==</option>
													</select>
													<select class="full_size" style="width:45%;">
														<option>==선택==</option>
