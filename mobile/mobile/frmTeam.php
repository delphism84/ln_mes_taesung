					...
					<div style="width: 100%; height: 100%;" class="wrap_box_float">
						...
						<div class="top_title">
							<ul>
								...
								<li>기준정보관리</li>
								<li>></li>
								<li style="color:#d15b47">생산팀 관리</li>
							</ul>
						</div>
						...
						<div class="search_box box_after">
							...
							<span class="floatright">
								<button class="enrollment_btn" data-toggle="modal" data-target="#team_pop">
						...
						<div class="general_box">
							...
							<table class="general_table jquery_tap01">
								<thead>
									<tr>	
										<th class="checkbox_middle" style="width:10%;">
											<input type="checkbox"/>
										</th>
							...
							<table class="general_table jquery_tap02">
								<thead>
									<tr>
										...
										<th class="paddingleft" style="width:5%;">
											번호
										</th>
						...
						<div class="search_box box_after margintophi">
							...
							<span class="floatright">
								<button class="delete" data-toggle="modal" data-target="#team_pop">
									선택 사원 팀원에서 제외
								</button>								
							</span>	
						</div>
							...
							<div class="modal-dialog">
								<div class="search_wrap_box box_after">
									<div class="search_body">
										<div>
											<input type="search"/ class="full_size" placeholder="거래처 검색">
						...
						<!-- 생산팀 등록 팝업 -->
						<div class="modal fade" id="team_pop" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
							<div class="modal-dialog">
								<div class="search_wrap_box box_after">
									<div class="pop_head">
										<h4>생산팀 등록</h4>
