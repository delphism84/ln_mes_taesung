					...
					<div style="width: 100%; height: 100%;" class="wrap_box_float">
						...
						<div class="top_title">
							<ul>
								...
								<li>기준정보관리</li>
								<li>></li>
								<li style="color:#d15b47">거래처 관리</li>
							</ul>
						</div>
							...
							<div class="modal-dialog">
								<div class="search_wrap_box box_after">
									<div class="search_body">
										...
										<div class="margintop">
											<input type="search"/ class="full_size" placeholder="거래처 리스트 검색">
									...
									<div class="search_body">
										...
										<table class="enrollment_table ">
											<tr>
												...
												<td>
													<input type="radio" name="sep"/><span>매입</span>
													<input type="radio" name="sep"/><span>매출</span>
													<input type="radio" name="sep"/><span>외주</span>
													<input type="radio" name="sep"/><span>공자</span>
													<input type="radio" name="sep"/><span>운송</span>
												</td>
											</tr>
											<tr>
												<th>
												...
												<td>
													<input type="radio" name="sepe"/><span>아니오</span>
													<input type="radio" name="sepe"/><span>예</span>													
												</td>
											</tr>										
											<tr>
												<th>
