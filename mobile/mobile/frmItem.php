					...
					<div style="width: 100%; height: 100%;" class="wrap_box_float">
						...
						<div class="top_title">
							<ul>
								...
								<li>기준정보관리</li>
								<li>></li>
								<li style="color:#d15b47">품목 관리</li>
							</ul>
						</div>
									...
									<div class="search_body">
										...
										<table class="enrollment_table ">
											...
											<tr>
												...
												<td>
													<input type="text"/ style="width:50%;" class="full_size" disabled>
											...
											<tr>
												...
												<td>
													<input type="text"/ class="full_size" style="width:60%;">													
													<select class="full_size" style="width:30%;">
														<option>ea</option>
													<select>
												</td>
												</td>
											...
											<tr>
												...
												<td>
													<input type="text"/ class="full_size" style="width:80%"><span style="width:10%;">일</span>
												</td>
											</tr>
											<tr>
												<th>
