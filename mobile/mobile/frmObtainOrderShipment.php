					...
					<div style="width: 100%; height: 100%;" class="wrap_box_float">
						...
						<div class="top_title">
							<ul>
								...
								<li>수주 / 영업관리</li>
								<li>></li>
								<li style="color:#d15b47">출하지시관리</li>
							</ul>
						</div>
						...
						<div class="search_box box_after rel">							
							...
							<span class="floatright">
								...
								<div class="textaling_div margintop" data-toggle="modal" data-target="#shipment_pop">
									<button class="newly_btn">
										<span>출하지시</span>
									</button>
								</div>								
							...
							<table class="general_table jquery_tap01">
								<thead>
									<tr>
										...
										<th class="paddingleft" style="width:20%;">
											수주코드
										</th>
										<th class="paddingleft" style="width:16%;">
											거래처
										</th>
								...
								<div class="search_wrap_box box_after">
									<div class="search_body">
										...
										<div class="textaling_div">
											<button type="button" class="close_btn" data-dismiss="modal">상차일자검색</button>
										</div>
									...
									<div class="search_body">										
										<table class="enrollment_table ">
											<tr>
												...
												<td>
													<input type="text"/ value="제이이엔지" class="full_size">
												</td>
											</tr>																					
											<tr>
												<th>
										...
										<table class="general_table jquery_tap01">
											...
											<tbody>
												<tr>	
													...
													<td class="paddingleft on">
														<input type="number"/ class="full_size" value="">
													</td>													
												</tr>	
											</tbody>
										</table>
