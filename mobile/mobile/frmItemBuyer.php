  ...
  <table class="wrap_com" style="width: 100%; height: 100%;"><tr><td> 
	...
	<div class="top_title">
		<ul>
			...
			<li>기준정보관리</li>
			<li>></li>
			<li style="color:#d15b47">품목 매입처 관리</li>
		</ul>
	</div>
	...
	<div class="search_box box_after margintophi">
		...
		<span class="floatright">
			<button class="search_btn" data-toggle="modal" data-target="#search02">
				<span class="glyphicon glyphicon-search" aria-hidden="true"></span>
			</button>
			<button class="newly_btn ">
				<span class="glyphicon glyphicon-refresh" aria-hidden="true"></span>
	...
	<div class="search_box box_after margintophi">
		...
		<div class="floatright">
			<button class="delete margintop">선택삭제</button>
		</div>
	</div>
	<div class="general_box srcoll_box">
		<!-- jquery_tap03 표 클릭할때 색상 표시 제이쿼리 클래스 -->
		<table class="general_table jquery_tap03">
			<thead>
				<tr>	
		...
		<div class="modal-dialog">
			<div class="search_wrap_box box_after">
				<div class="search_body">
					<div>
						<input type="search"/ class="full_size" placeholder="품목리스트 검색">
	...
	<!-- 검색 팝업 거래처리스트 -->
	<div class="modal fade" id="search02" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
		<div class="modal-dialog">
			<div class="search_wrap_box box_after">
				<div class="search_body">
					<div>
						<input type="search"/ class="full_size" placeholder="거래처리스트 검색">
						<button class="pop_search_btn">
							<span class="glyphicon glyphicon-search" aria-hidden="true"></span>
						</button>
					</div>					
