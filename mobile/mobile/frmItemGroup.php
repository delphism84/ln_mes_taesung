  ...
  <table class="wrap_com" style="width: 100%; height: 100%;"><tr><td> 
	...
	<div class="top_title">
		<ul>
			...
			<li>기준정보관리</li>
			<li>></li>
			<li style="color:#d15b47">품목 그룹 관리</li>
		</ul>
	</div>
	<div class="box_after">
		<table class="table_creation">
			<tr>
				<th>
					<span class="title_box">그룹명</span>
				</th>
				<td>
			...
			<tr>
				<th>
					<span class="title_box">출력순서</span>
				</th>
				<td>
					<input type="text"/ class="full_size">
				</td>
		...
		<div class="margintop floatright">
			<button class="creation_btn">생성 및 수정</button> 
			<button class="newly_btn">새로고침</button>
		</div>
