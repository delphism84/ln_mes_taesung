					...
					<div style="width: 100%; height: 100%;" class="wrap_box_float">
						...
						<div class="top_title">
							<ul>
								...
								<li>기준정보관리</li>
								<li>></li>
								<li style="color:#d15b47">품목 제조공정 관리</li>
							</ul>
						</div>
						...
						<div class="search_box box_after margintophi">
						...
						<div class="general_box srcoll_box">
							<!-- jquery_tap02 표 클릭할때 색상 표시 제이쿼리 클래스 -->
							<table class="general_table jquery_tap02">
								<thead>
									<tr>	
								...
								<tbody>
									<tr>	
										...
										<td class="paddingleft" style="width:15%;" >
											<input type="text"/ class="full_size">
										</td>
										<td class="paddingleft" style="width:20%;">
											<select class="full_size" >
												<option>금형</option>
											</select>
										</td>
										<td class="paddingleft" style="width:25%;" data-toggle="modal" data-target="#production_pop">
						...
						<div class="search_box box_after margintophi">
							<button class="enrollment_btn" data-toggle="modal" data-target="#materials_pop">
								<span>투입자재추가</span>
							</button>	
							<button class="creation_btn">
								<span>저장</span>
							...
							<table class="general_table jquery_tap02">
								...
								<tbody>
									<tr>	
										...
										<td class="paddingleft" style="width:25%;" >
											<input type="text"/ class="full_size">
										</td>
										<td class="paddingleft" style="width:25%;">
											<input type="text"/ class="full_size">
							...
							<div class="modal-dialog">
								<div class="search_wrap_box box_after">
									<div class="search_body">
										...
										<div class="margintop">
											<input type="search"/ class="full_size" placeholder="품목 리스트 검색">
						...
						<!-- 품목 단가 등록 팝업 -->
						<div class="modal fade" id="enrollment_pop" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
							<div class="modal-dialog">
								<div class="search_wrap_box box_after">
									<div class="pop_head">
										<h4>품목 단가 등록</h4>
						...
						<!-- 생산품번 팝업 -->
						<div class="modal fade" id="production_pop" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
							<div class="modal-dialog">
								<div class="search_wrap_box box_after">
									<div class="pop_head">
										<h4>생산품명</h4>
									...
									<div class="search_body">					
										...
										<div class="margintop">											
											<input type="search"/ class="full_size" placeholder="생산품명 검색">
											<button class="pop_search_btn">
												<span class="glyphicon glyphicon-search" aria-hidden="true"></span>
											</button>												
										</div>										
						...
						<!-- 투입자재추가 팝업 -->
						<div class="modal fade" id="materials_pop" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
							<div class="modal-dialog">
								<div class="search_wrap_box box_after">
									<div class="pop_head">
										<h4>투입자재</h4>
