<?
session_start();
if(isset($_SESSION['login_id'])) header("Location: ./index.php?controller=page&action=home");
		...
		<div id="login_bg" style="width:100%; text-align:center">
			<table align="center" width="100%">
				<tr>
					<td align="center">
						<br><br><br>
						<h1 style="color:#000">태성 ERP SYSTEM</h1>
						<br><br><br>
						<h3>성공은 변화로부터 출발합니다.</h3>
						<h3> 함께 시작하십시오. </h3>
						<br>
						<div style="margin-top:20px; text-align:center"><b>Latest Version</b> <a href="#" onclick="centerOpenWindow('views/popup/versionList.php?target=jerp', '버전리스트', 800, 500)" style="color:red">v.<?=$version->version?>.<?=$version->version_code?> [<?=$version->create_dt?>]</a></div>
						<!--<div>
